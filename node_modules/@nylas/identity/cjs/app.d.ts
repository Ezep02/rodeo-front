import { Config, AuthConfig, IDToken, ProviderList, IMAPPayload, EWSPayload } from "./@types";
...
export declare class NylasSessions {
    ...
    authIMAP(data: IMAPPayload): Promise<any>;
    authEWS(data: EWSPayload): Promise<any>;
