var r;
(function(a) {
  a.en = "en", a.es = "es", a.fr = "fr", a.de = "de", a.sv = "sv", a.zh = "zh", a.ja = "ja", a.nl = "nl";
})(r || (r = {}));
const n = {
  en: "English",
  es: "Español",
...
Object.keys(c).map((a) => a);
[
  { value: 1, label: "1" },
  ...Array.from({ length: 90 / 5 + 1 }, (a, i) => {
    const e = i * 5;
    return { value: e, label: e.toString() };
  })
].sort((a, i) => a.value - i.value);
Array.from({ length: 23 }, (a, i) => ({ value: i + 1, label: (i + 1).toString() }));
Array.from({ length: 7 }, (a, i) => ({ value: i + 1, label: (i + 1).toString() }));
export {
  u as C,
  s as D,
  t as E,
