import { r as registerInstance, h, F as Fragment, c as createEvent, H as Host, a as getElement } from './index-7cb0dd3d.js';
import { R as RegisterComponent } from './register-component-a169494c.js';
import { a as debug, m as mergeDeep, i as instance, k as parsePreviewLink } from './utils-c3434a93.js';
import { D as DEFAULT_OPEN_HOURS } from './constants-91d76d21.js';
import { i as isInitialized, a as init, c as captureMessage, b as captureFeedback, f as feedbackSyncIntegration } from './feedbackSync-b5d35a5b.js';
...
const GoogleLogoIcon = class {
    ...
    render() {
        return (h("svg", { key: '3ca599e18ce6095779ded84b497b5296f17c10d2', width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("g", { key: '88b3f5f83ede3ed85a770467f48ad836405b990a', "clip-path": "url(#clip0_959_12452)" }, h("path", { key: '4e15a1ff9fd5ed8752a01653cc0313519c3979ca', d: "M23.745 12.27C23.745 11.48 23.675 10.73 23.555 10H12.255V14.51H18.725C18.435 15.99 17.585 17.24 16.325 18.09V21.09H20.185C22.445 19 23.745 15.92 23.745 12.27Z", fill: "#4285F4" }), h("path", { key: '1d5b9ac448e9067003693fc996d84e4a6a6fb424', d: "M12.255 24C15.495 24 18.205 22.92 20.185 21.09L16.325 18.09C15.245 18.81 13.875 19.25 12.255 19.25C9.12504 19.25 6.47505 17.14 5.52505 14.29H1.54504V17.38C3.51504 21.3 7.56504 24 12.255 24Z", fill: "#34A853" }), h("path", { key: '60c45db031014875d1f0c51e4d96d233ff4d739e', d: "M5.52501 14.2901C5.27501 13.5701 5.145 12.8001 5.145 12.0001C5.145 11.2001 5.28501 10.4301 5.52501 9.71012V6.62012H1.545C0.725004 8.24012 0.255005 10.0601 0.255005 12.0001C0.255005 13.9401 0.725004 15.7601 1.545 17.3801L5.52501 14.2901Z", fill: "#FBBC05" }), h("path", { key: 'c11e6c275b10368721e0d520d98a8f57bc38acc5', d: "M12.255 4.75C14.025 4.75 15.605 5.36 16.855 6.55L20.275 3.13C18.205 1.19 15.495 0 12.255 0C7.56504 0 3.51504 2.7 1.54504 6.62L5.52505 9.71C6.47505 6.86 9.12504 4.75 12.255 4.75Z", fill: "#EA4335" })), h("defs", { key: '9ed8d3df0e31854c32fe754fc79877ca48ea5ab9' }, h("clipPath", { key: '7b54dd3d596dc38980237b59f21184a00316760f', id: "clip0_959_12452" }, h("rect", { key: '6632bab4f2645c9a5dc9f3f000a7b537d5b09f22', width: 24, height: 24, fill: "white" })))));
    }
};
...
const MicrosoftLogoIcon = class {
    ...
    render() {
        return (h("svg", { key: '970afb49d36b25194c649b69ca0f136a588c20a4', width: this.width, height: this.height, viewBox: "0 0 22 22", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'b3f4f95ead19fff86c4026bcf226a31a22b9c09a', d: "M0.043457 0.043457H10.4782V10.4782H0.043457V0.043457Z", fill: "#F35325" }), h("path", { key: '425e0c099da7b5e3637665f2b9240aab9dd43589', d: "M11.5217 0.043457H21.9565V10.4782H11.5217V0.043457Z", fill: "#81BC06" }), h("path", { key: '2f531126f18dd92603d2caaa31dfaf8a3dac3c9f', d: "M0.043457 11.5217H10.4782V21.9565H0.043457V11.5217Z", fill: "#05A6F0" }), h("path", { key: 'b500f059a84c5223d1688410bc8378e02fc87156', d: "M11.5217 11.5217H21.9565V21.9565H11.5217V11.5217Z", fill: "#FFBA08" })));
    }
};
...
const NylasListConfigurations = class {
    ...
    getActionLabelHTML(action) {
        ...
        switch (action) {
            case 'preview':
                return (h("span", { style: actionStyle }, h("eye-icon", { width: "16", height: "16" }), instance.t('nylasListConfigurations.previewButtonText')));
            case 'copy':
                return (h("span", { style: actionStyle }, h("copy-icon", { width: "16", height: "16" }), instance.t('nylasListConfigurations.copyLinkButtonText')));
            case 'delete':
                return (h("span", { style: { ...actionStyle, ...dangerStyle } }, h("delete-icon", { width: "15", height: "17" }), instance.t('nylasListConfigurations.deleteButtonText')));
            default:
                return '';
        }
    }
    ...
    render() {
        return (h(Host, null, h("div", { class: "header" }, h("div", { class: "description" }, h("h2", null, instance.t('allSchedulingPages')), h("p", null, instance.t('createAndManageSchedulingPages'))), this.configurations && this.configurations.length > 0 && (h("div", { class: "actions" }, h("button-component", { part: "nlc__create-new-cta", clickHandler: () => {
                this.createButtonClick.emit(this.host);
            } }, instance.t('createNewSchedulingPageButtonText'))))), h("div", { class: "configurations" }, h("div", { class: "table-container" }, h("table", { class: {
            ...
            } }, h("th", null, instance.t('pageTitle')), h("th", null, instance.t('durationTitle')), h("th", null)), this.state === 'loading' && (h("tr", { class: "no-configurations" }, h("td", { colSpan: 3 }, h("div", null, h("h3", null, instance.t('loading'), "..."), h("p", null, instance.t('loadingPagesDescription')))))), this.state !== 'loading' && (!this.configurations || this.configurations.length === 0) && (h("tr", { class: "no-configurations" }, h("td", { colSpan: 3 }, h("div", null, h("calendar-icon", { width: "48", height: "48" }), h("h3", null, instance.t('noSchedulingPages')), h("p", null, instance.t('createFirstSchedulingPage')), h("button-component", { part: "nlc__create-new-cta", clickHandler: () => {
                this.createButtonClick.emit(this.host);
            } }, instance.t('createNewSchedulingPageButtonText')))))), this.state !== 'loading' &&
            this.configurations?.map((config, i) => {
                ...
                return (h("tr", { key: config?.id }, h("td", null, h("div", { class: "title" }, h("div", { class: "config-event-title", title: config?.event_booking?.title }, config?.event_booking?.title), h("div", { class: 'config-event-description' }, config?.event_booking?.description))), h("td", null, h("div", { class: "duration" }, this.getDurationString(config?.availability?.duration_minutes))), h("td", null, h("div", { class: "actions" }, h("button-component", { variant: 'basic', key: `edit-${i}`, clickHandler: event => {
                    ...
                    } }, h("edit-icon", { width: "16", height: "16" }), instance.t('editSchedulingPageButtonText')), h("select-dropdown", { class: {
                        last: lastTwo,
            ...
            }))), h("div", { class: "pagination" }, h("button", { class: "arrow left", onClick: () => this.previousPageClickedHandler(), disabled: this.previousCursors.length <= 0 }, h("chevron-icon", null)), h("button", { class: "arrow right", onClick: () => this.nextPageClickedHandler(), disabled: this.disableNextPageButton }, h("chevron-icon", null)))), this.state === 'error' && (h("div", { class: "error-container" }, h("p", { class: 'error' }, this.error))), !!this.deleteConfigurationId && (h("div", { class: "card-wrapper" }, h("div", { class: "card-modal" }, h("div", { class: "close-button" }, h("button-component", { tooltip: "Close", id: "close", variant: 'invisible', onClick: e => this.closeModal(e), part: "nfbf__close-button" }, h("close-icon", null))), h("div", { class: "header" }, h("h2", { slot: "card-title", part: "nfbf__title" }, instance.t('deleteSchedulingPageTitle'))), h("div", { class: "description title-desc" }, h("p", null, instance.t('deleteSchedulingPageDescription'))), h("div", { class: {
                footer: true,
            } }, h("button-component", { variant: 'basic', onClick: e => this.closeModal(e), part: "nfbf__button-outline nfbf__cancel-cta" }, `${instance.t('deleteSchedulingPageCancelButton')}`), h("button-component", { variant: 'destructive', onClick: e => this.handleConfirmDeleteButtonClicked(e), disabled: this.showDeleteButtonLoading, isLoading: this.showDeleteButtonLoading, part: "nfbf__button-outline nfbf__reschedule-cta" }, `${instance.t('deleteSchedulingPageConfirmButton')}`)))))));
    }
    get host() { return getElement(this); }
    static get watchers() { return {
