...
import { s as sanitizeHtml_1, i as instance, a as debug, l as sanitize } from './utils-14cfef23.js';
...
const NylasBookingForm = class {
    constructor(hostRef) {
        ...
        this.handleGuestChange = (guestIndex, email) => {
            ...
            guests[guestIndex] = sanitizeHtml_1(email);
    ...
    changeEmail(email) {
        ...
        this.email = sanitizeHtml_1(email);
