...
const CheckboxComponent = class {
    ...
    render() {
        return (h("div", { key: '846414c76901571e7c2591f2f73a1e81a75da8cb', class: "checkbox-container" }, h("label", { key: '0d4f046e5e16b98e8bf456b1a839764ef8ca2149' }, h("input", { key: '53e0e070c154543aa4b66c90d7506938a926fbed', type: "checkbox", name: this.name, checked: this.isChecked, onChange: () => this.toggleCheck() }), h("span", { key: '651d933ddb459c8b3226babc82bf0fa05663a389', class: "checkmark" }), h("slot", { key: '2b59df9447d01fb0000d4dfcfa3d029d48a4400e', name: "label" }, h("span", { key: '644a2d26e208e41545566471ebba96c93629af0c', class: "label" }, this.label))), this.error && h("p", { class: "error" }, this.error)));
    }
...
const NylasDateComponent = class {
    ...
    render() {
        return (h("label", { key: '9af33d8d1bfe9ae6b5caa99f28fac36e98a2275e', part: "ic__label", class: { error: !!this.error } }, this.label && (h("p", null, h("span", { class: "label" }, this.label), this.required && h("span", { class: "required" }, "*"))), h("div", { key: 'a1ef7829a3411f8d10edcfb4cf7637c14c4e2fe8', part: "ic__input_wrapper", class: "input_wrapper" }, h("input", { key: '8ced975367fda28dd8ead5402c2829001149704c', type: "date", name: this.name, part: "ic__date", readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, placeholder: this.placeholder, class: { error: !!this.error }, onInput: e => this.handleInput(e), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), h("slot", { key: 'fbe36b28c751122364a9a14934a6d8f1a74f78d5', name: "additional-input" })), this.error && h("span", { class: "error help-text" }, this.error)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
NylasDateComponent.style = NylasDateComponentStyle0;
...
export { CheckboxComponent as checkbox_component, NylasDateComponent as nylas_date_component, RadioButtonGroup as radio_button_group };

//# sourceMappingURL=checkbox-component_3.entry.js.map