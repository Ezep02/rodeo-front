...
import { a as debug } from './utils-c3434a93.js';
...
const InputDropdown = class {
    constructor(hostRef) {
        ...
        this.inputOptionChanged = createEvent(this, "inputOptionChanged", 7);
        this.name = undefined;
        this.options = [];
    ...
    render() {
        return (h("div", { key: '9d5c9dfd32cc331198fdda58da51ed89cee2ede0', class: "dropdown", part: "id_dropdown" }, h("input", { key: '6aa03686c990fd7fb44945807b5b67c53a762f91', type: "text", name: this.name, id: this.name, part: "id_dropdown-input", class: { dropbtn: true, open: this.isOpen }, value: this.inputValue, onClick: (e) => {
                this.toggleDropdown();
                this.shouldAutoScroll = true;
                this.handleClick(e);
...
export { InputDropdown as input_dropdown, TimePeriodSelector as time_period_selector };

//# sourceMappingURL=input-dropdown_2.entry.js.map