...
const ButtonComponent = class {
    ...
    render() {
        ...
        return (h("button", { key: 'c2ea933b85e63b6305793712f65cf335e7361866', class: className, disabled: this.disabled, type: "type", title: this.tooltip, onClick: this.clickHandler, onMouseOver: this.mouseOverHandler, onMouseOut: this.mouseOutHandler, onFocus: this.focusHandler, onBlur: this.blurHandler }, !!this.isLoading && h("loading-icon", { slot: "icon" }), h("slot", { key: 'faa43f2d964f51c5fd83e09cebc97b6eeb1fe5ab' })));
    }
};
...
const LoadingIconStyle0 = loadingCss;
...
const LoadingIcon = class {
    ...
    render() {
        return (h("div", { key: 'cedd3c86fe3766ab22b921d44d5fe9dabbb6e117', class: "wave" }, h("div", { key: 'f1bb2fd41da0ac750f67d974859a9daa32bd6ea1', class: "dot" }), h("div", { key: 'a6a07592c610b729b38aa2f827a88df3474169e5', class: "dot" }), h("div", { key: '49c403775d68c22bbaaf522e0ef9a4712873ab3b', class: "dot" })));
    }
};
LoadingIcon.style = LoadingIconStyle0;

export { ButtonComponent as button_component, LoadingIcon as loading_icon };

//# sourceMappingURL=button-component_2.entry.js.map