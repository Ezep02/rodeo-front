...
const U = (e, t, ...n) => {
  ...
  if (le || (W = !0, o.$tag$ === "slot" && (L && s.classList.add(L + "-s"), o.$flags$ |= o.$children$ ? (
    ...
    if (v || (v = o.$tag$ === "svg"), l = o.$elm$ = S.createElementNS(v ? me : ke, o.$flags$ & 2 ? "slot-fb" : o.$tag$), v && o.$tag$ === "foreignObject" && (v = !1), ce(null, o, v), Te(L) && l["s-si"] !== L && l.classList.add(l["s-si"] = L), o.$children$)
  ...
  let i;
  c === null ? (v = l === "svg" ? !0 : l === "foreignObject" ? !1 : v, l === "slot" || ce(e, t, v), o !== null && r !== null ? we(s, o, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), $e(s, null, t, r, 0, r.length - 1)) : o !== null && ae(o, 0, o.length - 1), v && l === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, de = (e) => {
  ...
  var s, o, r, l, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || w(null, null), $ = Le(t) ? t : U(null, null, t);
  ...
  let r;
  return t ? r = E(o, "componentWillLoad") : r = E(o, "componentWillUpdate"), r = V(r, () => E(o, "componentWillRender")), s(), V(r, () => He(e, o, t));
...
}, rt = (e) => ot().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-person-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
