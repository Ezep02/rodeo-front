...
let L, H, A, ot = !1, w = !1, W = !1, v = !1, I = null, M = !1;
const x = (t, e = "") => () => {
...
const F = (t, e, ...n) => {
...
}, Rt = (t) => se.map((e) => e(t)).find((e) => !!e), Ot = (t, e) => t != null && !z(t) ? e & 4 ? t === "false" ? !1 : t === "" || !!t : e & 2 ? parseFloat(t) : e & 1 ? String(t) : t : t, K = /* @__PURE__ */ new WeakMap(), Pt = (t, e, n) => {
  let s = B.get(t);
  ...
  const e = t.$cmpMeta$, n = t.$hostElement$, s = e.$flags$, l = x("attachStyles", e.$tagName$), r = Ct(n.shadowRoot ? n.shadowRoot : n.getRootNode(), e, t.$modeName$);
  ...
  if (ot || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? mt : Tt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ct(null, l, v), bt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== A && l["s-ol"] && (ft(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), e && R(l, e);
  }
  p.$flags$ &= -2;
}, $t = (t, e, n, s, l, r) => {
  ...
  for (let s = e; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      ht(l), r && (w = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, jt = (t, e, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || h.$tag$ === "slot") && R(f.$elm$.parentNode, !1), E(f, h, l), t.insertBefore(f.$elm$, $.$elm$.nextSibling), f = e[++r], h = s[--d];
    else if (C($, a, l))
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (e = n[s], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== l["s-hn"] && !T.experimentalSlotFixes)
          if (Z(e, r)) {
            ...
            w = !0, e["s-sn"] = e["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (e["s-sh"] = l["s-hn"], k.push({
              $slotRefNode$: l,
              $nodeToRelocate$: e
            })), e["s-sr"] && k.map((c) => {
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || U(null, null), $ = Et(e) ? e : F(null, null, e);
  ...
  $.$tag$ = null, $.$flags$ |= 4, t.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, L = i["s-sc"], H = i["s-cr"], ot = (u.$flags$ & 1) !== 0, w = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ut($.$elm$);
      for (const d of k) {
...
}, et = (t, e) => e in t, P = (t, e) => (0, console.error)(t, e), B = /* @__PURE__ */ new Map(), se = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, ne = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (t) => t(),
...
}, ce = (t) => oe().then(t), $e = /* @__PURE__ */ re(vt, !0), ae = ".sc-play-icon-h{display:flex}", fe = ae, St = Yt(class extends ne {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return F("svg", { key: "89505d8724aa9db256428426ecdf5876ec037dcd", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "auto", xmlns: "http://www.w3.org/2000/svg" }, F("path", { key: "6b53e880ecd128514c431f2590365aa40f4a59f1", d: "M21 12L3 21V3L21 12Z", stroke: "auto", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }));
  }
  static get style() {
    return fe;
  }
