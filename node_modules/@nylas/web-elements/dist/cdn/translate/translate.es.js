...
let L, D, _, ot = !1, F = !1, W = !1, v = !1, G = null, H = !1;
const T = (t, e = "") => () => {
}, Ct = "slot-fb{display:contents}slot-fb[hidden]{display:none}", Z = "http://www.w3.org/1999/xlink", I = {}, St = "http://www.w3.org/2000/svg", mt = "http://www.w3.org/1999/xhtml", kt = (t) => t != null, z = (t) => (t = typeof t, t === "object" || t === "function");
function bt(t) {
  var e, n, s;
...
const U = (t, e, ...n) => {
  ...
  const l = e.$elm$.nodeType === 11 && e.$elm$.host ? e.$elm$.host : e.$elm$, r = t && t.$attrs$ || I, o = e.$attrs$ || I;
  for (s in r)
  ...
  if (ot || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = C.createElementNS(v ? St : mt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ct(null, l, v), kt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || M(null, null), $ = Lt(e) ? e : U(null, null, e);
  ...
  try {
    G = e, e = e.render && e.render(), t.$flags$ &= -17, t.$flags$ |= 2, (k.hasRenderFn || k.reflect) && (k.vdomRender || k.reflect) && (k.hydrateServerSide || Pt(t, e, s));
  } catch (i) {
    O(i, t.$hostElement$);
  }
  return G = null, null;
...
}, et = (t, e) => e in t, O = (t, e) => (0, console.error)(t, e), j = /* @__PURE__ */ new Map(), ee = [], B = typeof window < "u" ? window : {}, C = B.document || { head: {} }, se = B.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (t) => t(),
...
}, re = (t) => le().then(t), ce = /* @__PURE__ */ ie(vt, !0), $e = ".sc-translate-icon-h{display:flex}", ae = $e, fe = Kt(class extends se {
  constructor() {
