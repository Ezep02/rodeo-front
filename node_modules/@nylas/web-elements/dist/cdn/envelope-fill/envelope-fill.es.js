...
let x, H, A, oe = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const L = (e, t = "") => () => {
...
const w = (e, t, ...n) => {
...
}, ie = (e, t) => "sc-" + (t && e.$flags$ & 32 ? e.$tagName$ + "-" + t : e.$tagName$), Z = (e, t, n, s, l, r) => {
  if (n !== s) {
  ...
  for (s in r)
    s in o || Z(l, s, r[s], void 0, n, t.$flags$);
  for (s in o)
    Z(l, s, r[s], o[s], n, t.$flags$);
}, j = (e, t, n, s) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      pe(l), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, Pe = (e, t, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || p.$tag$ === "slot") && R(f.$elm$.parentNode, !1), E(f, p, l), e.insertBefore(f.$elm$, $.$elm$.nextSibling), f = t[++r], p = s[--d];
    else if (F($, a, l))
      (f.$tag$ === "slot" || p.$tag$ === "slot") && R($.$elm$.parentNode, !1), E($, a, l), e.insertBefore($.$elm$, f.$elm$), $ = t[--u], a = s[++o];
    else {
      for (c = -1, i = r; i <= u; ++i)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = j(t && t[o], n, c, e) : (E(g, a, l), t[c] = void 0, y = g.$elm$), a = s[++o]) : (y = j(t && t[o], n, o, e), a = s[++o]), y && fe(f.$elm$).insertBefore(y, q(f.$elm$));
    }
...
}, he = (e, t) => (e.$flags$ |= 16, Be(e, e.$ancestorComponent$), ct(() => De(e, t))), De = (e, t) => {
