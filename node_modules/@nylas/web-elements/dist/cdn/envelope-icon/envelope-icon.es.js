...
let x, D, C, oe = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const L = (e, t = "") => () => {
...
const w = (e, t, ...n) => {
  ...
  const i = [], u = ($) => {
    for (let d = 0; d < $.length; d++)
      s = $[d], Array.isArray(s) ? u(s) : s != null && typeof s != "boolean" && ((o = typeof e != "function" && !z(s)) && (s = String(s)), o && c ? i[i.length - 1].$text$ += s : i.push(o ? H(null, s) : s), c = o);
  };
  if (u(n), t) {
      ...
      if (o || G.set(e, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        {
          ...
          const i = (s = h.$nonce$) !== null && s !== void 0 ? s : Le(S);
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = L("attachStyles", t.$tagName$), r = Fe(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(B, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(He, ""), n && h.rel(e, t, n, i), s && h.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, we = /\s/, J = (e) => e ? e.split(we) : [], re = "Capture", He = new RegExp(re + "$"), ce = (e, t, n, s) => {
  ...
  return o["s-hn"] = C, l.$flags$ & 3 && (o["s-sr"] = !0, o["s-cr"] = D, o["s-sn"] = l.$name$ || "", i = e && e.$children$ && e.$children$[n], i && i.$tag$ === l.$tag$ && e.$elm$ && A(e.$elm$, !1)), o;
}, A = (e, t) => {
  h.$flags$ |= 1;
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      pe(l), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Pe = (e, t, n, s, l = !1) => {
  let r = 0, o = 0, c = 0, i = 0, u = t.length - 1, f = t[0], $ = t[u], d = s.length - 1, a = s[0], p = s[d], y, g;
  for (; r <= u && o <= d; )
    if (f == null)
      f = t[++r];
    else if ($ == null)
      ...
      (f.$tag$ === "slot" || p.$tag$ === "slot") && A(f.$elm$.parentNode, !1), E(f, p, l), e.insertBefore(f.$elm$, $.$elm$.nextSibling), f = t[++r], p = s[--d];
    else if (F($, a, l))
      (f.$tag$ === "slot" || p.$tag$ === "slot") && A($.$elm$.parentNode, !1), E($, a, l), e.insertBefore($.$elm$, f.$elm$), $ = t[--u], a = s[++o];
    else {
      for (c = -1, i = r; i <= u; ++i)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = P(t && t[o], n, c, e) : (E(g, a, l), t[c] = void 0, y = g.$elm$), a = s[++o]) : (y = P(t && t[o], n, o, e), a = s[++o]), y && fe(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ce(e, t, v), l !== null && r !== null ? Pe(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), $e(s, null, t, r, 0, r.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, de = (e) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (t = n[s], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== l["s-hn"] && !b.experimentalSlotFixes)
          if (Y(t, r)) {
            ...
            U = !0, t["s-sn"] = t["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (t["s-sh"] = l["s-hn"], m.push({
              $slotRefNode$: l,
              $nodeToRelocate$: t
            })), t["s-sr"] && m.map((c) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || H(null, null), $ = Ee(t) ? t : w(null, null, t);
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], D = i["s-cr"], oe = (u.$flags$ & 1) !== 0, U = !1, E(f, $, n);
  {
    if (h.$flags$ |= 1, W) {
      ue($.$elm$);
      for (const d of m) {
...
}, he = (e, t) => (e.$flags$ |= 16, Be(e, e.$ancestorComponent$), $t(() => De(e, t))), De = (e, t) => {
  const n = e.$hostElement$, s = L("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let r;
  return t ? r = _(l, "componentWillLoad") : r = _(l, "componentWillUpdate"), r = V(r, () => _(l, "componentWillRender")), s(), V(r, () => Ne(e, l, t));
...
}, Ve = (e, t) => t & 4 ? S : t & 8 ? B : t & 16 ? S.body : e, et = (e) => lt ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), j = /* @__PURE__ */ new Map(), st = [], B = typeof window < "u" ? window : {}, S = B.document || { head: {} }, nt = B.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
  ...
  e.push(n), M || (M = !0, t && h.$flags$ & 4 ? ct(N) : h.raf(N));
}, le = (e) => {
  ...
  le(ne), le(ve), (M = ne.length > 0) && h.raf(N);
}, ct = (e) => ot().then(e), $t = /* @__PURE__ */ rt(ve, !0), at = ".sc-envelope-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
    super(), this.__registerHost(), this.width = "16", this.height = "13";
  }
  render() {
    return w("svg", { key: "6dc7bd6bb3aff1eaedef68c773b0b0c4e916a47a", width: "16", height: "13", viewBox: "0 0 16 13", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, w("path", { key: "9a041ba1b01f028888d8e8ad760b3e38605e3fe5", d: "M13.5 0C14.8807 0 16 1.11929 16 2.5V10.5C16 11.8807 14.8807 13 13.5 13H2.5C1.11929 13 0 11.8807 0 10.5V2.5C0 1.11929 1.11929 0 2.5 0H13.5ZM15 3.961L8.25351 7.93097C8.12311 8.00767 7.96661 8.02045 7.82751 7.96932L7.74649 7.93097L1 3.963V10.5C1 11.3284 1.67157 12 2.5 12H13.5C14.3284 12 15 11.3284 15 10.5V3.961ZM13.5 1H2.5C1.67157 1 1 1.67157 1 2.5V2.802L8 6.91991L15 2.801V2.5C15 1.67157 14.3284 1 13.5 1Z", fill: "currentColor" }));
  }
  static get style() {
    return ft;
  }
