...
let x, M, _, oe = !1, U = !1, W = !1, v = !1, I = null, H = !1;
const L = (e, t = "") => () => {
...
const w = (e, t, ...n) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? ke : Te, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), be(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], M = i["s-cr"], oe = (u.$flags$ & 1) !== 0, U = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ue($.$elm$);
      for (const d of m) {
