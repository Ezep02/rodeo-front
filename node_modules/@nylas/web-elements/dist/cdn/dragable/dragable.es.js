...
const M = (e, t, ...n) => {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = x("attachStyles", t.$tagName$), r = Oe(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(j, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(Me, ""), n && g.rel(e, t, n, i), s && g.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Fe = /\s/, J = (e) => e ? e.split(Fe) : [], re = "Capture", Me = new RegExp(re + "$"), ce = (e, t, n, s) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (C && s.classList.add(C + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), be(C) && o["s-si"] !== C && o.classList.add(o["s-si"] = C), l.$children$)
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || U(null, null), $ = Ce(t) ? t : M(null, null, t);
  ...
  let r;
  return t ? r = E(l, "componentWillLoad") : r = E(l, "componentWillUpdate"), r = V(r, () => E(l, "componentWillRender")), s(), V(r, () => He(e, l, t));
}, V = (e, t) => Be(e) ? e.then(t) : t(), Be = (e) => e instanceof Promise || e && e.then && typeof e.then == "function", He = async (e, t, n) => {
  ...
  try {
    Z = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || we(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return Z = null, null;
  ...
  e.push(n), H || (H = !0, t && g.$flags$ & 4 ? rt(N) : g.raf(N));
}, le = (e) => {
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-dragable-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
