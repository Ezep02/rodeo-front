...
const w = (e, t, ...n) => {
...
}, Ce = (e) => tt.map((t) => t(e)).find((t) => !!t), Ae = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, G = /* @__PURE__ */ new WeakMap(), Re = (e, t, n) => {
  let s = j.get(e);
      ...
      if (o || G.set(e, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        {
          ...
          const i = (s = h.$nonce$) !== null && s !== void 0 ? s : Te(S);
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(B, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(we, ""), n && h.rel(e, t, n, i), s && h.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ce(e, t, v), l !== null && r !== null ? He(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), $e(s, null, t, r, 0, r.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, de = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || H(null, null), $ = xe(t) ? t : w(null, null, t);
...
}, he = (e, t) => (e.$flags$ |= 16, je(e, e.$ancestorComponent$), ct(() => Be(e, t))), Be = (e, t) => {
  const n = e.$hostElement$, s = L("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let r;
  return t ? r = _(l, "componentWillLoad") : r = _(l, "componentWillUpdate"), r = V(r, () => _(l, "componentWillRender")), s(), V(r, () => Me(e, l, t));
}, V = (e, t) => De(e) ? e.then(t) : t(), De = (e) => e instanceof Promise || e && e.then && typeof e.then == "function", Me = async (e, t, n) => {
  ...
  if (!(t.$flags$ & 32) && (t.$flags$ |= 32, l = e.constructor, customElements.whenDefined(n.$tagName$).then(() => t.$flags$ |= 128), l.style)) {
    let o = l.style;
    typeof o != "string" && (o = o[t.$modeName$ = Ce(e)]);
...
}, Ye = (e, t) => t & 4 ? S : t & 8 ? B : t & 16 ? S.body : e, Ve = (e) => nt ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), j = /* @__PURE__ */ new Map(), tt = [], B = typeof window < "u" ? window : {}, S = B.document || { head: {} }, st = B.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
  ...
  e.push(n), M || (M = !0, t && h.$flags$ & 4 ? rt(N) : h.raf(N));
}, le = (e) => {
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-envelope-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
