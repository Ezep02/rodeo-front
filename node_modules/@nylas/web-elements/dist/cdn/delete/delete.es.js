...
const F = (e, t, ...n) => {
...
}, De = /\s/, J = (e) => e ? e.split(De) : [], re = "Capture", Fe = new RegExp(re + "$"), ce = (e, t, n, s) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || U(null, null), $ = xe(t) ? t : F(null, null, t);
  ...
  let r;
  return t ? r = E(l, "componentWillLoad") : r = E(l, "componentWillUpdate"), r = V(r, () => E(l, "componentWillRender")), s(), V(r, () => Be(e, l, t));
}, V = (e, t) => Me(e) ? e.then(t) : t(), Me = (e) => e instanceof Promise || e && e.then && typeof e.then == "function", Be = async (e, t, n) => {
  ...
  try {
    I = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || we(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return I = null, null;
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-delete-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
