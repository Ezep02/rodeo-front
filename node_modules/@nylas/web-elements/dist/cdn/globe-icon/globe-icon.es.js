...
const T = (e, t = "") => () => {
}, me = "slot-fb{display:contents}slot-fb[hidden]{display:none}", G = "http://www.w3.org/1999/xlink", I = {}, ke = "http://www.w3.org/2000/svg", be = "http://www.w3.org/1999/xhtml", Ce = (e) => e != null, Z = (e) => (e = typeof e, e === "object" || e === "function");
function Te(e) {
  var t, n, s;
...
const w = (e, t, ...n) => {
...
}, Ae = (e) => st.map((t) => t(e)).find((t) => !!t), Re = (e, t) => e != null && !Z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, X = /* @__PURE__ */ new WeakMap(), He = (e, t, n) => {
  let s = P.get(e);
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = T("attachStyles", t.$tagName$), r = Oe(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? ke : be, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), Ce(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || Pe(e, t, s));
  } catch (i) {
    H(i, e.$hostElement$);
  }
  return q = null, null;
...
}, ct = (e) => ot().then(e), $t = /* @__PURE__ */ rt(ve, !0), at = ".sc-globe-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
