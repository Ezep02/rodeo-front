...
let L, D, C, ot = !1, P = !1, W = !1, v = !1, I = null, M = !1;
const x = (t, e = "") => () => {
}, St = "slot-fb{display:contents}slot-fb[hidden]{display:none}", Q = "http://www.w3.org/1999/xlink", X = {}, mt = "http://www.w3.org/2000/svg", kt = "http://www.w3.org/1999/xhtml", bt = (t) => t != null, z = (t) => (t = typeof t, t === "object" || t === "function");
function Tt(t) {
  var e, n, s;
...
const H = (t, e, ...n) => {
...
}, Ct = (t) => ee.map((e) => e(t)).find((e) => !!e), At = (t, e) => t != null && !z(t) ? e & 4 ? t === "false" ? !1 : t === "" || !!t : e & 2 ? parseFloat(t) : e & 1 ? String(t) : t : t, K = /* @__PURE__ */ new WeakMap(), Rt = (t, e, n) => {
  let s = j.get(t);
  oe && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = e : s.replaceSync(e)) : s = e, j.set(t, s);
}, Ot = (t, e, n) => {
  var s;
  const l = it(e, n), r = j.get(l);
  if (t = t.nodeType === 11 ? t : S, r)
    if (typeof r == "string") {
      ...
      if (o || K.set(t, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        ...
        e.$flags$ & 4 && (c.innerHTML += St), o && o.add(l);
      }
    } else t.adoptedStyleSheets.includes(r) || (t.adoptedStyleSheets = [...t.adoptedStyleSheets, r]);
  return l;
}, Ft = (t) => {
  const e = t.$cmpMeta$, n = t.$hostElement$, s = e.$flags$, l = x("attachStyles", e.$tagName$), r = Ot(n.shadowRoot ? n.shadowRoot : n.getRootNode(), e, t.$modeName$);
  s & 10 && (n["s-sc"] = r, n.classList.add(r + "-h"), s & 2 && n.classList.add(r + "-s")), l();
}, it = (t, e) => "sc-" + (e && t.$flags$ & 32 ? t.$tagName$ + "-" + e : t.$tagName$), Z = (t, e, n, s, l, r) => {
  if (n !== s) {
    ...
    if (e === "class") {
      ...
      if (e === "ref")
        ...
        if (e[2] === "-" ? e = e.slice(3) : et(B, c) ? e = c.slice(2) : e = c[2] + e.slice(3), n || s) {
          ...
          e = e.replace(Ht, ""), n && p.rel(t, e, n, i), s && p.ael(t, e, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Pt = /\s/, J = (t) => t ? t.split(Pt) : [], rt = "Capture", Ht = new RegExp(rt + "$"), ct = (t, e, n, s) => {
  const l = e.$elm$.nodeType === 11 && e.$elm$.host ? e.$elm$.host : e.$elm$, r = t && t.$attrs$ || X, o = e.$attrs$ || X;
  for (s in r)
    s in o || Z(l, s, r[s], void 0, n, e.$flags$);
  for (s in o)
    Z(l, s, r[s], o[s], n, e.$flags$);
}, w = (t, e, n, s) => {
  ...
  if (ot || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? mt : kt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ct(null, l, v), bt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
      for (r = 0; r < l.$children$.length; ++r)
        c = w(t, l, r, o), c && o.appendChild(c);
    l.$tag$ === "svg" ? v = !1 : o.tagName === "foreignObject" && (v = !0);
  }
  return o["s-hn"] = C, l.$flags$ & 3 && (o["s-sr"] = !0, o["s-cr"] = D, o["s-sn"] = l.$name$ || "", i = t && t.$children$ && t.$children$[n], i && i.$tag$ === l.$tag$ && t.$elm$ && A(t.$elm$, !1)), o;
}, A = (t, e) => {
  p.$flags$ |= 1;
  const n = t.childNodes;
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== C && l["s-ol"] && (ft(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), e && A(l, e);
  }
  p.$flags$ &= -2;
}, $t = (t, e, n, s, l, r) => {
  let o = t["s-cr"] && t["s-cr"].parentNode || t, c;
  for (o.shadowRoot && o.tagName === C && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = w(null, n, l, t), c && (s[l].$elm$ = c, o.insertBefore(c, q(e))));
}, at = (t, e, n) => {
  for (let s = e; s <= n; ++s) {
    const l = t[s];
    if (l) {
      const r = l.$elm$;
      ht(l), r && (P = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Ut = (t, e, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A(f.$elm$.parentNode, !1), E(f, h, l), t.insertBefore(f.$elm$, $.$elm$.nextSibling), f = e[++r], h = s[--d];
    else if (F($, a, l))
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A($.$elm$.parentNode, !1), E($, a, l), t.insertBefore($.$elm$, f.$elm$), $ = e[--u], a = s[++o];
    else {
      for (c = -1, i = r; i <= u; ++i)
      ...
      c >= 0 ? (g = e[c], g.$tag$ !== a.$tag$ ? y = w(e && e[o], n, c, t) : (E(g, a, l), e[c] = void 0, y = g.$elm$), a = s[++o]) : (y = w(e && e[o], n, o, t), a = s[++o]), y && ft(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ct(t, e, v), l !== null && r !== null ? Ut(s, l, e, r, n) : r !== null ? (t.$text$ !== null && (s.textContent = ""), $t(s, null, e, r, 0, r.length - 1)) : l !== null && at(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : t.$text$ !== c && (s.data = c);
}, dt = (t) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (e = n[s], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== l["s-hn"] && !b.experimentalSlotFixes)
          if (Y(e, r)) {
            ...
            P = !0, e["s-sn"] = e["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (e["s-sh"] = l["s-hn"], m.push({
              $slotRefNode$: l,
              $nodeToRelocate$: e
            })), e["s-sr"] && m.map((c) => {
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || U(null, null), $ = Lt(e) ? e : H(null, null, e);
  ...
  $.$tag$ = null, $.$flags$ |= 4, t.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, L = i["s-sc"], D = i["s-cr"], ot = (u.$flags$ & 1) !== 0, P = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ut($.$elm$);
      for (const d of m) {
  ...
  let r;
  return e ? r = _(l, "componentWillLoad") : r = _(l, "componentWillUpdate"), r = V(r, () => _(l, "componentWillRender")), s(), V(r, () => Mt(t, l, e));
  ...
  try {
    I = e, e = e.render && e.render(), t.$flags$ &= -17, t.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || wt(t, e, s));
  } catch (i) {
    O(i, t.$hostElement$);
  }
  return I = null, null;
...
}, re = (t) => le().then(t), ce = /* @__PURE__ */ ie(vt, !0), $e = ".sc-paintbrush-fill-icon-h{display:flex}", ae = $e, fe = Zt(class extends se {
  constructor() {
