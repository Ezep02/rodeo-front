...
let x, H, _, oe = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const L = (e, t = "") => () => {
}, ke = "slot-fb{display:contents}slot-fb[hidden]{display:none}", Q = "http://www.w3.org/1999/xlink", X = {}, me = "http://www.w3.org/2000/svg", Te = "http://www.w3.org/1999/xhtml", be = (e) => e != null, z = (e) => (e = typeof e, e === "object" || e === "function");
function Le(e) {
  var t, n, s;
...
const w = (e, t, ...n) => {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = L("attachStyles", t.$tagName$), c = Fe(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : Te, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), be(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
      for (c = 0; c < l.$children$.length; ++c)
        r = j(e, l, c, o), r && o.appendChild(r);
    l.$tag$ === "svg" ? v = !1 : o.tagName === "foreignObject" && (v = !0);
  }
  return o["s-hn"] = _, l.$flags$ & 3 && (o["s-sr"] = !0, o["s-cr"] = H, o["s-sn"] = l.$name$ || "", i = e && e.$children$ && e.$children$[n], i && i.$tag$ === l.$tag$ && e.$elm$ && A(e.$elm$, !1)), o;
}, A = (e, t) => {
  p.$flags$ |= 1;
  const n = e.childNodes;
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && (fe(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && A(l, t);
  }
  p.$flags$ &= -2;
}, $e = (e, t, n, s, l, c) => {
  let o = e["s-cr"] && e["s-cr"].parentNode || e, r;
  for (o.shadowRoot && o.tagName === _ && (o = o.shadowRoot); l <= c; ++l)
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const c = l.$elm$;
      he(l), c && (U = !0, c["s-ol"] ? c["s-ol"].remove() : A(c, !0), c.remove());
    }
  }
}, je = (e, t, n, s, l = !1) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (t = n[s], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== l["s-hn"] && !T.experimentalSlotFixes)
          if (Y(t, c)) {
            ...
            U = !0, t["s-sn"] = t["s-sn"] || c, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (t["s-sh"] = l["s-hn"], k.push({
              $slotRefNode$: l,
              $nodeToRelocate$: t
            })), t["s-sr"] && k.map((r) => {
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], H = i["s-cr"], oe = (u.$flags$ & 1) !== 0, U = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ue($.$elm$);
      for (const d of k) {
  ...
  let c;
  return t ? c = C(l, "componentWillLoad") : c = C(l, "componentWillUpdate"), c = V(c, () => C(l, "componentWillRender")), s(), V(c, () => Ne(e, l, t));
  ...
  try {
    I = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Be(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return I = null, null;
  ...
  e.$ancestorComponent$, C(l, "componentDidRender"), e.$flags$ & 64 ? (C(l, "componentDidUpdate"), s()) : (e.$flags$ |= 64, C(l, "componentDidLoad"), s());
}, C = (e, t, n) => {
  if (e && e[t])
    try {
      return e[t](n);
  ...
  if (!(p.$flags$ & 1)) {
    ...
    n.$flags$ & 12 && Ge(e), n.$members$ && Object.entries(n.$members$).map(([l, [c]]) => {
...
}, rt = (e) => ot().then(e), $t = /* @__PURE__ */ ct(ve, !0), at = ".sc-clock-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
    super(), this.__registerHost(), this.width = "16", this.height = "16";
  }
  render() {
    return w("svg", { key: "efed3ea03c496391e7ac5582574691c9c9031020", width: this.width, height: this.height, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, w("path", { key: "691c0a73bbd4c71380e621dfe123cf7db72f7a61", d: "M8 0.5C12.1421 0.5 15.5 3.85786 15.5 8C15.5 12.1421 12.1421 15.5 8 15.5C3.85786 15.5 0.5 12.1421 0.5 8C0.5 3.85786 3.85786 0.5 8 0.5ZM8 1.4375C4.37563 1.4375 1.4375 4.37563 1.4375 8C1.4375 11.6244 4.37563 14.5625 8 14.5625C11.6244 14.5625 14.5625 11.6244 14.5625 8C14.5625 4.37563 11.6244 1.4375 8 1.4375ZM7.53125 3.3125C7.76137 3.3125 7.95276 3.47832 7.99245 3.69699L8 3.78125V8H10.3438C10.6026 8 10.8125 8.20987 10.8125 8.46875C10.8125 8.69887 10.6467 8.89026 10.428 8.92995L10.3438 8.9375H7.53125C7.30113 8.9375 7.10974 8.77168 7.07005 8.55301L7.0625 8.46875V3.78125C7.0625 3.52237 7.27237 3.3125 7.53125 3.3125Z", fill: "currentColor" }));
  }
  static get style() {
    return ft;
  }
