...
const w = (e, t, ...n) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), be(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  let r;
  return t ? r = A(l, "componentWillLoad") : r = A(l, "componentWillUpdate"), r = V(r, () => A(l, "componentWillRender")), s(), V(r, () => He(e, l, t));
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-add-circle-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
