...
const v = (e, t, ...n) => {
  ...
  if (e = e.nodeType === 11 ? e : m, i)
    if (typeof i == "string") {
      ...
      if (l || G.set(e, l = /* @__PURE__ */ new Set()), !l.has(o)) {
        ...
        t.$flags$ & 4 && (a.innerHTML += Se), l && l.add(o);
      }
    } else e.adoptedStyleSheets.includes(i) || (e.adoptedStyleSheets = [...e.adoptedStyleSheets, i]);
  return o;
}, Ue = (e) => {
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, o = T("attachStyles", t.$tagName$), i = Me(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  s & 10 && (n["s-sc"] = i, n.classList.add(i + "-h"), s & 2 && n.classList.add(i + "-s")), o();
}, re = (e, t) => "sc-" + (t && e.$flags$ & 32 ? e.$tagName$ + "-" + t : e.$tagName$), J = (e, t, n, s, o, i) => {
  if (n !== s) {
...
}, je = /\s/, Y = (e) => e ? e.split(je) : [], ie = "Capture", ze = new RegExp(ie + "$"), ae = (e, t, n, s) => {
  ...
  if (le || (I = !0, o.$tag$ === "slot" && (C && s.classList.add(C + "-s"), o.$flags$ |= o.$children$ ? (
    ...
    if (b || (b = o.$tag$ === "svg"), l = o.$elm$ = m.createElementNS(b ? xe : we, o.$flags$ & 2 ? "slot-fb" : o.$tag$), b && o.$tag$ === "foreignObject" && (b = !1), ae(null, o, b), Te(C) && l["s-si"] !== C && l.classList.add(l["s-si"] = C), o.$children$)
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (o) {
      const i = o.$elm$;
      pe(o), i && (F = !0, i["s-ol"] ? i["s-ol"].remove() : O(i, !0), i.remove());
    }
  }
}, He = (e, t, n, s, o = !1) => {
  ...
  for (; i <= u && l <= $; )
    if (d == null)
      ...
      a >= 0 ? (g = t[a], g.$tag$ !== f.$tag$ ? y = P(t && t[l], n, a, e) : (E(g, f, o), t[a] = void 0, y = g.$elm$), f = s[++l]) : (y = P(t && t[l], n, l, e), f = s[++l]), y && de(d.$elm$).insertBefore(y, q(d.$elm$));
    }
  i > u ? ce(e, s[$ + 1] == null ? null : s[$ + 1].$elm$, n, s, l, $) : l > $ && fe(t, i, u);
  ...
  let r;
  a === null ? (b = l === "svg" ? !0 : l === "foreignObject" ? !1 : b, l === "slot" || ae(e, t, b), o !== null && i !== null ? He(s, o, t, i, n) : i !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, i, 0, i.length - 1)) : o !== null && fe(o, 0, o.length - 1), b && l === "svg" && (b = !1)) : (r = s["s-cr"]) ? r.parentNode.textContent = a : e.$text$ !== a && (s.data = a);
}, $e = (e) => {
  ...
  let i;
  return t ? i = L(o, "componentWillLoad") : i = L(o, "componentWillUpdate"), i = V(i, () => L(o, "componentWillRender")), s(), V(i, () => Ke(e, o, t));
  ...
  if (!(h.$flags$ & 1)) {
    ...
    t.$flags$ & 1 ? (ye(e, t, n.$listeners$), t != null && t.$lazyInstance$ ? ee(t.$lazyInstance$) : t != null && t.$onReadyPromise$ && t.$onReadyPromise$.then(() => ee(t.$lazyInstance$))) : (t.$flags$ |= 1, // TODO(STENCIL-854): Remove code related to legacy shadowDomShim field
    n.$flags$ & 12 && et(e), n.$members$ && Object.entries(n.$members$).map(([o, [i]]) => {
  ...
  n && n.map(([o, i, l]) => {
    const a = nt(e, o), r = st(t, l), u = ot(o);
...
}, nt = (e, t) => t & 4 ? m : t & 8 ? U : t & 16 ? m.body : e, ot = (e) => it ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
  ...
  return ye(e, n, t.$listeners$), be.set(e, n);
...
}, dt = (e) => at().then(e), $t = /* @__PURE__ */ ft(me, !0), ut = ".sc-chevron-icon-h{display:flex}", pt = ut, ht = ge(class extends ve {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "24";
  }
  render() {
    return v("svg", { key: "7aba61db23989386b629855aca2a4e8f9bf4362c", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, v("path", { key: "20bf8190f264566aabe644a60205498ea8796bd9", fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" }));
  }
  static get style() {
    return pt;
  }
...
const yt = ':host{display:block;position:relative;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif;width:100%}@media screen and (max-width: 768px){:host{position:unset}}label{display:flex;color:var(--nylas-base-800, #293056);font-size:14px;font-style:normal;font-weight:400;line-height:150%;flex-direction:column;gap:4px;font-family:var(--nylas-font-family);font-size:16px;color:var(--nylas-base-800)}label.error{color:var(--nylas-error)}label span.required{color:var(--nylas-error);padding:0 0.25rem}label p{margin:0}label .error{color:var(--nylas-error)}.color-picker-container{display:flex;height:48px;padding-left:16px;align-items:center;gap:8px;align-self:stretch;border-radius:var(--nylas-border-radius-2x);border:1px solid var(--nylas-base-300);background:var(--nylas-base-0);width:-webkit-fill-available;color:var(--nylas-base-900);font-size:16px;font-style:normal;font-weight:400;line-height:150%;width:-moz-available;width:-webkit-fill-available;padding-left:0;gap:0;overflow:hidden}.color-picker-container:focus{outline-color:var(--nylas-primary)}.color-picker-container.error{border-radius:var(--nylas-border-radius-2x);font-weight:600;border-color:var(--nylas-error);border-width:2px}.color-picker-container.error::placeholder{font-weight:400}.color-picker-container::placeholder{color:var(--nylas-base-300)}.color-picker-container input{display:flex;align-items:center;height:100%;appearance:none;border:none;border-right:1px solid var(--nylas-base-200);background:transparent}.color-picker-container input::-webkit-color-swatch{min-width:30px;border-radius:0.25rem;border:1px solid var(--nylas-base-200);margin:0.25rem}.color-picker-container input::-moz-color-swatch{min-width:30px;border-radius:0.25rem;border:1px solid var(--nylas-base-200);margin:0.25rem}.color-picker-container.error{border:1px solid var(--nylas-error)}.color-picker-container:hover,.color-picker-container:active{outline:1px solid var(--nylas-primary)}.color-picker-container:active{outline:2px solid var(--nylas-primary)}.color-picker-container label{width:100%}.labelBtn{color:var(--nylas-base-800);padding:14px;font-size:16px;font-family:var(--nylas-font-family);cursor:pointer;display:flex;flex-direction:row;justify-content:space-between;width:100%;gap:0.5rem;background:transparent;border:none}.labelBtn.error{border:1px solid var(--nylas-error)}.labelBtn.focus{background:transparent}.labelBtn:hover,.labelBtn:active{outline:1px solid var(--nylas-primary)}.labelBtn span.chevron{display:flex;align-self:center}.labelBtn span.open{transform:rotate(90deg)}.labelBtn span.closed{transform:rotate(270deg)}.labelBtn span.selected-option{text-overflow:ellipsis;overflow:hidden;white-space:nowrap;max-width:144px;font-size:14px;line-height:20px}@media screen and (max-width: 768px){.labelBtn span.selected-option{max-width:124px;font-size:16px}}', bt = yt, ke = ge(class extends ve {
  ...
  render() {
    return v("div", { key: "821db0f91c515797a660b950a35360c3c6b04a31", class: "color-picker-container", part: "icp_color-picker", tabindex: "0", onKeyDown: (t) => this.handleKeyDown(t) }, v("input", { key: "415a71f72ed2450052720b31f31a2d289ce6bc4d", type: "color", ref: (t) => this.inputRef = t, id: this.name, name: this.name, value: this.selectedColor, tabindex: "-1", onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onInput: (t) => this.handleInput(t), onChange: (t) => this.handleChange(t), onKeyDown: (t) => this.handleKeyDown(t) }), v("label", { key: "2e5b60172e2b64528377ec40f6a8f88633372186", part: "icp_color-picker-button", htmlFor: this.name, class: { labelBtn: !0, open: this.isOpen, error: !!this.errorMessage }, "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? "true" : "false", "aria-label": this.name }, v("span", { key: "6e6e6fd8b989e877004a2bb5b33342c8a27c492c", class: "selected-option", part: "icp_color-picker-button-selected-label" }, this.selectedColor || "Select a color"), v("span", { key: "4deb0977faf3c2259bc8e0e2aa2720c59503ec12", class: {
      open: this.isOpen,
      closed: !this.isOpen,
      chevron: !0
    }, "aria-hidden": "true" }, v("chevron-icon", { key: "da16cec17511ed70e1a4dcdb8f2f08a3b7682674", width: "16", height: "16" })), this.errorMessage && v("span", { class: "error help-text" }, this.errorMessage)));
  }
  get el() {
    return this;
  }
