...
const b = (e, t = "") => () => {
}, Se = "slot-fb{display:contents}slot-fb[hidden]{display:none}", I = "http://www.w3.org/1999/xlink", Q = {}, me = "http://www.w3.org/2000/svg", ke = "http://www.w3.org/1999/xhtml", Te = (e) => e != null, z = (e) => (e = typeof e, e === "object" || e === "function");
function Ce(e) {
  var t, n, s;
...
const w = (e, t, ...n) => {
  ...
  const i = [], u = (a) => {
    for (let d = 0; d < a.length; d++)
      s = a[d], Array.isArray(s) ? u(s) : s != null && typeof s != "boolean" && ((o = typeof e != "function" && !z(s)) && (s = String(s)), o && c ? i[i.length - 1].$text$ += s : i.push(o ? F(null, s) : s), c = o);
  };
  if (u(n), t) {
...
}, He = /\s/, J = (e) => e ? e.split(He) : [], re = "Capture", we = new RegExp(re + "$"), ce = (e, t, n, s) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), Te(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A(f.$elm$.parentNode, !1), L(f, h, l), e.insertBefore(f.$elm$, a.$elm$.nextSibling), f = t[++r], h = s[--d];
    else if (M(a, $, l))
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A(a.$elm$.parentNode, !1), L(a, $, l), e.insertBefore(a.$elm$, f.$elm$), a = t[--u], $ = s[++o];
    else {
      for (c = -1, i = r; i <= u; ++i)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== $.$tag$ ? y = U(t && t[o], n, c, e) : (L(g, $, l), t[c] = void 0, y = g.$elm$), $ = s[++o]) : (y = U(t && t[o], n, o, e), $ = s[++o]), y && fe(f.$elm$).insertBefore(y, Z(f.$elm$));
    }
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ce(e, t, v), l !== null && r !== null ? Fe(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ae(s, null, t, r, 0, r.length - 1)) : l !== null && $e(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, de = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || F(null, null), a = xe(t) ? t : w(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], B = i["s-cr"], oe = (u.$flags$ & 1) !== 0, H = !1, L(f, a, n);
  {
    if (p.$flags$ |= 1, W) {
      ue(a.$elm$);
      for (const d of m) {
      ...
      for (const d of m) {
        ...
        if (h) {
          ...
          let g = h.nextSibling;
          {
            let C = (s = $["s-ol"]) === null || s === void 0 ? void 0 : s.previousSibling;
            for (; C; ) {
    ...
    H && de(a.$elm$), p.$flags$ &= -2, m.length = 0;
  }
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Ue(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return q = null, null;
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), P = /* @__PURE__ */ new Map(), tt = [], j = typeof window < "u" ? window : {}, S = j.document || { head: {} }, st = j.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), at = ".sc-calendar-icon-h{display:flex}", $t = at, ft = Ke(class extends st {
  constructor() {
