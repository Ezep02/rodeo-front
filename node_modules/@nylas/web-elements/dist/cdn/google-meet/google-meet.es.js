...
const x = (e, t = "") => () => {
}, Se = "slot-fb{display:contents}slot-fb[hidden]{display:none}", G = "http://www.w3.org/1999/xlink", I = {}, be = "http://www.w3.org/2000/svg", ke = "http://www.w3.org/1999/xhtml", me = (e) => e != null, z = (e) => (e = typeof e, e === "object" || e === "function");
function Le(e) {
  var t, n, s;
...
const v = (e, t, ...n) => {
...
}, Ae = (e) => tt.map((t) => t(e)).find((t) => !!t), Re = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, X = /* @__PURE__ */ new WeakMap(), Ce = (e, t, n) => {
  let s = U.get(e);
  ot && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = t : s.replaceSync(t)) : s = t, U.set(e, s);
}, Oe = (e, t, n) => {
  var s;
      ...
      if (o || X.set(e, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        {
          ...
          const i = (s = p.$nonce$) !== null && s !== void 0 ? s : Le(b);
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(D, r) ? t = r.slice(2) : t = r[2] + t.slice(3), n || s) {
          ...
          t = t.replace(He, ""), n && p.rel(e, t, n, i), s && p.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Fe = /\s/, J = (e) => e ? e.split(Fe) : [], ce = "Capture", He = new RegExp(ce + "$"), re = (e, t, n, s) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (E && s.classList.add(E + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (S || (S = l.$tag$ === "svg"), o = l.$elm$ = b.createElementNS(S ? be : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), S && l.$tag$ === "foreignObject" && (S = !1), re(null, l, S), me(E) && o["s-si"] !== E && o.classList.add(o["s-si"] = E), l.$children$)
  ...
  let i;
  r === null ? (S = o === "svg" ? !0 : o === "foreignObject" ? !1 : S, o === "slot" || re(e, t, S), l !== null && c !== null ? we(s, l, t, c, n) : c !== null ? (e.$text$ !== null && (s.textContent = ""), ae(s, null, t, c, 0, c.length - 1)) : l !== null && $e(l, 0, l.length - 1), S && o === "svg" && (S = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (s.data = r);
}, de = (e) => {
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || w(null, null), a = xe(t) ? t : v(null, null, t);
...
}, pe = (e, t) => (e.$flags$ |= 16, Ue(e, e.$ancestorComponent$), rt(() => De(e, t))), De = (e, t) => {
  const n = e.$hostElement$, s = x("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let c;
  return t ? c = A(l, "componentWillLoad") : c = A(l, "componentWillUpdate"), c = V(c, () => A(l, "componentWillRender")), s(), V(c, () => Be(e, l, t));
}, V = (e, t) => je(e) ? e.then(t) : t(), je = (e) => e instanceof Promise || e && e.then && typeof e.then == "function", Be = async (e, t, n) => {
  ...
  try {
    Z = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (L.hasRenderFn || L.reflect) && (L.vdomRender || L.reflect) && (L.hydrateServerSide || Pe(e, t, s));
  } catch (i) {
    M(i, e.$hostElement$);
  }
  return Z = null, null;
  ...
  if (!(p.$flags$ & 1)) {
    ...
    n.$flags$ & 12 && Qe(e), n.$members$ && Object.entries(n.$members$).map(([l, [c]]) => {
...
}, Ye = (e, t) => t & 4 ? b : t & 8 ? D : t & 16 ? b.body : e, Ve = (e) => nt ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
...
}, te = (e, t) => t in e, M = (e, t) => (0, console.error)(e, t), U = /* @__PURE__ */ new Map(), tt = [], D = typeof window < "u" ? window : {}, b = D.document || { head: {} }, st = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, ct = (e) => lt().then(e), rt = /* @__PURE__ */ it(ve, !0), at = ".sc-google-meet-icon-h{display:flex}", $t = at, ft = Ke(class extends st {
  constructor() {
