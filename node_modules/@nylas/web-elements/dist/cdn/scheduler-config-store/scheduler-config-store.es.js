...
const m = (e, t = "") => () => {
  ...
  for (let s = o.length - 1; s >= 0; s--) {
    const n = o[s];
    n["s-hn"] !== A && n["s-ol"] && (ie(n).insertBefore(n, H(n)), n["s-ol"].remove(), n["s-ol"] = void 0, n["s-sh"] = void 0, W = !0), t && C(n, t);
  }
  x.$flags$ &= -2;
}, le = (e, t, o, s, n, i) => {
  let l = e["s-cr"] && e["s-cr"].parentNode || e, f;
  for (l.shadowRoot && l.tagName === A && (l = l.shadowRoot); n <= i; ++n)
    s[n] && (f = M(null, o, n, e), f && (s[n].$elm$ = f, l.insertBefore(f, H(t))));
}, re = (e, t, o) => {
  for (let s = t; s <= o; ++s) {
    const n = e[s];
    if (n) {
  ...
  for (; i <= h && l <= p; )
    if (a == null)
      ...
      f >= 0 ? (g = t[f], g.$tag$ !== $.$tag$ ? u = M(t && t[l], o, f, e) : (L(g, $, n), t[f] = void 0, u = g.$elm$), $ = s[++l]) : (u = M(t && t[l], o, l, e), $ = s[++l]), u && ie(a.$elm$).insertBefore(u, H(a.$elm$));
    }
  i > h ? le(e, s[p + 1] == null ? null : s[p + 1].$elm$, o, s, l, p) : l > p && re(t, i, h);
}, D = (e, t, o = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : o ? !0 : e.$key$ === t.$key$ : !1, H = (e) => e && e["s-ol"] || e, ie = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, L = (e, t, o = !1) => {
...
}, _e = /* @__PURE__ */ new WeakMap(), me = (e) => _e.get(e), Z = (e, t) => t in e, b = (e, t) => (0, console.error)(e, t), q = typeof window < "u" ? window : {}, U = q.document || { head: {} };
q.HTMLElement;
const x = {
  $flags$: 0,
  $resourcesUrl$: "",
...
}, F = (e) => typeof e == "function" ? e() : e, He = (e, t = (o, s) => o !== s) => {
  const o = F(e);
