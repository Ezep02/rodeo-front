...
const w = (e, t, ...n) => {
  ...
  return o["s-hn"] = _, l.$flags$ & 3 && (o["s-sr"] = !0, o["s-cr"] = M, o["s-sn"] = l.$name$ || "", i = e && e.$children$ && e.$children$[n], i && i.$tag$ === l.$tag$ && e.$elm$ && R(e.$elm$, !1)), o;
}, R = (e, t) => {
  p.$flags$ |= 1;
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      he(l), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, je = (e, t, n, s, l = !1) => {
...
}, ct = (e) => ot().then(e), $t = /* @__PURE__ */ rt(ve, !0), at = ".sc-add-circle-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "25";
  }
  render() {
    return w("svg", { key: "bebcd56afbd82c29d67e8e36ffc5826ab463b589", width: this.width, height: this.height, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, w("path", { key: "17e654b7803552ad184a95480bfbd4aeeaa70e89", d: "M12 2.5c5.523 0 10 4.477 10 10s-4.477 10-10 10-10-4.477-10-10 4.477-10 10-10ZM12 4a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17Zm0 3.5a.75.75 0 0 1 .75.75v3.5h3.5a.75.75 0 0 1 0 1.5h-3.5v3.5a.75.75 0 0 1-1.5 0v-3.5h-3.5a.75.75 0 0 1 0-1.5h3.5v-3.5A.75.75 0 0 1 12 7.5Z", fill: "currentColor" }));
  }
  static get style() {
    return ft;
  }
