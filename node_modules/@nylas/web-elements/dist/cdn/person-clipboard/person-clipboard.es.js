...
const M = (e, t, ...n) => {
  ...
  let s = w.get(e);
  lt && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = t : s.replaceSync(t)) : s = t, w.set(e, s);
}, He = (e, t, n) => {
  var s;
  ...
  if (le || (W = !0, o.$tag$ === "slot" && (x && s.classList.add(x + "-s"), o.$flags$ |= o.$children$ ? (
    ...
    if (v || (v = o.$tag$ === "svg"), l = o.$elm$ = S.createElementNS(v ? me : ke, o.$flags$ & 2 ? "slot-fb" : o.$tag$), v && o.$tag$ === "foreignObject" && (v = !1), ce(null, o, v), Ce(x) && l["s-si"] !== x && l.classList.add(l["s-si"] = x), o.$children$)
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (o) {
      const r = o.$elm$;
      he(o), r && (P = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Fe = (e, t, n, s, o = !1) => {
  ...
  for (; r <= u && l <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A(f.$elm$.parentNode, !1), L(f, h, o), e.insertBefore(f.$elm$, $.$elm$.nextSibling), f = t[++r], h = s[--d];
    else if (O($, a, o))
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A($.$elm$.parentNode, !1), L($, a, o), e.insertBefore($.$elm$, f.$elm$), $ = t[--u], a = s[++l];
    else {
      for (c = -1, i = r; i <= u; ++i)
  ...
  let i;
  c === null ? (v = l === "svg" ? !0 : l === "foreignObject" ? !1 : v, l === "slot" || ce(e, t, v), o !== null && r !== null ? Fe(s, o, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), $e(s, null, t, r, 0, r.length - 1)) : o !== null && ae(o, 0, o.length - 1), v && l === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, de = (e) => {
  ...
  oe(ne), oe(ve), (D = ne.length > 0) && p.raf(N);
}, rt = (e) => ot().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-person-clipboard-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
