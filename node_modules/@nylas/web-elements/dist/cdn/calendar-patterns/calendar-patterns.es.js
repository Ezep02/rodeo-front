...
let x, B, C, oe = !1, P = !1, W = !1, v = !1, Z = null, D = !1;
const L = (e, t = "") => () => {
...
const M = (e, t, ...n) => {
  ...
  let s = w.get(e);
  ot && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = t : s.replaceSync(t)) : s = t, w.set(e, s);
}, He = (e, t, n) => {
  var s;
  const l = ie(t, n), r = w.get(l);
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(j, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(Me, ""), n && p.rel(e, t, n, i), s && p.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Pe = /\s/, J = (e) => e ? e.split(Pe) : [], re = "Capture", Me = new RegExp(re + "$"), ce = (e, t, n, s) => {
  ...
  return o["s-hn"] = C, l.$flags$ & 3 && (o["s-sr"] = !0, o["s-cr"] = B, o["s-sn"] = l.$name$ || "", i = e && e.$children$ && e.$children$[n], i && i.$tag$ === l.$tag$ && e.$elm$ && A(e.$elm$, !1)), o;
}, A = (e, t) => {
  p.$flags$ |= 1;
  ...
  for (o.shadowRoot && o.tagName === C && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = U(null, n, l, e), c && (s[l].$elm$ = c, o.insertBefore(c, q(t))));
}, $e = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
      const r = l.$elm$;
      he(l), r && (P = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Fe = (e, t, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== $.$tag$ ? y = U(t && t[o], n, c, e) : (E(g, $, l), t[c] = void 0, y = g.$elm$), $ = s[++o]) : (y = U(t && t[o], n, o, e), $ = s[++o]), y && fe(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  r > u ? ae(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && $e(t, r, u);
}, O = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, fe = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, E = (e, t, n = !1) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (t = n[s], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== l["s-hn"] && !T.experimentalSlotFixes)
          if (Y(t, r)) {
            ...
            P = !0, t["s-sn"] = t["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (t["s-sh"] = l["s-hn"], m.push({
              $slotRefNode$: l,
              $nodeToRelocate$: t
            })), t["s-sr"] && m.map((c) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || F(null, null), a = xe(t) ? t : M(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], B = i["s-cr"], oe = (u.$flags$ & 1) !== 0, P = !1, E(f, a, n);
  {
    if (p.$flags$ |= 1, W) {
      ue(a.$elm$);
      for (const d of m) {
      ...
      for (const d of m) {
        ...
        if (h) {
          ...
          let g = h.nextSibling;
          {
            let b = (s = $["s-ol"]) === null || s === void 0 ? void 0 : s.previousSibling;
            for (; b; ) {
    ...
    P && de(a.$elm$), p.$flags$ &= -2, m.length = 0;
  }
...
}, pe = (e, t) => (e.$flags$ |= 16, we(e, e.$ancestorComponent$), ct(() => je(e, t))), je = (e, t) => {
  ...
  try {
    Z = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Ue(e, t, s));
  } catch (i) {
    H(i, e.$hostElement$);
  }
  return Z = null, null;
...
}, te = (e, t) => t in e, H = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), tt = [], j = typeof window < "u" ? window : {}, S = j.document || { head: {} }, st = j.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
function ut() {
  if (typeof customElements > "u")
    return;
  ["calendar-patterns-icon"].forEach((t) => {
    switch (t) {
