...
const F = (e, t, ...n) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      he(l), r && (w = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, Ue = (e, t, n, s, l = !1) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (t = n[s], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== l["s-hn"] && !T.experimentalSlotFixes)
          if (Y(t, r)) {
            ...
            w = !0, t["s-sn"] = t["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (t["s-sh"] = l["s-hn"], m.push({
              $slotRefNode$: l,
              $nodeToRelocate$: t
            })), t["s-sr"] && m.map((c) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || U(null, null), $ = Le(t) ? t : F(null, null, t);
  ...
  try {
    Z = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || je(e, t, s));
  } catch (i) {
    C(i, e.$hostElement$);
  }
  return Z = null, null;
...
}, te = (e, t) => t in e, C = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), tt = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, st = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ve, !0), $t = ".sc-people-icon-h{display:flex}", at = $t, ft = Ke(class extends st {
  constructor() {
