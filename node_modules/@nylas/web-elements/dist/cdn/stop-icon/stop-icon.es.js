...
let L, H, A, lt = !1, F = !1, W = !1, v = !1, I = null, M = !1;
const x = (t, e = "") => () => {
...
const U = (t, e, ...n) => {
  ...
  return l["s-hn"] = A, o.$flags$ & 3 && (l["s-sr"] = !0, l["s-cr"] = H, l["s-sn"] = o.$name$ || "", i = t && t.$children$ && t.$children$[n], i && i.$tag$ === o.$tag$ && t.$elm$ && R(t.$elm$, !1)), l;
}, R = (t, e) => {
  p.$flags$ |= 1;
...
}, w = (t, e, n = !1) => t.$tag$ === e.$tag$ ? t.$tag$ === "slot" ? t.$name$ === e.$name$ : n ? !0 : t.$key$ === e.$key$ : !1, q = (t) => t && t["s-ol"] || t, ft = (t) => (t["s-ol"] ? t["s-ol"] : t).parentNode, E = (t, e, n = !1) => {
...
}, ce = (t) => le().then(t), $e = /* @__PURE__ */ re(vt, !0), ae = ".sc-stop-icon-h{display:flex}", fe = ae, St = Yt(class extends ne {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return U("svg", { key: "df7eec4c007960f83155487d96452a10ffcbcd7e", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "auto", xmlns: "http://www.w3.org/2000/svg" }, U("path", { key: "1cd0f4af8c05959b3be310a29864967382e732c0", d: "M4 4H20V20H4V4Z", stroke: "auto", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }));
  }
  static get style() {
    return fe;
  }
