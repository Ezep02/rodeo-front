...
let x, B, _, oe = !1, F = !1, W = !1, v = !1, I = null, D = !1;
const L = (e, t = "") => () => {
...
const U = (e, t, ...n) => {
  ...
  const i = [], u = ($) => {
    for (let d = 0; d < $.length; d++)
      s = $[d], Array.isArray(s) ? u(s) : s != null && typeof s != "boolean" && ((o = typeof e != "function" && !z(s)) && (s = String(s)), o && r ? i[i.length - 1].$text$ += s : i.push(o ? w(null, s) : s), r = o);
  };
  if (u(n), t) {
  ...
  if (n !== s) {
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(M, r) ? t = r.slice(2) : t = r[2] + t.slice(3), n || s) {
...
}, Fe = /\s/, J = (e) => e ? e.split(Fe) : [], ce = "Capture", Ue = new RegExp(ce + "$"), re = (e, t, n, s) => {
  ...
  for (; c <= u && o <= d; )
    if (f == null)
      ...
      (f.$tag$ === "slot" || h.$tag$ === "slot") && A(f.$elm$.parentNode, !1), C(f, h, l), e.insertBefore(f.$elm$, $.$elm$.nextSibling), f = t[++c], h = s[--d];
    else if (H($, a, l))
      ...
      r >= 0 ? (g = t[r], g.$tag$ !== a.$tag$ ? y = P(t && t[o], n, r, e) : (C(g, a, l), t[r] = void 0, y = g.$elm$), a = s[++o]) : (y = P(t && t[o], n, o, e), a = s[++o]), y && fe(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || w(null, null), $ = xe(t) ? t : U(null, null, t);
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], B = i["s-cr"], oe = (u.$flags$ & 1) !== 0, F = !1, C(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ue($.$elm$);
      for (const d of k) {
...
}, pe = (e, t) => (e.$flags$ |= 16, je(e, e.$ancestorComponent$), rt(() => Me(e, t))), Me = (e, t) => {
  const n = e.$hostElement$, s = L("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let c;
  return t ? c = E(l, "componentWillLoad") : c = E(l, "componentWillUpdate"), c = V(c, () => E(l, "componentWillRender")), s(), V(c, () => De(e, l, t));
  ...
  try {
    I = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Pe(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return I = null, null;
