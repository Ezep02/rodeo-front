...
let L, H, C, oe = !1, F = !1, W = !1, v = !1, I = null, M = !1;
const x = (e, t = "") => () => {
...
const U = (e, t, ...n) => {
...
}, Ue = /\s/, J = (e) => e ? e.split(Ue) : [], ce = "Capture", Pe = new RegExp(ce + "$"), re = (e, t, n, s) => {
  ...
  let c = 0, o, r, i;
  if (oe || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : Te, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), be(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, L = i["s-sc"], H = i["s-cr"], oe = (u.$flags$ & 1) !== 0, F = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      ue($.$elm$);
      for (const d of k) {
...
}, rt = (e) => ot().then(e), $t = /* @__PURE__ */ ct(ve, !0), at = ".sc-checkmark-circle-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
    super(), this.__registerHost(), this.width = "20", this.height = "20";
  }
  render() {
    return U("svg", { key: "3cee8e7ca80105a52420a965aca673ff6b6ae275", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, fill: "none", viewBox: "0 0 20 20" }, U("path", { key: "6df95e545ded190b3b63a32585d89ef6731f6f71", fill: "currentColor", d: "M10 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16Zm0 1a7 7 0 1 0 0 14 7 7 0 0 0 0-14Zm3.358 4.646a.5.5 0 0 1 .058.638l-.058.07-4.004 4.004a.5.5 0 0 1-.638.058l-.07-.058-2-2a.5.5 0 0 1 .638-.765l.07.058L9 11.298l3.651-3.652a.5.5 0 0 1 .707 0Z" }));
  }
  static get style() {
    return ft;
  }
}, [2, "checkmark-circle-icon", {
  width: [1],
  height: [1]
}]);
function dt() {
  if (typeof customElements > "u")
    return;
  ["checkmark-circle-icon"].forEach((t) => {
    switch (t) {
