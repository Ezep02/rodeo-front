...
const H = (t, e, ...n) => {
  ...
  const e = t.$cmpMeta$, n = t.$hostElement$, s = e.$flags$, l = x("attachStyles", e.$tagName$), r = Ft(n.shadowRoot ? n.shadowRoot : n.getRootNode(), e, t.$modeName$);
...
}, Ht = /\s/, J = (t) => t ? t.split(Ht) : [], rt = "Capture", Ut = new RegExp(rt + "$"), ct = (t, e, n, s) => {
  ...
  if (ot || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? kt : bt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ct(null, l, v), Tt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || U(null, null), $ = Et(e) ? e : H(null, null, e);
  ...
  let r;
  return e ? r = C(l, "componentWillLoad") : r = C(l, "componentWillUpdate"), r = V(r, () => C(l, "componentWillRender")), s(), V(r, () => Nt(t, l, e));
...
}, ce = (t) => oe().then(t), $e = /* @__PURE__ */ re(vt, !0), ae = ".sc-paintbrush-fill-icon-h{display:flex}", fe = ae, St = Jt(class extends ne {
  constructor() {
