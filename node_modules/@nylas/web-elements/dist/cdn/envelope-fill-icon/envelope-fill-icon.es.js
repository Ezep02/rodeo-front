...
const w = (e, t, ...n) => {
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(D, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(Pe, ""), n && h.rel(e, t, n, i), s && h.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, we = /\s/, J = (e) => e ? e.split(we) : [], re = "Capture", Pe = new RegExp(re + "$"), ce = (e, t, n, s) => {
...
}, he = (e, t) => (e.$flags$ |= 16, De(e, e.$ancestorComponent$), $t(() => He(e, t))), He = (e, t) => {
  ...
  if (!(h.$flags$ & 1)) {
    ...
    n.$flags$ & 12 && Ke(e), n.$members$ && Object.entries(n.$members$).map(([l, [r]]) => {
...
}, ct = (e) => ot().then(e), $t = /* @__PURE__ */ rt(ve, !0), at = ".sc-envelope-fill-icon-h{display:flex}", ft = at, Se = Je(class extends nt {
  constructor() {
