...
const b = (e, t, ...n) => {
...
}, Ue = /\s/, Y = (e) => e ? e.split(Ue) : [], ce = "Capture", je = new RegExp(ce + "$"), re = (e, t, n, s) => {
  ...
  if (oe || (W = !0, l.$tag$ === "slot" && (E && s.classList.add(E + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : be, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), Te(E) && o["s-si"] !== E && o.classList.add(o["s-si"] = E), l.$children$)
  ...
  let i;
  r === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && c !== null ? we(s, l, t, c, n) : c !== null ? (e.$text$ !== null && (s.textContent = ""), $e(s, null, t, c, 0, c.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (s.data = r);
}, de = (e) => {
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || j(null, null), $ = Ee(t) ? t : b(null, null, t);
...
}, te = (e, t) => t in e, F = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), st = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, nt = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => ot().then(e), $t = /* @__PURE__ */ ct(ve, !0), at = ".sc-close-icon-h{display:flex}", ft = at, Se = Ye(class extends nt {
  constructor() {
