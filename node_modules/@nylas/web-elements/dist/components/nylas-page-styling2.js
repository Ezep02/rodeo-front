...
const NylasPageStyling = proxyCustomElement(class NylasPageStyling extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["nylas-page-styling", "chevron-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-page-styling":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasPageStyling);
            }
            break;
        case "chevron-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-page-styling2.js.map