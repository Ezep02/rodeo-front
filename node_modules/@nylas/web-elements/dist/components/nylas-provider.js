...
import { N as NylasBaseProvider, e as es } from './index.es.js';
import { a as debug } from './utils.js';
import { N as NylaSchedulerAPIConnector, C as CreateNylasSchedulerStore } from './scheduler-store.js';
...
const NylasProvider$1 = proxyCustomElement(class NylasProvider extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasProviderCss; }
}, [1, "nylas-provider", {
        "authConfig": [16],
        "eventOverrides": [16],
...
function defineCustomElement$1() {
    ...
    const components = ["nylas-provider"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-provider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasProvider$1);
            }
            break;
    } });
}

const NylasProvider = NylasProvider$1;
const defineCustomElement = defineCustomElement$1;

export { NylasProvider, defineCustomElement };
