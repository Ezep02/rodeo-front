...
const InfoIcon = proxyCustomElement(class InfoIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '14';
...
function defineCustomElement() {
    ...
    const components = ["info-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "info-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InfoIcon);
            }
            break;
    } });
}

export { InfoIcon as I, defineCustomElement as d };
