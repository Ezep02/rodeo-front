...
import { a as debug, b as instance, M as compactStringToUUIDs, u as addDaysToCurrentDate, o as capitalizeFirstLetter } from './utils.js';
import { N as NylaSchedulerAPIConnector, E as ErrorCategory, C as CreateNylasSchedulerStore } from './scheduler-store.js';
import { c as LANGUAGE_CODE, L as LANGUAGE_CODE_MAP } from './constants.js';
import { i as isInitialized, a as init, f as feedbackSyncIntegration, c as captureMessage, b as captureFeedback } from './index3.js';
import { d as defineCustomElement$D } from './add-circle.js';
import { d as defineCustomElement$C } from './button-component2.js';
import { d as defineCustomElement$B } from './calendar-cancel.js';
import { d as defineCustomElement$A } from './calendar-check.js';
import { d as defineCustomElement$z } from './calendar.js';
import { d as defineCustomElement$y } from './checkbox-component2.js';
import { d as defineCustomElement$x } from './checkmark-circle.js';
import { d as defineCustomElement$w } from './chevron.js';
import { d as defineCustomElement$v } from './clock.js';
import { d as defineCustomElement$u } from './close.js';
import { d as defineCustomElement$t } from './feedback-icon2.js';
import { d as defineCustomElement$s } from './globe.js';
import { d as defineCustomElement$r } from './info.js';
import { d as defineCustomElement$q } from './input-component2.js';
import { d as defineCustomElement$p } from './loading.js';
import { d as defineCustomElement$o } from './multi-select-dropdown2.js';
import { d as defineCustomElement$n } from './nylas-booked-event-card2.js';
import { d as defineCustomElement$m } from './nylas-booking-form2.js';
import { d as defineCustomElement$l } from './nylas-cancel-booking-form2.js';
import { d as defineCustomElement$k } from './nylas-cancelled-event-card2.js';
import { d as defineCustomElement$j } from './nylas-confirmed-event-card2.js';
import { d as defineCustomElement$i } from './nylas-date-component2.js';
import { d as defineCustomElement$h } from './nylas-date-picker2.js';
import { d as defineCustomElement$g } from './nylas-feedback-form2.js';
import { d as defineCustomElement$f } from './nylas-locale-switch2.js';
import { d as defineCustomElement$e } from './nylas-logo2.js';
import { d as defineCustomElement$d } from './nylas-notification2.js';
import { d as defineCustomElement$c } from './nylas-organizer-confirmation-card2.js';
import { d as defineCustomElement$b } from './nylas-selected-event-card2.js';
import { d as defineCustomElement$a } from './nylas-timeslot-picker2.js';
import { d as defineCustomElement$9 } from './person.js';
import { d as defineCustomElement$8 } from './radio-button-group2.js';
import { d as defineCustomElement$7 } from './search.js';
import { d as defineCustomElement$6 } from './select-dropdown2.js';
import { d as defineCustomElement$5 } from './textarea-component2.js';
import { d as defineCustomElement$4 } from './toolitp-component.js';
...
const NylasScheduling$1 = proxyCustomElement(class NylasScheduling extends HTMLElement {
    constructor() {
        ...
        this.configSettingsLoaded = createEvent(this, "configSettingsLoaded", 7);
        this.bookingRefExtracted = createEvent(this, "bookingRefExtracted", 7);
        this.bookedEventInfo = createEvent(this, "bookedEventInfo", 7);
        this.mode = 'app';
        ...
        this.selectedDateLabel = new Date().toLocaleDateString(undefined, { dateStyle: 'full' }) || `${instance.t('noDateSelected')}`;
    ...
    dateSelectedHandler(event) {
        const date = event.detail;
        this.selectedDateLabel = date ? date.toLocaleDateString(undefined, { dateStyle: 'full' }) : `${instance.t('noDateSelected')}`;
    }
    ...
    feedbackSubmittedHandler(event) {
        const eventId = captureMessage('Scheduling Page User Feedback');
        const feedback = {
            eventId: eventId,
    ...
    checkIfSessionIdOrConfigIdExists() {
        if (!this.sessionId && !this.refConfigId && !(this.slug && this.clientId)) {
            let description = '';
            if (!this.sessionId) {
                description += instance.t('sessionIdRequiredErrorMessage');
            }
            if (!this.sessionId && !this.refConfigId && !(this.slug && this.clientId)) {
                description = instance.t('sessionIdRequiredErrorMessage') + ' ' + instance.t('publicConfigErrorMessage');
            }
            this.nylasSchedulerError.emit({
                notification: {
                    title: instance.t('schedulingComponentErrorTitle'),
    ...
    isTimeslotValid(timeslot) {
        ...
        if (selectedDate < new Date()) {
            this.nylasSchedulerError.emit({
                notification: {
                    title: instance.t('invalidTimeslotErrorTitle'),
                    category: ErrorCategory.Component,
                    type: nr.Error,
                    description: instance.t('invalidTimeslotErrorMessage'),
                    id: new Date().getTime().toString(),
                    ttl: 'none',
                },
                host: this.host,
    ...
    static get style() { return nylasSchedulingCss; }
        ...
        "bookingInfo": [16],
        "rescheduleBookingRef": [1, "reschedule-booking-ref"],
        "cancelBookingRef": [1, "cancel-booking-ref"],
        "organizerConfirmationBookingRef": [1, "organizer-confirmation-booking-ref"],
...
function defineCustomElement$1() {
    ...
    const components = ["nylas-scheduling", "add-circle-icon", "button-component", "calendar-cancel-icon", "calendar-check-icon", "calendar-icon", "checkbox-component", "checkmark-circle-icon", "chevron-icon", "clock-icon", "close-icon", "feedback-icon", "globe-icon", "info-icon", "input-component", "loading-icon", "multi-select-dropdown", "nylas-booked-event-card", "nylas-booking-form", "nylas-cancel-booking-form", "nylas-cancelled-event-card", "nylas-confirmed-event-card", "nylas-date-component", "nylas-date-picker", "nylas-feedback-form", "nylas-locale-switch", "nylas-logo", "nylas-notification", "nylas-organizer-confirmation-card", "nylas-selected-event-card", "nylas-timeslot-picker", "person-icon", "radio-button-group", "search-icon", "select-dropdown", "textarea-component", "tooltip-component", "translate-icon", "warning-icon"];
