...
const LocationOffIcon = proxyCustomElement(class LocationOffIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '16';
...
function defineCustomElement() {
    ...
    const components = ["location-off-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "location-off-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LocationOffIcon);
            }
            break;
    } });
}

export { LocationOffIcon as L, defineCustomElement as d };

//# sourceMappingURL=location-off.js.map