...
import { d as defineCustomElement$4 } from './input-dropdown2.js';
...
const NylasReminderTime = proxyCustomElement(class NylasReminderTime extends HTMLElement {
    ...
    static get style() { return nylasReminderTimeCss; }
}, [65, "nylas-reminder-time", {
        "name": [1],
        "eventReminderTimeMinutes": [2, "event-reminder-time-minutes"],
...
function defineCustomElement() {
    ...
    const components = ["nylas-reminder-time", "chevron-icon", "input-dropdown", "search-icon", "select-dropdown", "time-period-selector"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-reminder-time":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasReminderTime);
            }
            break;
        case "chevron-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-reminder-time2.js.map