...
const NylasEventDuration = proxyCustomElement(class NylasEventDuration extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasEventDurationCss; }
        ...
        "duration": [32],
        "durationMinutes": [32],
        "durationIncrement": [32],
        "durationMinutesOptions": [32]
...
function defineCustomElement() {
    ...
    const components = ["nylas-event-duration", "chevron-icon", "input-dropdown", "search-icon", "select-dropdown"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-event-duration":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasEventDuration);
            }
            break;
        case "chevron-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-event-duration2.js.map