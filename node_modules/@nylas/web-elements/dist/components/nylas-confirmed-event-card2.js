...
import { d as defineCustomElement$2 } from './calendar-cancel.js';
...
const NylasConfirmedEventCard = proxyCustomElement(class NylasConfirmedEventCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasConfirmedEventCardCss; }
...
function defineCustomElement() {
    ...
    const components = ["nylas-confirmed-event-card", "button-component", "calendar-cancel-icon", "loading-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-confirmed-event-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasConfirmedEventCard);
            }
            break;
...
//# sourceMappingURL=nylas-confirmed-event-card2.js.map