...
const NylasEventDescription = proxyCustomElement(class NylasEventDescription extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasEventDescriptionCss; }
}, [65, "nylas-event-description", {
        "selectedConfiguration": [16],
        "eventDescription": [1, "event-description"],
        "name": [1],
    ...
    }, [[4, "valueChanged", "valueChangedHandler"]], {
        "name": ["elementNameChangedHandler"],
        "selectedConfiguration": ["selectedConfigurationChangedHandler"],
        "selectedLanguage": ["selectedLanguageChangedHandler"]
    }]);
...
function defineCustomElement() {
    ...
    const components = ["nylas-event-description", "info-icon", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-event-description":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasEventDescription);
            }
            break;
        case "info-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-event-description2.js.map