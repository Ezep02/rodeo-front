...
import { a as debug, b as instance, y as isSameDay } from './utils.js';
...
const NylasTimeslotPicker = proxyCustomElement(class NylasTimeslotPicker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["nylas-timeslot-picker", "button-component", "loading-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-timeslot-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasTimeslotPicker);
            }
            break;
...
//# sourceMappingURL=nylas-timeslot-picker2.js.map