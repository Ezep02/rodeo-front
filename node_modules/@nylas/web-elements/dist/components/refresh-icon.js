...
const iconCss = ".sc-refresh-icon-h{display:flex}";

const RefreshIcon$1 = proxyCustomElement(class RefreshIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '15';
...
function defineCustomElement$1() {
    ...
    const components = ["refresh-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "refresh-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RefreshIcon$1);
            }
            break;
    } });
}

const RefreshIcon = RefreshIcon$1;
const defineCustomElement = defineCustomElement$1;

export { RefreshIcon, defineCustomElement };

//# sourceMappingURL=refresh-icon.js.map