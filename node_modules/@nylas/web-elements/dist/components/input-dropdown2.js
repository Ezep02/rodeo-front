...
const InputDropdown = proxyCustomElement(class InputDropdown extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return inputDropdownCss; }
}, [1, "input-dropdown", {
        "name": [1],
        "options": [16],
...
function defineCustomElement() {
    ...
    const components = ["input-dropdown"];
    components.forEach(tagName => { switch (tagName) {
        case "input-dropdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, InputDropdown);
            }
            break;
    } });
}

export { InputDropdown as I, defineCustomElement as d };

//# sourceMappingURL=input-dropdown2.js.map