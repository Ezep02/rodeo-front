import { h, Fragment as Fragment$1, proxyCustomElement, HTMLElement, createEvent, Host } from '@stencil/core/internal/client';
import { X as Xr, N as NylasBaseProvider } from './index.es.js';
import { N as NylasIdentityRequestWrapper } from './nylas-api-request.js';
import { d as dataResponse, a as debug, L as Buffer, E as process, h as commonjsGlobal, b as instance } from './utils.js';
import { C as CreateNylasSchedulerConfigStore } from './scheduler-config-store.js';
import { c as LANGUAGE_CODE, b as LANGUAGE_MAP } from './constants.js';
import { d as defineCustomElement$1n } from './add-circle.js';
import { d as defineCustomElement$1m } from './button-component2.js';
import { d as defineCustomElement$1l } from './calendar-agenda-fill.js';
import { d as defineCustomElement$1k } from './calendar-agenda.js';
import { d as defineCustomElement$1j } from './calendar.js';
import { d as defineCustomElement$1i } from './calendar-info.js';
import { d as defineCustomElement$1h } from './calendar-patterns.js';
import { d as defineCustomElement$1g } from './checkbox-component2.js';
import { d as defineCustomElement$1f } from './checkmark.js';
import { d as defineCustomElement$1e } from './chevron.js';
import { d as defineCustomElement$1d } from './clock.js';
import { d as defineCustomElement$1c } from './close.js';
import { d as defineCustomElement$1b } from './copy.js';
import { d as defineCustomElement$1a } from './delete.js';
import { d as defineCustomElement$19 } from './dragable.js';
import { d as defineCustomElement$18 } from './edit.js';
import { d as defineCustomElement$17 } from './envelope-fill.js';
import { d as defineCustomElement$16 } from './envelope.js';
import { d as defineCustomElement$15 } from './eye.js';
import { d as defineCustomElement$14 } from './feedback-icon2.js';
import { d as defineCustomElement$13 } from './flow.js';
import { d as defineCustomElement$12 } from './globe.js';
import { d as defineCustomElement$11 } from './google-logo.js';
import { d as defineCustomElement$10 } from './google-meet.js';
import { d as defineCustomElement$$ } from './info.js';
import { d as defineCustomElement$_ } from './input-component2.js';
import { d as defineCustomElement$Z } from './input-dropdown2.js';
import { d as defineCustomElement$Y } from './input-image-url2.js';
import { d as defineCustomElement$X } from './loading.js';
import { d as defineCustomElement$W } from './location.js';
import { d as defineCustomElement$V } from './location-off.js';
import { d as defineCustomElement$U } from './microsoft-logo.js';
import { d as defineCustomElement$T } from './microsof-teams.js';
import { d as defineCustomElement$S } from './multi-select-dropdown2.js';
import { d as defineCustomElement$R } from './nylas-additional-participants2.js';
import { d as defineCustomElement$Q } from './nylas-availability-picker2.js';
import { d as defineCustomElement$P } from './nylas-booking-calendar-picker2.js';
import { d as defineCustomElement$O } from './nylas-booking-confirmation-redirect2.js';
import { d as defineCustomElement$N } from './nylas-booking-confirmation-type2.js';
import { d as defineCustomElement$M } from './nylas-booking-form-config2.js';
import { d as defineCustomElement$L } from './nylas-buffer-time2.js';
import { d as defineCustomElement$K } from './nylas-calendar-picker2.js';
import { d as defineCustomElement$J } from './nylas-cancellation-policy2.js';
import { d as defineCustomElement$I } from './nylas-confirmation-email2.js';
import { d as defineCustomElement$H } from './nylas-connected-calendars2.js';
import { d as defineCustomElement$G } from './nylas-custom-booking-flow2.js';
import { d as defineCustomElement$F } from './nylas-custom-event-slug2.js';
import { d as defineCustomElement$E } from './nylas-customize-booking-settings2.js';
import { d as defineCustomElement$D } from './nylas-date-component2.js';
import { d as defineCustomElement$C } from './nylas-editor-tabs2.js';
import { d as defineCustomElement$B } from './nylas-event-description2.js';
import { d as defineCustomElement$A } from './nylas-event-duration2.js';
import { d as defineCustomElement$z } from './nylas-event-info2.js';
import { d as defineCustomElement$y } from './nylas-event-limits2.js';
import { d as defineCustomElement$x } from './nylas-event-location2.js';
import { d as defineCustomElement$w } from './nylas-event-title2.js';
import { d as defineCustomElement$v } from './nylas-feedback-form2.js';
import { d as defineCustomElement$u } from './nylas-form-card2.js';
import { d as defineCustomElement$t } from './nylas-limit-future-bookings2.js';
import { d as defineCustomElement$s } from './nylas-list-configurations2.js';
import { d as defineCustomElement$r } from './nylas-min-booking-notice2.js';
import { d as defineCustomElement$q } from './nylas-min-cancellation-notice2.js';
import { d as defineCustomElement$p } from './nylas-page-name2.js';
import { d as defineCustomElement$o } from './nylas-page-styling2.js';
import { d as defineCustomElement$n } from './nylas-participant-booking-calendars2.js';
import { d as defineCustomElement$m } from './nylas-participants-custom-availability2.js';
import { d as defineCustomElement$l } from './nylas-reminder-emails2.js';
import { d as defineCustomElement$k } from './nylas-reminder-time2.js';
import { d as defineCustomElement$j } from './nylas-scheduling-method2.js';
import { d as defineCustomElement$i } from './nylas-time-window-picker2.js';
import { d as defineCustomElement$h } from './nylas-timeslot-interval2.js';
import { d as defineCustomElement$g } from './paintbrush-fill.js';
import { d as defineCustomElement$f } from './paintbrush.js';
import { d as defineCustomElement$e } from './people.js';
import { d as defineCustomElement$d } from './person-clipboard.js';
import { d as defineCustomElement$c } from './plus.js';
import { d as defineCustomElement$b } from './radio-button-group2.js';
import { d as defineCustomElement$a } from './search.js';
import { d as defineCustomElement$9 } from './select-dropdown2.js';
import { d as defineCustomElement$8 } from './textarea-component2.js';
import { d as defineCustomElement$7 } from './time-period-selector2.js';
import { d as defineCustomElement$6 } from './toggle-switch2.js';
import { d as defineCustomElement$5 } from './toolitp-component.js';
import { d as defineCustomElement$4 } from './translate.js';
import { d as defineCustomElement$3 } from './trash.js';
...
class NylasSessions {
    ...
    constructor(config) {
        ...
        if (config.disableInitCodeExchange !== true) {
...
const LoginRequired = ({ authenticationUrl }) => (h("div", { class: 'login-required', part: "nse__login-required login-component" },
    h("div", { class: 'card', part: "nse__login-required-card" },
        h("p", { part: "nse__login-required-text" }, "Log into your account to use the Scheduler Editor."),
        h("button", { class: "google-button", part: "nse__login-required-google-button", onClick: async (event) => {
        ...
        h("button", { class: "microsoft-button", part: "nse__login-required-microsoft-button", onClick: async (event) => {
                event.preventDefault();
        ...
        h("button", { class: "other-provider-button", part: "nse__login-required-other-provider-button", onClick: async (event) => {
                event.preventDefault();
...
function ExpressFlow({ currentUser, calendars }) {
    ...
    return (h(Fragment$1, null,
        ...
        h("nylas-booking-calendar-picker", { expressFlow: true, calendars: calendars, currentUser: currentUser, defaultBookingCalendar: defaultCalendarOption?.id }),
...
const NylasSchedulerEditor$1 = proxyCustomElement(class NylasSchedulerEditor extends HTMLElement {
    ...
    updateLocalization(newVal) {
        ...
        Object.keys(newVal).forEach(lang => {
            ...
            instance.addResourceBundle(lang, 'translation', newVal[lang], false, true);
        });
    }
    async store() {
    ...
    nylasFormDropdownChangedHandler(event) {
        ...
        if (name === 'language') {
            this.selectedLanguage = LANGUAGE_CODE[value];
            instance.changeLanguage(this.selectedLanguage);
    ...
    static get style() { return nylasSchedulerEditorCss; }
}, [1, "nylas-scheduler-editor", {
        "configurationId": [1025, "configuration-id"],
        "nylasApiRequest": [1040],
        "nylasSessionsConfig": [16],
        "defaultAuthArgs": [16],
        "eventOverrides": [16],
        "schedulerPreviewLink": [1, "scheduler-preview-link"],
        "defaultSchedulerConfigState": [16],
        "mode": [1],
        ...
        "defaultLanguage": [1, "default-language"],
        "localization": [16],
        "automaticComponentRegistration": [32],
        "selectedLanguage": [32],
        "store": [64],
        "schedulerConnector": [64]
    }, [[0, "registerComponent", "registerComponentHandler"], [0, "unregisterComponent", "unregisterComponentHandler"], [0, "nylasFormDropdownChanged", "nylasFormDropdownChangedHandler"]], {
        "configurationId": ["configurationIdChanged"],
        "localization": ["updateLocalization"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["nylas-scheduler-editor", "add-circle-icon", "button-component", "calendar-agenda-fill-icon", "calendar-agenda-icon", "calendar-icon", "calendar-info-icon", "calendar-patterns-icon", "checkbox-component", "checkmark-icon", "chevron-icon", "clock-icon", "close-icon", "copy-icon", "delete-icon", "dragable-icon", "edit-icon", "envelope-fill-icon", "envelope-icon", "eye-icon", "feedback-icon", "flow-icon", "globe-icon", "google-logo-icon", "google-meet-icon", "info-icon", "input-component", "input-dropdown", "input-image-url", "loading-icon", "location-icon", "location-off-icon", "microsoft-logo-icon", "microsoft-teams-icon", "multi-select-dropdown", "nylas-additional-participants", "nylas-availability-picker", "nylas-booking-calendar-picker", "nylas-booking-confirmation-redirect", "nylas-booking-confirmation-type", "nylas-booking-form-config", "nylas-buffer-time", "nylas-calendar-picker", "nylas-cancellation-policy", "nylas-confirmation-email", "nylas-connected-calendars", "nylas-custom-booking-flow", "nylas-custom-event-slug", "nylas-customize-booking-settings", "nylas-date-component", "nylas-editor-tabs", "nylas-event-description", "nylas-event-duration", "nylas-event-info", "nylas-event-limits", "nylas-event-location", "nylas-event-title", "nylas-feedback-form", "nylas-form-card", "nylas-limit-future-bookings", "nylas-list-configurations", "nylas-min-booking-notice", "nylas-min-cancellation-notice", "nylas-page-name", "nylas-page-styling", "nylas-participant-booking-calendars", "nylas-participants-custom-availability", "nylas-reminder-emails", "nylas-reminder-time", "nylas-scheduling-method", "nylas-time-window-picker", "nylas-timeslot-interval", "paintbrush-fill-icon", "paintbrush-icon", "people-icon", "person-clipboard-icon", "plus-icon", "radio-button-group", "search-icon", "select-dropdown", "textarea-component", "time-period-selector", "toggle-switch", "tooltip-component", "translate-icon", "trash-icon", "zoom-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-scheduler-editor":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasSchedulerEditor$1);
            }
            break;
...
const NylasSchedulerEditor = NylasSchedulerEditor$1;
const defineCustomElement = defineCustomElement$1;

export { NylasSchedulerEditor, defineCustomElement };
