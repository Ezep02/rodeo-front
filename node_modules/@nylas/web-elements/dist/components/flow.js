...
const iconCss = ".sc-flow-icon-h{display:flex}";

const FlowIcon = proxyCustomElement(class FlowIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '16';
...
function defineCustomElement() {
    ...
    const components = ["flow-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "flow-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, FlowIcon);
            }
            break;
    } });
}

export { FlowIcon as F, defineCustomElement as d };
