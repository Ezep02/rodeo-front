...
const NylasDateComponent = proxyCustomElement(class NylasDateComponent extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasDateComponentCss; }
...
function defineCustomElement() {
    ...
    const components = ["nylas-date-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-date-component":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasDateComponent);
            }
            break;
    } });
}
...
//# sourceMappingURL=nylas-date-component2.js.map