...
const iconCss = ".sc-paintbrush-icon-h{display:flex}";

const PaintbrushIcon = proxyCustomElement(class PaintbrushIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '16';
...
function defineCustomElement() {
    ...
    const components = ["paintbrush-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "paintbrush-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PaintbrushIcon);
            }
            break;
    } });
}

export { PaintbrushIcon as P, defineCustomElement as d };
