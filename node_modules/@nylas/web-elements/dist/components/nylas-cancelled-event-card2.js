...
const NylasCancelledEventCard = proxyCustomElement(class NylasCancelledEventCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["nylas-cancelled-event-card", "button-component", "calendar-cancel-icon", "loading-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-cancelled-event-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasCancelledEventCard);
            }
            break;
...
//# sourceMappingURL=nylas-cancelled-event-card2.js.map