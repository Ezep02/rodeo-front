...
const NylasLogin$1 = proxyCustomElement(class NylasLogin extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: '05d703ee512a876f10ba163da3b926e29335cd33' }, this.loginMethod === 'redirect' && (h("div", { class: "redirect-container" }, !this.isAuthenticated && (h("button", { part: "button", onClick: this._handleLoginRedirect }, this.buttonText)))), this.loginMethod === 'emebded' && (h("main", { class: "login-container" }, h("section", { class: "login-box" }, h("header", null, h("img", { src: this.logoUrl, alt: `${this.companyName} logo`, width: '100%', style: {
    ...
    static get style() { return nylasLoginCss; }
}, [1, "nylas-login", {
...
], NylasLogin$1.prototype, "render", null);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["nylas-login"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-login":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasLogin$1);
            }
            break;
    } });
}

const NylasLogin = NylasLogin$1;
const defineCustomElement = defineCustomElement$1;

export { NylasLogin, defineCustomElement };
