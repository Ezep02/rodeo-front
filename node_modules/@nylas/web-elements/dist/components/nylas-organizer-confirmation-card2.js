...
const NylasOrganizerConfirmationCard = proxyCustomElement(class NylasOrganizerConfirmationCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasOrganizerConfirmationCardCss; }
...
function defineCustomElement() {
    ...
    const components = ["nylas-organizer-confirmation-card", "button-component", "calendar-check-icon", "loading-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-organizer-confirmation-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasOrganizerConfirmationCard);
            }
            break;
...
//# sourceMappingURL=nylas-organizer-confirmation-card2.js.map