...
const iconCss = ".sc-person-clipboard-icon-h{display:flex}";

const PersonClipboardIcon = proxyCustomElement(class PersonClipboardIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '12';
...
function defineCustomElement() {
    ...
    const components = ["person-clipboard-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "person-clipboard-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PersonClipboardIcon);
            }
            break;
    } });
}

export { PersonClipboardIcon as P, defineCustomElement as d };

//# sourceMappingURL=person-clipboard.js.map