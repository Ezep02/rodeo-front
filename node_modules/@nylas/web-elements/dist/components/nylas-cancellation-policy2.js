...
const NylasCancellationPolicy = proxyCustomElement(class NylasCancellationPolicy extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasCancellationPolicyCss; }
}, [65, "nylas-cancellation-policy", {
        "selectedConfiguration": [16],
        "cancellationPolicy": [1, "cancellation-policy"],
        "name": [1],
...
function defineCustomElement() {
    ...
    const components = ["nylas-cancellation-policy", "info-icon", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-cancellation-policy":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasCancellationPolicy);
            }
            break;
        case "info-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-cancellation-policy2.js.map