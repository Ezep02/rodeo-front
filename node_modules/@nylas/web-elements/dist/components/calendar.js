...
const iconCss = ".sc-calendar-icon-h{display:flex}";

const CalendarIcon = proxyCustomElement(class CalendarIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '15';
...
function defineCustomElement() {
    ...
    const components = ["calendar-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "calendar-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CalendarIcon);
            }
            break;
    } });
}

export { CalendarIcon as C, defineCustomElement as d };
