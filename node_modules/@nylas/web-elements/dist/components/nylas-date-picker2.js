...
import { u as addDaysToCurrentDate, b as instance, a as debug, w as getLastDayOfMonth, x as getFirstDayOfMonth, y as isSameDay, z as convertMinutesToHoursAndMinutes, A as translateMonth, B as isSameMonth } from './utils.js';
...
const NylasDatePicker = proxyCustomElement(class NylasDatePicker extends HTMLElement {
    ...
    static get style() { return nylasDatePickerCss; }
}, [1, "nylas-date-picker", {
        "selectableDates": [16],
        "configSettings": [16],
...
function defineCustomElement() {
    ...
    const components = ["nylas-date-picker", "chevron-icon", "clock-icon", "person-icon"];
