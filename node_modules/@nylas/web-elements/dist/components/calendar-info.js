...
const iconCss = ".sc-calendar-info-icon-h{display:flex}";

const CalendarInfoIcon = proxyCustomElement(class CalendarInfoIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '20';
...
function defineCustomElement() {
    ...
    const components = ["calendar-info-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "calendar-info-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CalendarInfoIcon);
            }
            break;
    } });
}

export { CalendarInfoIcon as C, defineCustomElement as d };

//# sourceMappingURL=calendar-info.js.map