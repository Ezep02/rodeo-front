...
const ToggleSwitchComponent = proxyCustomElement(class ToggleSwitchComponent extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "toggle-switch":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ToggleSwitchComponent);
            }
            break;
    } });
}

export { ToggleSwitchComponent as T, defineCustomElement as d };

//# sourceMappingURL=toggle-switch2.js.map