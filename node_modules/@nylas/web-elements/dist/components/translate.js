...
const iconCss = ".sc-translate-icon-h{display:flex}";

const GlobeIcon = proxyCustomElement(class GlobeIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '16';
...
function defineCustomElement() {
    ...
    const components = ["translate-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "translate-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GlobeIcon);
            }
            break;
    } });
}

export { GlobeIcon as G, defineCustomElement as d };
