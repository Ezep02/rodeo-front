...
import { a as debug, c as checkForMissingSlots } from './utils.js';
...
const NylasFormCard = proxyCustomElement(class NylasFormCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["nylas-form-card"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-form-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasFormCard);
            }
            break;
    } });
}
...
//# sourceMappingURL=nylas-form-card2.js.map