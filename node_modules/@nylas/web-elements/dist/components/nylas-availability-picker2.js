...
import { a as debug, b as instance, t as timeToMinutes, f as convertTo12HourFormat, m as minutesToTime, g as convertTo24HourFormat } from './utils.js';
import { D as DEFAULT_OPEN_HOURS, T as TIMEZONE_MAP } from './constants.js';
...
import { d as defineCustomElement$6 } from './globe.js';
import { d as defineCustomElement$5 } from './info.js';
import { d as defineCustomElement$4 } from './nylas-time-window-picker2.js';
...
const NylasAvailabilityPicker = proxyCustomElement(class NylasAvailabilityPicker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasAvailabilityPickerCss; }
}, [65, "nylas-availability-picker", {
        "name": [1],
        ...
        "timezone": [32],
        "overlapDays": [32]
    }, [[0, "nylasFormDropdownChanged", "nylasFormDropdownChangedHandler"], [0, "timeChange", "setTime"], [0, "formError", "setFormError"]], {
        "name": ["elementNameChangedHandler"],
        "selectedConfiguration": ["configChangedHandler"],
        "schedule": ["scheduleChanged"],
        "selectedLanguage": ["selectedLanguageChangedHandler"]
...
function defineCustomElement() {
    ...
    const components = ["nylas-availability-picker", "add-circle-icon", "chevron-icon", "close-icon", "globe-icon", "info-icon", "nylas-time-window-picker", "search-icon", "select-dropdown", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-availability-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasAvailabilityPicker);
            }
            break;
...
//# sourceMappingURL=nylas-availability-picker2.js.map