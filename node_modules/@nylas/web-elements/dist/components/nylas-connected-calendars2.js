...
import { d as defineCustomElement$5 } from './close.js';
import { d as defineCustomElement$4 } from './info.js';
import { d as defineCustomElement$3 } from './multi-select-dropdown2.js';
import { d as defineCustomElement$2 } from './nylas-calendar-picker2.js';
...
const NylasConnectedCalendars = proxyCustomElement(class NylasConnectedCalendars extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasConnectedCalendarsCss; }
...
function defineCustomElement() {
    ...
    const components = ["nylas-connected-calendars", "chevron-icon", "close-icon", "info-icon", "multi-select-dropdown", "nylas-calendar-picker", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-connected-calendars":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasConnectedCalendars);
            }
            break;
        case "chevron-icon":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=nylas-connected-calendars2.js.map