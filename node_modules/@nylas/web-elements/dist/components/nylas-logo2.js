...
const NylasLogo = proxyCustomElement(class NylasLogo extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '69';
...
function defineCustomElement() {
    ...
    const components = ["nylas-logo"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-logo":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasLogo);
            }
            break;
    } });
}

export { NylasLogo as N, defineCustomElement as d };

//# sourceMappingURL=nylas-logo2.js.map