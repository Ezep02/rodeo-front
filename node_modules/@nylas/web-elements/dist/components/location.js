...
const LocationIcon = proxyCustomElement(class LocationIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '16';
...
function defineCustomElement() {
    ...
    const components = ["location-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "location-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LocationIcon);
            }
            break;
    } });
}

export { LocationIcon as L, defineCustomElement as d };
