...
const InputComponent = proxyCustomElement(class InputComponent extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h("label", { key: 'fb41bff320a0aa12f31cd4fd025c020acd32fe30', part: "ic__label", class: { error: !!this.error } }, this.label && (h("p", null, h("span", { class: "label" }, this.label), this.required && h("span", { class: "required" }, "*"))), h("div", { key: 'c0466ccb293c74b7850f84c34361b05f84dbf808', part: "ic__input_wrapper", class: "input_wrapper" }, h("input", { key: 'f7ad6326c0417ccb72c0be94fac1fb9c9abec5e8', type: "text", name: this.name, part: "ic__input", readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, placeholder: this.placeholder, class: { error: !!this.error }, onInput: e => this.handleInput(e), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), h("slot", { key: '2111935c92c404fa92eb5dbba300cdae2d4e2991', name: "additional-input" })), this.error && h("span", { class: "error help-text" }, this.error)));
    }
    get el() { return this; }
    static get watchers() { return {
        "defaultValue": ["handleDefaultValueChange"]
    }; }
    static get style() { return inputComponentCss; }
}, [1, "input-component", {
        "name": [1],
...
function defineCustomElement() {
    ...
    const components = ["input-component"];
...
//# sourceMappingURL=input-component2.js.map