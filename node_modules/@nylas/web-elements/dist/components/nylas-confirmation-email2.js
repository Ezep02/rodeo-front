...
import { d as defineCustomElement$b } from './chevron.js';
import { d as defineCustomElement$a } from './clock.js';
import { d as defineCustomElement$9 } from './edit.js';
import { d as defineCustomElement$8 } from './info.js';
import { d as defineCustomElement$7 } from './input-component2.js';
import { d as defineCustomElement$6 } from './input-image-url2.js';
import { d as defineCustomElement$5 } from './loading.js';
import { d as defineCustomElement$4 } from './person-clipboard.js';
import { d as defineCustomElement$3 } from './textarea-component2.js';
import { d as defineCustomElement$2 } from './toggle-switch2.js';
...
const NylasConfirmationEmail = proxyCustomElement(class NylasConfirmationEmail extends HTMLElement {
    ...
    }, [[0, "nylasFormInputChanged", "nylasFormInputChangeHandler"], [0, "valueChanged", "valueChangedHandler"], [0, "nylasFormInputImageUrlInvalid", "nylasFormInputImageUrlInvalidHandler"], [0, "nylasFormSwitchToggled", "nyalsFormSwitchToggledHandler"]], {
        "name": ["elementNameChangedHandler"],
        "selectedConfiguration": ["selectedConfigurationChangedHandler"],
        "selectedLanguage": ["selectedLanguageChangedHandler"]
    }]);
...
function defineCustomElement() {
    ...
    const components = ["nylas-confirmation-email", "button-component", "chevron-icon", "clock-icon", "edit-icon", "info-icon", "input-component", "input-image-url", "loading-icon", "person-clipboard-icon", "textarea-component", "toggle-switch", "tooltip-component"];
