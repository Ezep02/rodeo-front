...
import { d as defineCustomElement$g } from './button-component2.js';
import { d as defineCustomElement$f } from './chevron.js';
import { d as defineCustomElement$e } from './clock.js';
import { d as defineCustomElement$d } from './edit.js';
import { d as defineCustomElement$c } from './info.js';
import { d as defineCustomElement$b } from './input-component2.js';
...
import { d as defineCustomElement$3 } from './time-period-selector2.js';
import { d as defineCustomElement$2 } from './toolitp-component.js';
import { d as defineCustomElement$1 } from './trash.js';
...
const NylasReminderEmails = proxyCustomElement(class NylasReminderEmails extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasReminderEmailsCss; }
        ...
        "reminderErrors": [32],
        "participants": [32]
    }, [[0, "valueChanged", "handleValueChanged"], [0, "nylasFormDropdownChanged", "handleNylasFormDropdownChanged"], [0, "nylasFormInputChanged", "handleNylasFormInputChanged"]], {
        "name": ["elementNameChangedHandler"],
        "selectedConfiguration": ["selectedConfigurationChangedHandler"],
        "selectedLanguage": ["selectedLanguageChangedHandler"]
    }]);
...
function defineCustomElement() {
    ...
    const components = ["nylas-reminder-emails", "button-component", "chevron-icon", "clock-icon", "edit-icon", "info-icon", "input-component", "input-dropdown", "loading-icon", "nylas-reminder-time", "person-clipboard-icon", "plus-icon", "search-icon", "select-dropdown", "time-period-selector", "tooltip-component", "trash-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-reminder-emails":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasReminderEmails);
            }
            break;
...
//# sourceMappingURL=nylas-reminder-emails2.js.map