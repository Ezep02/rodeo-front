...
const PeopleIcon = proxyCustomElement(class PeopleIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '20';
...
function defineCustomElement() {
    ...
    const components = ["people-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "people-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PeopleIcon);
            }
            break;
    } });
}

export { PeopleIcon as P, defineCustomElement as d };
