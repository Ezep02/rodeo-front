...
export declare function formatTimezone(date: Date, timezone: string): string;
...
export declare function convertMinutesToHoursAndMinutes(minutes: number): string;
export declare function checkForMissingSlots(slots: string[], host: HTMLElement): void;
export declare function compactStringToUUIDs(compactString: string): string[];
export declare const t: (key: any) => string;
export declare const capitalizeFirstLetter: (str: string) => string;
export declare const translateMonth: (month: string) => string;
export declare const isValidUrl: (url: string) => boolean;
export declare const isValidImage: (url: string) => Promise<unknown>;
