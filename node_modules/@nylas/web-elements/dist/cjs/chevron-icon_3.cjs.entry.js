...
const iconCss$1 = ".sc-chevron-icon-h{display:flex}";
const ChevronIconStyle0 = iconCss$1;

const ChevronIcon = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h("svg", { key: '7aba61db23989386b629855aca2a4e8f9bf4362c', xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, index.h("path", { key: '20bf8190f264566aabe644a60205498ea8796bd9', fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" })));
    }
};
ChevronIcon.style = ChevronIconStyle0;

const iconCss = ".sc-search-icon-h{display:flex}";
const SearchIconStyle0 = iconCss;
...
const SelectDropdownStyle0 = selectDropdownCss;

const SelectDropdown = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        ...
        this.emptyValue = 'Select an option';
        this.errorMessage = '';
    ...
    render() {
        ...
        return (index.h("div", { key: '2c620508eeef332e31afe32c261d04e52ddddc30', class: "dropdown", part: "sd_dropdown" }, index.h("label", { key: 'b6332c551e0c5e7da74b7c2135ab038ab0744502', part: "sd_dropdown_label", class: { error: !!this.error } }, this.label && (index.h("p", null, index.h("span", { class: "label" }, this.label), this.required && index.h("span", { class: "required" }, "*"))), index.h("button", { key: 'f4e2a425f33ea3d25033e9dfa0311d7b80927c31', part: "sd_dropdown-button", class: { dropbtn: true, open: this.isOpen, error: !!this.error }, onClick: () => this.toggleDropdown(), "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-label": this.name, onKeyDown: e => this.handleSelectButtonKeyDown(e) }, index.h("slot", { key: '1b254af0779a5c97ec201aa1cb3886a3c154ce59', name: "select-icon", "aria-hidden": "true" }), index.h("span", { key: '019c36eaa7ee04e84e5e1eb906d745653bc91518', class: "selected-option", part: "sd_dropdown-button-selected-label" }, buttonText), this.withChevron && (index.h("span", { class: {
                open: this.isOpen,
                closed: !this.isOpen,
                chevron: true,
            }, "aria-hidden": "true" }, index.h("chevron-icon", { width: "16", height: "16" })))), this.error && index.h("span", { class: "error help-text" }, this.error)), this.isOpen ? (index.h("div", { class: "dropdown-content", part: "sd_dropdown-content" }, this.withSearch && (index.h("div", { class: { 'search-box': true, 'open': this.isOpen } }, index.h("search-icon", { width: "15", height: "15", class: 'icon' }), index.h("input", { type: "text", role: "combobox", placeholder: "Search", value: this.searchValue, ref: el => (this.inputRef = el), onInput: event => this.filterOptions(event), onKeyDown: e => this.handleComboboxKeyDown(e) }))), index.h("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: e => this.handleListboxKeydown(e) }, this.filteredOptions.map(option => option.value.toString() ? (index.h("li", { tabindex: "0", key: option.value, id: option.value, onClick: () => this.selectOption(option), role: "option" }, option.labelHTML ? index.h("div", { part: "sd_dropdown-labelhtml" }, option.labelHTML) : option.label)) : null)))) : null));
    }
...
SelectDropdown.style = SelectDropdownStyle0;

exports.chevron_icon = ChevronIcon;
exports.search_icon = SearchIcon;
exports.select_dropdown = SelectDropdown;

//# sourceMappingURL=chevron-icon_3.cjs.entry.js.map