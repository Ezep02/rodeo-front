...
const TextareaComponent = class {
    ...
    handleInput(e) {
        ...
        this.value = utils.sanitize(inputElement.value);
    ...
    render() {
        return (index.h("label", { key: '18b05c7318527e7cf7215bf3825e2e65674527d9', part: "tc__label", class: { error: !!this.error } }, index.h("p", { key: 'ab8167c6d7f695c75ecf00f3719783fdb92b92f5' }, index.h("span", { key: 'f0669daea951f39a0f47929cf84fe2c573c7ab48', class: "label" }, this.label), this.required && index.h("span", { class: "required" }, "*"), this.tooltip && (index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, this.tooltip)))), index.h("textarea", { key: 'c0960b3e0662e02cd5e26586853cd1550b0fc4e5', name: this.name, placeholder: this.placeholder, readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, onInput: e => this.handleInput(e), class: { error: !!this.error }, part: "tc__textarea" }), this.error && index.h("span", { class: "error help-text" }, this.error)));
    }
};
TextareaComponent.style = textareaComponentCss;

exports.textarea_component = TextareaComponent;

//# sourceMappingURL=textarea-component.cjs.entry.js.map