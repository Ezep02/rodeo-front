...
const NylasSchedulingMethod = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "nylas-scheduling-method", part: "nsm" }, index.h("div", { class: "header", part: "nsm__header" }, index.h("h3", null, utils.instance.t('nylasSchedulingMethod.headerTitle'))), index.h("div", { class: "nylas-scheduling-method__dropdown" }, index.h("span", { class: "nylas-scheduling-method__dropdown-label" }, utils.instance.t('nylasSchedulingMethod.headerSubTitle'), index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, index.h("strong", null, utils.instance.t('nylasSchedulingMethod.tooltip.standard.label')), index.h("br", null), "- ", utils.instance.t('nylasSchedulingMethod.tooltip.standard.desc'), index.h("br", null), index.h("br", null), index.h("strong", null, utils.instance.t('nylasSchedulingMethod.tooltip.maxFairness.label')), index.h("br", null), "- ", utils.instance.t('nylasSchedulingMethod.tooltip.maxFairness.desc'), index.h("br", null), index.h("br", null), index.h("strong", null, utils.instance.t('nylasSchedulingMethod.tooltip.maxAvailability.label')), index.h("br", null), "- ", utils.instance.t('nylasSchedulingMethod.tooltip.maxAvailability.desc'), index.h("br", null)))), this.readOnly ? (index.h("input-component", { name: "availability-method-read-only", type: "text", exportparts: "ic__label: nsm__input-label, ic__input: nsm__input, ic__input_wrapper: nsm__input_wrapper", readOnly: true, defaultValue: bookingTypeOptions.find(cal => cal.value == defaultBookingType)?.label ?? bookingTypeOptions[0].label })) : (index.h("select-dropdown", { name: this.name, options: bookingTypeOptions, withSearch: false, exportparts: "sd_dropdown: nsm__dropdown, sd_dropdown-button: nsm__dropdown-button, sd_dropdown-content: nsm__dropdown-content", defaultSelectedOption: bookingTypeOptions.find(cal => cal.value == defaultBookingType) ?? bookingTypeOptions[0] }))))));
    }
...
//# sourceMappingURL=nylas-scheduling-method.cjs.entry.js.map