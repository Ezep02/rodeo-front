...
const InputImageUrl = class {
    constructor(hostRef) {
        ...
        this.nylasFormInputImageUrlInvalid = index.createEvent(this, "nylasFormInputImageUrlInvalid", 7);
    ...
    render() {
        return (index.h(index.Host, { key: 'ffddd82e9733783c1188c5f725e9005a89addcbb' }, index.h("div", { key: 'bcb39f174166d4ae721e12ee80c22178fe94149f', class: "logo-container" }, index.h("div", { key: '70fc18f9c3dedfcde59f6fd1173a45ed2d8c9afc', class: "input-container" }, index.h("input-component", { key: '65ad4998db6f2a7d09ed30f3f4957e3cecb48cea', name: this.name, id: this.name, type: "text", required: false, exportparts: "ic_input: iiu__logo-input-textfield", defaultValue: this.imageUrl ?? '' }), this.errorMessage && index.h("span", { class: "error-message" }, this.errorMessage)), this.currentImageUrl && !this.errorMessage && (index.h("div", { class: "logo" }, index.h("img", { src: this.currentImageUrl, alt: "Logo" }))))));
    }
...
InputImageUrl.style = inputImageUrlCss;

exports.input_image_url = InputImageUrl;

//# sourceMappingURL=input-image-url.cjs.entry.js.map