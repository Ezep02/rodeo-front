...
const CheckboxComponent = class {
    ...
    render() {
        return (index.h("div", { key: '846414c76901571e7c2591f2f73a1e81a75da8cb', class: "checkbox-container" }, index.h("label", { key: '0d4f046e5e16b98e8bf456b1a839764ef8ca2149' }, index.h("input", { key: '53e0e070c154543aa4b66c90d7506938a926fbed', type: "checkbox", name: this.name, checked: this.isChecked, onChange: () => this.toggleCheck() }), index.h("span", { key: '651d933ddb459c8b3226babc82bf0fa05663a389', class: "checkmark" }), index.h("slot", { key: '2b59df9447d01fb0000d4dfcfa3d029d48a4400e', name: "label" }, index.h("span", { key: '644a2d26e208e41545566471ebba96c93629af0c', class: "label" }, this.label))), this.error && index.h("p", { class: "error" }, this.error)));
    }
...
//# sourceMappingURL=checkbox-component.cjs.entry.js.map