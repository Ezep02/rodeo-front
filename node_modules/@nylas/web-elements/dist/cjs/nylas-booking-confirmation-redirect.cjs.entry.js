...
const NylasBookingConfirmationRedirect = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5d44420cd786a4ca2ca34692283ae220cf129aa4' }, index.h("div", { key: '87faa97ba4edc3c0a0d153454b57716d9032cea6', class: "nylas-booking-confirmation-redirect", part: "nbcr" }, redirectOptions.length > 0 && (index.h("div", { class: "nylas-booking-confirmation-redirect__dropdown" }, index.h("span", { class: "label" }, utils.instance.t('nylasBookingConfirmationRedirect.dropdownLabel'), index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasBookingConfirmationRedirect.tooltip.desc')))), this.componentLoaded && (index.h("select-dropdown", { name: "confirmation-redirect-dropdown", options: redirectOptions, withSearch: false, defaultSelectedOption: redirectOptions.find(option => option.value === (this.acceptUrl ? 'custom' : 'default')), exportparts: "sd_dropdown: nbcr__dropdown, sd_dropdown-button: nbcr__dropdown-button, sd_dropdown-content: nbcr__dropdown-content" })), this.acceptUrl && (index.h("div", null, index.h("input-component", { name: "confirmation-redirect", id: "confirmation-redirect", type: "text", placeholder: "Enter custom redirect URL", required: false, part: "ic__input_wrapper: nbcr__input-textfield", defaultValue: this.currentRedirectUrl }), this.redirectUrlErrorMessage && index.h("span", { class: "error-message" }, this.redirectUrlErrorMessage))))))));
    }
...
NylasBookingConfirmationRedirect.style = nylasBookingConfirmationRedirectCss;

exports.nylas_booking_confirmation_redirect = NylasBookingConfirmationRedirect;

//# sourceMappingURL=nylas-booking-confirmation-redirect.cjs.entry.js.map