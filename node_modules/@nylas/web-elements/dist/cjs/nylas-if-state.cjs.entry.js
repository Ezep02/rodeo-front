...
const NylasIfState = class {
    ...
    shouldRender() {
        ...
        if (typeof getStore === 'undefined') {
            utils.debug(`[nylas-if-state] Store name: ${storeName} | State name: ${stateName}`, { getStore });
            return false;
        }
        const store = getStore(storeName);
        if (typeof store === 'undefined') {
            utils.debug(`[nylas-if-state] Store name: ${storeName} | State name: ${stateName}`, { store });
            return false;
        }
    ...
    render() {
        return (index.h(index.Host, { key: '36d3cd4c91d34f8716528990469a2b015b4e3f72' }, index.h("div", { key: '2f598550f94fcb8e92e783f93c384703a6229776', class: this.classes }, this.show && index.h("slot", null))));
    }
...
exports.nylas_if_state = NylasIfState;

//# sourceMappingURL=nylas-if-state.cjs.entry.js.map