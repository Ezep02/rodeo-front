...
const NylasPageStyling = class {
    ...
    render() {
        return (index.h(index.Host, { key: '68e1c2f32b4268726ba8df026df3e21dbe68e5dc' }, index.h("div", { key: '1ae19e1b16b921ff07532f766f4d3cd66cd4eab7', part: "nps", class: { 'nylas-page-styling': true, 'no-border': !this.customInputsSlot } }, this.customInputsSlot ? (index.h("div", { class: "header", part: "nps__header" }, index.h("div", null, index.h("h3", null, utils.instance.t('nylasPageStyling.headerTitle'))), index.h("div", { class: "drawer-toggle", part: "nps__drawer-toggle--container" }, index.h("span", { class: `chevron ${this.isOpen ? 'open' : 'closed'} `, onClick: () => this.toggleConfirmationEmail() }, index.h("chevron-icon", { width: "24", height: "24" }))))) : null, index.h("div", { key: '444f71a9a295a038e08fdf46ffd3a48191b1da31', id: "nylas-page-styling__body", class: "nylas-page-styling__body", part: "nps__body" }, index.h("div", { key: '4033d47d7ffefbf28cdce4742ed90902ec9f5c0d', class: { 'nylas-page-styling__section': true, 'no-padding': !this.customInputsSlot } }, index.h("div", { key: 'e2b2ad42964df5f04fb0297a667f8724040dd41a', class: "nylas-page-styling__row" }, index.h("div", { key: '6c74558fa601b9be224758352f9fec1346ce86b7', class: { subsection: true, hide: !this.isOpen } })))))));
    }
