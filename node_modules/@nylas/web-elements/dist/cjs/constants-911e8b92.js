...
(function (LANGUAGE_CODE) {
    ...
    LANGUAGE_CODE["ja"] = "ja";
    LANGUAGE_CODE["nl"] = "nl";
})(exports.LANGUAGE_CODE || (exports.LANGUAGE_CODE = {}));
const LANGUAGE_MAP = {
    en: 'English',
    es: 'Español',
    fr: 'Français',
...
const PROVIDER_CONFERENCE_MAP = {
    google: 'Google Meet',
    zoom: 'Zoom Meeting',
    microsoft: 'Microsoft Teams',
};
const CONFERENCE_PROVIDER_MAP = {
    'Google Meet': 'google',
    'Zoom Meeting': 'zoom',
    'Microsoft Teams': 'microsoft',
};
const NON_PROVIDER_CONFERENCE_OPTIONS = ['zoom'];
...
const PROVIDER_CONFERENCE_OPTIONS = Object.keys(PROVIDER_CONFERENCE_MAP).map(provider => provider);
...
const REMINDER_HOUR_OPTIONS = Array.from({ length: 23 }, (_, i) => ({ value: i + 1, label: (i + 1).toString() }));
const REMINDER_DAY_OPTIONS = Array.from({ length: 7 }, (_, i) => ({ value: i + 1, label: (i + 1).toString() }));

exports.CONFERENCE_PROVIDER_MAP = CONFERENCE_PROVIDER_MAP;
exports.DEFAULT_FORM_FIELD_TYPES = DEFAULT_FORM_FIELD_TYPES;
exports.DEFAULT_OPEN_HOURS = DEFAULT_OPEN_HOURS;
exports.EVENT_TITLE_TOKENS = EVENT_TITLE_TOKENS;
exports.FIELD_TYPES = FIELD_TYPES;
exports.LANGUAGE_CODE_MAP = LANGUAGE_CODE_MAP;
exports.LANGUAGE_MAP = LANGUAGE_MAP;
exports.PROVIDER_CONFERENCE_MAP = PROVIDER_CONFERENCE_MAP;
exports.TIMEZONE_MAP = TIMEZONE_MAP;

//# sourceMappingURL=constants-911e8b92.js.map