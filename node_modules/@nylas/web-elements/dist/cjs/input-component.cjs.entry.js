...
const InputComponent = class {
    ...
    handleInput(e) {
        this.error = '';
        this.value = utils.sanitize(e.target.value);
    ...
    render() {
        return (index.h("label", { key: 'fb41bff320a0aa12f31cd4fd025c020acd32fe30', part: "ic__label", class: { error: !!this.error } }, this.label && (index.h("p", null, index.h("span", { class: "label" }, this.label), this.required && index.h("span", { class: "required" }, "*"))), index.h("div", { key: 'c0466ccb293c74b7850f84c34361b05f84dbf808', part: "ic__input_wrapper", class: "input_wrapper" }, index.h("input", { key: 'f7ad6326c0417ccb72c0be94fac1fb9c9abec5e8', type: "text", name: this.name, part: "ic__input", readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, placeholder: this.placeholder, class: { error: !!this.error }, onInput: e => this.handleInput(e), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), index.h("slot", { key: '2111935c92c404fa92eb5dbba300cdae2d4e2991', name: "additional-input" })), this.error && index.h("span", { class: "error help-text" }, this.error)));
    }
...
exports.input_component = InputComponent;

//# sourceMappingURL=input-component.cjs.entry.js.map