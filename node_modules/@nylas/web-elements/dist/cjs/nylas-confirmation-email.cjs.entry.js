...
const NylasConfirmationEmail = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f3d6c5e775d26df9e6693f6e2ebb66cbf50afb50' }, index.h("div", { key: 'eeb7e06b2fc8a43b137eb8ad0aa23aea7c057050', class: "nylas-confirmation-email", part: "nce" }, index.h("div", { key: '4d318a3ee7bfe014c4fe28f4295e706ccdb55c54', class: "header", part: "nce__header" }, index.h("div", { key: '3f727906b1c0146922464e8e34c7ef7c87de5def' }, index.h("h3", { key: 'e003e19ba7713de2bc4dbd549786d8223d62d25b' }, this.confirmationEmail?.booking_confirmed?.title ||
            utils.instance.t('nylasConfirmationEmail.headerTitle', { organizerName: `${organizerName ? ` with ${organizerName}` : ''}` })), index.h("p", { key: 'f6fd1e8a4b80ae811b2b1ea1e265337dfed5c0f1' }, utils.instance.t('nylasConfirmationEmail.headerSubTitle'))), this.isConfirmationEmailOpen ? (index.h("div", { class: "confirmation-email-toggle", part: "nce__confirmation-email-toggle--container" }, index.h("span", { class: `chevron ${this.isConfirmationEmailOpen ? 'open' : 'closed'} `, onClick: () => this.toggleConfirmationEmail() }, index.h("chevron-icon", { width: "24", height: "24" })))) : (index.h("button-component", { variant: 'basic', clickHandler: event => {
                event.preventDefault();
                this.toggleConfirmationEmail();
            } }, index.h("edit-icon", { width: "16", height: "16" }), utils.instance.t('nylasConfirmationEmail.editButtonText')))), this.isConfirmationEmailOpen ? (index.h("div", { class: "nylas-confirmation-email__body", part: "nce__body" }, index.h("div", { class: "nylas-confirmation-email__section" }, index.h("div", { class: "nylas-confirmation-email__row" }, index.h("label", null, utils.instance.t('nylasConfirmationEmail.confirmationEmail.label'), index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, " ", utils.instance.t('nylasConfirmationEmail.confirmationEmail.tooltip.desc'))))), index.h("span", { class: "selected-value" }, utils.instance.t('nylasConfirmationEmail.immediatelyUponBooking'))), index.h("div", { class: "nylas-confirmation-email__row" }, index.h("label", null, utils.instance.t('nylasConfirmationEmail.nylasBranding.label'), index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasConfirmationEmail.nylasBranding.tooltip.desc'))))), index.h("toggle-switch", { exportparts: "ts_label: nce__toggle-label, ts_input: nce_toggle-input, ts_slider: nce_toggle-slider", name: `confirmation-email-show-branding`, checked: this.confirmationEmail?.show_nylas_branding })), index.h("div", { class: "nylas-confirmation-email__row" }, index.h("div", { class: "subsection" }, index.h("div", { class: "input-container" }, index.h("label", null, utils.instance.t('nylasConfirmationEmail.companyLogoUrl.label'), index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasConfirmationEmail.companyLogoUrl.tooltip.desc'))))), this.confirmationEmail && (index.h("input-image-url", { name: "confirmation-email-logo", exportparts: "iiu__logo-input-textfield: nce__input-image-url", imageUrl: this.confirmationEmail?.logo ?? '' }))))), index.h("div", { class: "nylas-confirmation-email__row full-width-col" }, index.h("div", { class: "subsection" }, index.h("h3", null, utils.instance.t('nylasConfirmationEmail.emailMessage.header')), index.h("div", { class: "input-container" }, index.h("label", { htmlFor: "title" }, utils.instance.t('nylasConfirmationEmail.emailMessage.label'), index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasConfirmationEmail.emailMessage.tooltip.desc'))))), index.h("input-component", { name: "confirmation-email-title", maxLength: 60, placeholder: utils.instance.t('nylasConfirmationEmail.headerTitle', { organizerName: `${organizerName ? ` with ${organizerName}` : ''}` }), defaultValue: this.confirmationEmail?.booking_confirmed?.title ?? '' })), index.h("div", { class: "input-container" }, index.h("textarea-component", { label: utils.instance.t('nylasConfirmationEmail.emailMessage.additionalInfoLabel'), name: "confirmation-email-body", id: "confirmation-email-body", placeholder: utils.instance.t('nylasConfirmationEmail.emailMessage.additionalInfoPlaceholder'), tooltip: utils.instance.t('nylasConfirmationEmail.emailMessage.additionalInfoTooltip'), maxLength: 500, defaultValue: this.confirmationEmail?.booking_confirmed?.body ?? '' }))))))) : (index.h("div", { class: "nylas-confirmation-email__summary", part: "nce__summary" }, index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("person-clipboard-icon", null)), utils.instance.t('nylasConfirmationEmail.allHosts')), index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("clock-icon", null)), utils.instance.t('nylasConfirmationEmail.immediatelyUponBooking')))))));
    }
...
NylasConfirmationEmail.style = nylasConfirmationEmailCss;

exports.nylas_confirmation_email = NylasConfirmationEmail;

//# sourceMappingURL=nylas-confirmation-email.cjs.entry.js.map