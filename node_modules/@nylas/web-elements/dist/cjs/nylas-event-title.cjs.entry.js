...
const NylasEventTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '939a9d39a09fc21d9ddc3a9439531e67eb3c3ca4' }, index.h("div", { key: '64b4c5803d47507ce973901a2b72bd6e282d69ec', class: "nylas-event-title", part: "net" }, index.h("label", { key: '1e767bdcb14c5856116c292f1528ae48426fa629', htmlFor: "title" }, utils.instance.t('nylasEventTitle.headerTitle'), index.h("span", { key: 'f067d784f17ce438f6691470ae78014028fe0ae9', class: "required" }, "*")), index.h("div", { key: '043eaabcf1c15d4935717e00b04d62d087f75a87', class: {
                title: true,
                error: this.validationError !== '',
            }, part: "net__title", ref: el => (this.titleRef = el), contentEditable: "true", onInput: e => this.handleChange(e), onKeyDown: event => this.handleInputKeyDown(event) }), this.showTokens && this.filteredTokens?.length > 0 && (index.h("div", { class: "token-options", part: "net__dropdown-content" }, index.h("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant }, this.filteredTokens.map(option => (index.h("li", { tabindex: "0", key: option.label, id: option.label, class: { active: this.ariaActivedescendant === option.label }, onClick: e => this.selectOption(e, option), role: "option" }, this.getLabelHTML(option.labelHTML))))))), index.h("span", { key: '90cb59742f5f9feb4f1a95ecc11fdb0f6626c1b4', class: "help-text" }, utils.instance.t('nylasEventTitle.helpText', { context: 'start', field: utils.instance.t('nylasEventTitle.title') }), " ", index.h("code", { key: '4ccb07d90b5366e29b7ec041d9ea96e2dbe2f17f' }, "$"), ' ', utils.instance.t('nylasEventTitle.helpText', { context: 'end' }), index.h("span", { key: '762784688425f7c75c00d02650602d55a4c39a7f', class: "label-icon" }, index.h("tooltip-component", { key: '6c896cb600dfb33eea7d3d34d02dbf4957daaccb' }, index.h("info-icon", { key: '8510b9ff47f14773f3c156b01d9ee692a2e23b9d', slot: "tooltip-icon" }), index.h("span", { key: '55dc64d424f76c3e53380957d2a2194161509c05', slot: "tooltip-content" }, utils.instance.t('nylasEventTitle.tooltip.desc'), " ", index.h("code", { key: '02cacd5eca30da22d0ea5a74991238d3a0b68524' }, '${invitee}'))))), this.validationError != '' && index.h("span", { class: "error-message" }, this.validationError))));
    }
...
NylasEventTitle.style = nylasEventTitleCss;

exports.nylas_event_title = NylasEventTitle;

//# sourceMappingURL=nylas-event-title.cjs.entry.js.map