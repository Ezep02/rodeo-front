...
const InputColorPicker = class {
    ...
    render() {
        return (index.h("div", { key: '821db0f91c515797a660b950a35360c3c6b04a31', class: "color-picker-container", part: "icp_color-picker", tabindex: "0", onKeyDown: e => this.handleKeyDown(e) }, index.h("input", { key: '415a71f72ed2450052720b31f31a2d289ce6bc4d', type: "color", ref: el => (this.inputRef = el), id: this.name, name: this.name, value: this.selectedColor, tabindex: "-1", onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onInput: e => this.handleInput(e), onChange: e => this.handleChange(e), onKeyDown: e => this.handleKeyDown(e) }), index.h("label", { key: '2e5b60172e2b64528377ec40f6a8f88633372186', part: "icp_color-picker-button", htmlFor: this.name, class: { labelBtn: true, open: this.isOpen, error: !!this.errorMessage }, "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-label": this.name }, index.h("span", { key: '6e6e6fd8b989e877004a2bb5b33342c8a27c492c', class: "selected-option", part: "icp_color-picker-button-selected-label" }, this.selectedColor || 'Select a color'), index.h("span", { key: '4deb0977faf3c2259bc8e0e2aa2720c59503ec12', class: {
                open: this.isOpen,
                closed: !this.isOpen,
                chevron: true,
            }, "aria-hidden": "true" }, index.h("chevron-icon", { key: 'da16cec17511ed70e1a4dcdb8f2f08a3b7682674', width: "16", height: "16" })), this.errorMessage && index.h("span", { class: "error help-text" }, this.errorMessage))));
    }
    get el() { return index.getElement(this); }
};
InputColorPicker.style = inputColorPickerCss;

exports.input_color_picker = InputColorPicker;

//# sourceMappingURL=input-color-picker.cjs.entry.js.map