...
const NylasFeedbackForm = class {
    constructor(hostRef) {
        ...
        this.feedbackModalClosed = index.createEvent(this, "feedbackModalClosed", 7);
        this.feedbackSubmitted = index.createEvent(this, "feedbackSubmitted", 7);
    ...
    render() {
        return (index.h(index.Host, { key: 'd9e46e03000d836deb146a105ad5af7314fc93d3', part: "nfbf" }, index.h("div", { key: '6924101eb302c203949378720eea5a6c0ecb34a3', class: "card-wrapper", part: "nfbfc__card" }, index.h("div", { key: '29ad795443767409c2d9812f55b20678d79188ba', class: "close-button" }, index.h("button-component", { key: '6a2c2454351b7d1fdff44e03e5557da13eb75ade', tooltip: "Close", id: "close", variant: 'invisible', onClick: e => this.closeModal(e), part: "nfbf__close-button" }, index.h("close-icon", { key: 'cad67f709930a3d4f439de83f15d2cc4bf48ded5' }))), index.h("div", { key: '4060b186ead7f5dceb82275ca7c5f3daae6603e8', class: "header" }, index.h("h2", { key: 'dc5d83a6e9d0c8898011d2f490940bc7e9bcce8b', slot: "card-title", part: "nfbf__title" }, utils.instance.t('feedbackFormTitle'))), index.h("div", { key: '8f5519ff02c341fe26613e640b76556b6edcd4ac', class: "description title-desc" }, index.h("p", { key: '2bd0aa700560b3381ab3902be2da9bb6765ca1bb' }, utils.instance.t('feedbackFormDescription'))), index.h("textarea-component", { key: '959082460c4ed316ba7d74e8ce2a95225b53deb4', label: utils.instance.t('feedbackMessageLabel'), required: true, maxLength: 500, part: "nfbf__description", name: "feedback", placeholder: utils.instance.t('feedbackMessagePlaceholder') }), index.h("div", { key: 'b0b085c8d8c7d5855ade8a9e91ed172e710f5b7d', class: 'description footer-desc' }, index.h("p", { key: 'd64ed3e021f0590ee0d792f8d37fcf860332d50d' }, "By sending this report, you agree to Nylas\u2019 access to the data necessary to respond to this issue, subject to Nylas\u2019", ' ', index.h("a", { key: '7dc7c199ee9f4abd84274cd5bfca904f6aa8d19c', href: "https://www.nylas.com/privacy-policy/", target: "_blank", rel: "nofollow noreferrer noopener" }, "Privacy Policy"), ".")), index.h("div", { key: 'aa907c4c9462c5218b279b0cb6495aa7177a68aa', class: {
                footer: true,
            } }, index.h("button-component", { key: '049883425d2a7657b84dfd9cf1829b61771c23bc', variant: 'invisible', onClick: e => this.closeModal(e), part: "nfbf__button-outline nfbf__cancel-cta" }, `${utils.instance.t('feedbackModalCloseButton')}`), index.h("button-component", { key: '5a97be9f193e984237835f1707af9ce541a4f063', variant: 'primary', onClick: this.handleConfirmBookingButtonClicked, part: "nfbf__button-outline nfbf__reschedule-cta" }, `${utils.instance.t('feedbackModalSubmitButton')}`)))));
    }
...
NylasFeedbackForm.style = nylasFeedbackFormCss;

exports.nylas_feedback_form = NylasFeedbackForm;

//# sourceMappingURL=nylas-feedback-form.cjs.entry.js.map