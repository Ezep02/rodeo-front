...
const NylasDatePicker = class {
    constructor(hostRef) {
        ...
        this.dateSelected = index$1.createEvent(this, "dateSelected", 7);
        this.monthChanged = index$1.createEvent(this, "monthChanged", 7);
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '4c20e8d37a61de3397cac0625884fdd9c11cc8af', part: "ndp" }, index$1.h("div", { key: '44174b6408db8263ab96c9acb57985af0d0780d2', class: "nylas-date-picker" }, index$1.h("div", { key: '962fc8b1ab8d8794df5838e16a477b8f705e4e6f', class: "title", part: "ndp__title" }, this.configSettings?.name ? (index$1.h("h1", null, this.configSettings?.name)) : (this.configSettings?.organizer?.name && (index$1.h("h1", null, index$1.h("person-icon", null), this.configSettings?.organizer?.name || 'Organizer'))), index$1.h("p", { key: '422505548dffc0ee5a70811415ff030641faeeff' }, index$1.h("clock-icon", { key: 'ef51faa1c20ef5caf3f3a8f7ff619c619ba72401' }), this.eventDuration ? utils.convertMinutesToHoursAndMinutes(this.eventDuration) : `- ${utils.instance.t('time.minutes')}`)), index$1.h("div", { key: 'f593d3bbcb954bd863381e445cff053ce0085714', class: 'header flex-row' }, index$1.h("h2", { key: 'bc844a479c3d7e7b4a2065e91aa79baace20b302', part: 'ndp__month-header' }, index$1.h("strong", { key: 'da5035f141b874d58f626426b71ee7e9dd0b6424' }, utils.translateMonth(this.month.toLocaleDateString(undefined, { month: 'long' }).toLocaleLowerCase())), "\u00A0", this.month.toLocaleDateString(undefined, { year: 'numeric' })), index$1.h("div", { key: 'a2721542d5155de0072aa8a191b111b7d8cd7eea', class: 'pagination' }, index$1.h("button", { key: 'ad051ec43c6eb386ddefcab4db66932b079d75e0', title: "Previous month", onClick: () => this.changeMonth(-1), class: { 'chevron-left': true, 'button': true }, disabled: this.month <= new Date(), part: "ndp__month-button" }, index$1.h("chevron-icon", { key: '29cc3852bddacb1d4dd014aceb061d6baa27bfb4' })), index$1.h("button", { key: '92de9256c6c89f2dde6c59717bc9866a122e455c', title: "Next month", onClick: () => this.changeMonth(1), class: { 'chevron-right': true, 'button': true }, disabled: this.disableNextMonthButton, part: "ndp__month-button" }, index$1.h("chevron-icon", { key: '98e5e9d80629c9e86767ba151e88b20fb1a188b7' })))), index$1.h("div", { key: 'a63a1331d33c6f1b79d0e2f99e06c8ad0e4a2e50', class: 'dates' }, [
            ...
            return (index$1.h("div", { class: 'day', part: "ndp__day" }, day));
        }), this.dates.map((date, i) => {
            const isDisabled = this.isDisabled(date, this.selectableDates);
            if (this.isLoading) {
                return (index$1.h("button", { disabled: true, class: {
...
NylasDatePicker.style = nylasDatePickerCss;

exports.nylas_date_picker = NylasDatePicker;

//# sourceMappingURL=nylas-date-picker.cjs.entry.js.map