...
const TimeInput = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08c910b64f1990194d69892923e03e8cf2967853' }, index.h("div", { key: '8580adca9096558b400d9fc1ceaac1807345a4bf', class: "time-picker", part: "time-picker" }, index.h("input", { key: '922200c3ba40d880f368f06dba3a2c2549cfa9d6', type: "text", name: this.name, id: this.name, part: "time-input", class: {
                'time-input': true,
...
const ToggleSwitchComponent = class {
    ...
    render() {
        return (index.h("label", { key: '1586b4b0484716254ad8befbd9f99f7956e9c129', class: "switch", part: "ts_label" }, index.h("input", { key: 'c7e9432dfe88d4c27bb146c3816f750fb7dc6851', type: "checkbox", part: "ts_input", name: this.name, checked: this.isChecked, onChange: () => this.toggleCheck() }), index.h("div", { key: '08980c1db3849f197b1780caa55bfe8e84ce0a92', class: "slider round", part: "ts_slider" })));
    }
};
...
//# sourceMappingURL=nylas-time-window-picker_2.cjs.entry.js.map