...
const RadioButtonGroup = class {
    constructor(hostRef) {
        ...
        this.nylasFormRadioChanged = index.createEvent(this, "nylasFormRadioChanged", 7);
    ...
    render() {
        return (index.h("div", { key: 'bb8081c01a8910156ceceb6a84dbd397fd9bd729', class: "radio-group" }, index.h("slot", { key: 'dffac376a2e005f4d039e07c6742ffb5f9bea8b3', name: "label" }, this.label && (index.h("p", { class: { error: !!this.error } }, index.h("span", { class: "label" }, this.label), this.required && index.h("span", { class: "required" }, "*")))), this.options.map(option => (index.h("label", null, index.h("div", { class: "radio-option" }, index.h("input", { type: "radio", name: this.name, value: option.value, checked: this.selectedValue === option.value, onChange: () => this.handleChange(option.value) }), index.h("p", null, index.h("span", { class: "title" }, option.label), index.h("span", { class: "description" }, option.description)))))), this.error && index.h("span", { class: "error help-text" }, this.error)));
    }
...
//# sourceMappingURL=radio-button-group.cjs.entry.js.map