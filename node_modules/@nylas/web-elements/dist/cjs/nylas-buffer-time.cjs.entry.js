...
const NylasBufferTime = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "nylas-buffer-time", part: "nbt" }, index.h("div", { class: "header", part: "nbt__header" }, index.h("h3", null, utils.instance.t('nylasBufferTime.headerTitle')), index.h("p", null, utils.instance.t('nylasBufferTime.headerSubTitle'), index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasBufferTime.tooltip.desc'))))), index.h("div", { class: "nylas-buffer-time__body", part: "nbt__body" }, index.h("div", { class: "nylas-buffer-time__dropdown" }, index.h("div", { class: "nylas-buffer-time__row" }, index.h("label", null, utils.instance.t('nylasBufferTime.beforeBufferLabel')), index.h("div", { class: "dropdown-container" }, this.componentLoaded && (index.h("select-dropdown", { id: "before-buffer-time", withSearch: false, name: "before-buffer-time", exportparts: "sd_dropdown: nbt__dropdown-before, sd_dropdown-button: nbt__dropdown-button-before, sd_dropdown-content: nbt__dropdown-content-before", options: minuteOptions, defaultSelectedOption: minuteOptions.find(min => min.value == this.selectedBeforeBufferTime) })), index.h("span", null, utils.instance.t('nylasBufferTime.minutesShort')))), index.h("div", { class: "nylas-buffer-time__row" }, index.h("label", null, utils.instance.t('nylasBufferTime.afterBufferLabel')), index.h("div", { class: "dropdown-container" }, this.componentLoaded && (index.h("select-dropdown", { id: "after-buffer-time", withSearch: false, name: "after-buffer-time", exportparts: "sd_dropdown: nbt__dropdown-after, sd_dropdown-button: nbt__dropdown-button-after, sd_dropdown-content: nbt__dropdown-content-after", options: minuteOptions, defaultSelectedOption: minuteOptions.find(min => min.value == this.selectedAfterBufferTime) })), index.h("span", null, utils.instance.t('nylasBufferTime.minutesShort'))))), index.h("div", { class: "nylas-buffer-time__preview", part: "nbt__preview" }, index.h("h4", null, utils.instance.t('nylasBufferTime.previewHeader')), this.renderPreview())))));
    }
...
NylasBufferTime.style = nylasBufferTimeCss;

exports.nylas_buffer_time = NylasBufferTime;

//# sourceMappingURL=nylas-buffer-time.cjs.entry.js.map