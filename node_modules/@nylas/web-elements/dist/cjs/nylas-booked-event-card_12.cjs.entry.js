...
const NylasBookedEventCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5c0d6ded922007d327b55a3536338a82302ca0be', part: "nbec" }, index.h("div", { key: 'a0d3c60605fbf54303527bc6001477db946eb560', class: "nylas-booked-event-card" }, index.h("div", { key: '043a3aead5724fd56c3075d60ff0cfe470e2d551', class: "booked-event-timezone" }, index.h("globe-icon", { key: 'f21ee01ed85b02982e013d6731bffd8a20ef0ad9' }), constants.TIMEZONE_MAP[this.selectedTimezone]), index.h("div", { key: '5408744046d0b755044db2c88f15dfeed1ac0cd1', class: "event-card-wrapper", part: "nbec__card" }, index.h("div", { key: 'c1e352e8395aa35c9faadadf10a82f04b10cf88e', class: "calendar-icon" }, index.h("calendar-check-icon", { key: '9e4464eb5a88dafa35340d8441bfc6570c880151' })), index.h("div", { key: '2265e9737ed82f085e348a6bde53dc68d7d7fc94', class: "booked-event-header" }, index.h("h2", { key: '30ba50948f9de4ef3f47c72547478c81870d85b2', slot: "card-title", part: "nbec__title" }, !!this.rescheduleBookingId && !this.isLoading
            ? `${utils.instance.t('bookingRescheduled')}`
            : isManualConfirmation && !this.isLoading
                ? `${utils.instance.t('bookingSent')}`
                : `${utils.instance.t('bookingConfirmed')}`, "!"), index.h("div", { key: '8ae1ffd38656334a233bca8eb7b25b6e7c03c937', class: "card-description", part: "nbec__description" }, isManualConfirmation ? utils.instance.t('bookingSentDescription') : index.h("span", null, utils.instance.t('bookingConfirmedDescription')))), index.h("div", { key: 'cf6a84c9dc87e923c21468561a7601f476fd85a1', class: "booking-date-time" }, index.h("checkmark-circle-icon", { key: '7e42ae42fbe6c87a21f2a6031796132a5562d882' }), index.h("h3", { key: 'd92ede4d9f33a3dd461a0e14c4965e614c23f075' }, utils.instance.t('bookingDateAndTimeHeader')), index.h("p", { key: '1da0c2ff11644c6718e8ca512baffbc0affb3fd5' }, this.selectedTimeslot?.start_time
            ...
            : '-', ' ', index.h("br", { key: '167cd8c78e97697766713811549588e9d6fd3fcb' }), this.startTime, " - ", this.endTime)), index.h("div", { key: '61d35600d07d7ffccbce3f3aa93a3bfed385637e', class: "booking-participants" }), !isManualConfirmation && (index.h("div", { class: "button-container" }, index.h("div", { class: {
                'footer': true,
    ...
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            ...
            rescheduleBookedEventError: async (event, _nylasSchedulerConnector) => {
                utils.debug('nylas-booked-event-card', 'rescheduleBookedEventError', event.detail);
            },
...
const NylasBookingForm = class {
    constructor(hostRef) {
        ...
        this.handleGuestChange = (guestIndex, email) => {
            ...
            guests[guestIndex] = utils.sanitizeHtml(email);
    ...
    changeEmail(email) {
        ...
        this.email = utils.sanitizeHtml(email);
    ...
    render() {
        return (index.h(index.Host, { key: '5c6062534cb10178622df56b87e9d27093302f67' }, index.h("form", { key: 'd8fba8dc8b940082f774b1345641bbe6e756c295', onSubmit: e => this.bookButtonClickedHandler(e), noValidate: true }, index.h("div", { key: 'b3ce646d930f267196eea3dddd45036d6ead5b83', class: "nylas-booking-form", part: "nbf" }, index.h("div", { key: '8303180ac1fa78c4652e1a5f9b15950840ecfc11', class: "input-wrapper", part: "nbf__input-wrapper" }, index.h("input-component", { key: '861d9988deae50c98a013e573b04a73283d7ddd3', label: utils.instance.t('name'), name: "name", id: "name", defaultValue: this.bookingInfo?.primaryParticipant?.name || this.configSettings?.booking?.guest?.name || this.name, placeholder: utils.instance.t('namePlaceholder'), type: "text", required: true, requiredError: utils.instance.t('fieldRequired', { field: utils.instance.t('name') }), patternError: utils.instance.t('invalidInputFormat', { field: utils.instance.t('name') }), part: "nbf__input-textfield" })), index.h("div", { key: '4badb20b9713d9eb7c40687a830a516eaa057b18', class: "input-wrapper", part: "nbf__input-wrapper" }, index.h("input-component", { key: '92e5688fef7bf79e73e42c33c89173b0ef027101', label: utils.instance.t('email'), name: "email", id: "email", pattern: emailRegex, defaultValue: this.bookingInfo?.primaryParticipant?.email || this.configSettings?.booking?.guest?.email || this.email, placeholder: utils.instance.t('emailPlaceholder'), type: "email", required: true, requiredError: utils.instance.t('fieldRequired', { field: utils.instance.t('email') }), patternError: utils.instance.t('invalidInputFormat', { field: utils.instance.t('email') }), part: "nbf__input-textfield" })), this.configSettings?.scheduler?.hide_additional_guests !== true && (index.h("div", { class: "input-wrapper", part: "nbf__input-wrapper" }, this.guestEmails.map((email, index$1) => (index.h("div", { class: "input-wrapper button-wrapper" }, index.h("label", { class: {
                ...
                'guest-email': true,
                'error': !!this.guestEmailErrors[index$1],
            }, placeholder: utils.instance.t('guestEmailPlaceholder'), value: email, "data-index": index$1, part: "nbf__input-textfield", onBlur: (e) => this.handleGuestBlur(index$1, e.target?.value), onInput: (e) => this.handleGuestChange(index$1, e.target?.value) }), index.h("button-component", { variant: "basic", tooltip: "Remove guest", onClick: (e) => this.removeGuestButtonClickHandler(e, index$1), class: {
                'remove-guest': true,
                'error': !!this.guestEmailErrors[index$1],
            ...
            switch (field.type) {
                ...
                case 'date':
                    return (index.h("div", { class: "input-wrapper", part: "nbf__input-wrapper" }, index.h("nylas-date-component", { label: label, defaultValue: defaultValue, name: key, id: key, required: field.required, part: "nbf__date-component" })));
                case 'multi_select':
                    const defaultValues = defaultValue?.split(',').map(item => item.trim()) || [];
                    return (index.h("div", null, index.h("multi-select-dropdown", { label: label, name: key, id: key, options: field.options?.map(option => ({ value: option, label: option, selected: defaultValues.includes(option) })), required: field.required, exportparts: "msd_dropdown: nbf__ms_dropdown, msd_dropdown-label: nbf__ms_dropdown-label, msd_dropdown-button: nbf__ms_dropdown-button, msd_dropdown-content: nbf__ms_dropdown-content, msd_dropdown_error: nbf__ms_dropdown_error, msd_dropdown-button--error: nbf__ms_dropdown-button--error" })));
                case 'metadata':
                    return null;
                default:
        ...
        })), index.h("div", { key: '6f7a32f05fdf35515851598001ebb18b4a2b52ee', class: "cta" }, index.h("button-component", { key: 'de9548b9fab9475596750725fb9498940cde29b1', variant: 'basic', class: "back", part: "nbf__button-outline", isLoading: this.backButtonLoading && this.isLoading, onClick: this.handleBackButtonClicked }, index.h("slot", { key: 'e5fdb427c7b6e25b20c439b5edaa8e545d49cb44', name: "booking-form-back-label" }, `${utils.instance.t('backButton')}`)), index.h("button-component", { key: '688a5974bc75ce734a4409e33d379384a1840ff8', variant: 'primary', isLoading: !this.backButtonLoading && this.isLoading, disabled: this.isLoading, part: "nbf__button-primary", type: "submit" }, index.h("slot", { key: 'a588fa553809bb9042db4b06bb0072fbb1cafc15', name: "booking-form-book-label" }, `${utils.instance.t('bookNowButton')}`))))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
...
const NylasCancelBookingForm = class {
    constructor(hostRef) {
        ...
        this.triggerValidation = index.createEvent(this, "triggerValidation", 7);
        ...
        this.handleSubmitCancelBooking = (event) => {
            ...
            if (!this.cancellationReason) {
                this.cancellationError = utils.instance.t('cancellationErrorMessage');
                this.cancelBookingFormError.emit({ title: utils.instance.t('cancelBokingFormError'), description: utils.instance.t('cancellationErrorMessage') });
                return;
            }
            const minCancellationNotice = this.configSettings?.scheduler?.min_cancellation_notice;
            if (this.selectedTimeslot && minCancellationNotice) {
                ...
                if (dateTillCancellation < new Date().getTime()) {
                    this.cancelBookedEventError.emit({
                        error: {
                            title: utils.instance.t('cancellationErrorTitle'),
                            message: utils.instance.t('minimumCancellationNoticeErrorMessage', { minCancellationNotice }),
                        },
                    });
                    return;
                }
    ...
    render() {
        return (index.h(index.Host, { key: 'a883955600837a2006648886cc55ac8bd0ea0076', part: "ncbf" }, index.h("div", { key: '868e3b711cd18b2fabc29d5d179255ed1d9ba0dc', class: "nylas-cancel-booking-form", part: "ncbf__card" }, index.h("div", { key: '20dabbd57825f213f7a7f1700de22cd8228409b8', class: "nylas-cancel-booking-form__calendar-icon", part: "ncbf__icon" }, index.h("calendar-cancel-icon", { key: 'd6bab72a846359fdec0e0ee30c23c4ab41f33a8e' })), index.h("h3", { key: 'ac741c5913c7977bb411f6dec7ca25ce498a875a', class: "nylas-cancel-booking-form__title", part: "ncbf__title" }, utils.instance.t('cancelBookingTitle')), index.h("div", { key: '4938ceba259171a7b73465ee1979f7f42d99110f', class: "nylas-cancel-booking-form__description", part: "ncbf__description" }, !this.configSettings?.scheduler?.cancellation_policy ? `${utils.instance.t('cancelBookingMessage')}` : this.cancellationPolicy), index.h("form", { key: '7b33c284b2c9ee3aa92b5faf1f9b25acb5cacd2e', onSubmit: this.handleSubmitCancelBooking }, index.h("textarea-component", { key: 'c2cdfac338d6af301c84ce5120d79e0eba92f56a', id: "cancel-reason", name: "cancel-reason", required: true, label: utils.instance.t('reasonForCancellation'), class: this.cancellationError ? 'error' : '', part: "ncbf__reason-textarea", defaultValue: this.cancellationReason }), index.h("div", { key: '675ccb5dc874a97d05cacde94fec4b17c95c2e07', class: "footer" }, index.h("button-component", { key: '2dcba1cec03a6f21766dc1bc3f10aa8790dcc022', variant: 'destructive', class: "cancel", type: "submit", part: "ncbf__button-cta", disabled: this.isLoading }, utils.instance.t('cancelBookingButton')), !!this.eventInfo && (index.h("button-component", { variant: 'basic', class: "back", part: "ncbf__button-outline", onClick: this.handleGoBackClicked }, utils.instance.t('goBackButton'))))))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
    ...
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            ...
            goBackButtonClicked: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-cancel-booking-form', 'goBackButtonClicked', event.detail);
                nylasSchedulerConnector.scheduler.goBack();
            },
            cancelBookedEventError: async (event, _nylasSchedulerConnector) => {
                utils.debug('nylas-cancel-booking-form', 'cancelBookedEventError', event.detail);
            },
...
const NylasConfirmedEventCard = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.closeConfirmEventCardClicked = index.createEvent(this, "closeConfirmEventCardClicked", 7);
        this.confirmedEventCardError = index.createEvent(this, "confirmedEventCardError", 7);
        this.handleCloseClicked = () => {
            this.isClosing = true;
            const errorHandler = (error) => {
    ...
    connectedCallback() {
        utils.debug(`[nylas-confirmed-event-card] Component connected`);
    }
    async componentWillLoad() {
        utils.debug(`[nylas-confirmed-event-card] Component will load`);
    }
    async componentDidLoad() {
        utils.debug(`[nylas-confirmed-event-card] Component did load`);
    ...
    render() {
        return (index.h(index.Host, { key: '32150831bc61cda8bee5b633cf9f25d13adb50be', part: "ncec" }, index.h("div", { key: 'ced74e070e338973dcf89c61c010357940448dc3', class: "nylas-confirmed-event-card", part: "ncec__card" }, index.h("div", { key: '3aa9395069cab31c0a586405b1cbff880e175f83', class: "nylas-confirmed-event-card__calendar-icon", part: "ncec__icon" }, index.h("calendar-cancel-icon", { key: '97fd8d2aacca8fb53c0dccb3b043d2b2e1208b09' })), index.h("h3", { key: '6e4c56557ca295159a6f3a4c56e181f0da17bf07', class: "nylas-confirmed-event-card__title", part: "ncec__title" }, utils.instance.t('confirmedEventCardTitle'), "!"), index.h("div", { key: '631dd06c937cc87e54efc9a02aed1ca37b457593', class: "nylas-confirmed-event-card__description", part: "ncec__description" }, utils.instance.t('confirmedEventCardDescription'), " ", this.configSettings?.organizer?.name || 'the participants', "."), index.h("div", { key: 'e348ce191e32a00c54e0952ec512776cb1f3c02c', class: "nylas-confirmed-event-card__cta" }, index.h("button-component", { key: 'fc97c826564685ee51facea882aa4cf0a7b01608', variant: "basic", disabled: this.isClosing, part: "ncec__button-outline", onClick: this.handleCloseClicked }, this.isClosing ? `${utils.instance.t('closingButton')}...` : `${utils.instance.t('closeButton')}`)))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "themeConfig": ["themeConfigChanged"]
...
const NylasDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c20e8d37a61de3397cac0625884fdd9c11cc8af', part: "ndp" }, index.h("div", { key: '44174b6408db8263ab96c9acb57985af0d0780d2', class: "nylas-date-picker" }, index.h("div", { key: '962fc8b1ab8d8794df5838e16a477b8f705e4e6f', class: "title", part: "ndp__title" }, this.configSettings?.name ? (index.h("h1", null, this.configSettings?.name)) : (this.configSettings?.organizer?.name && (index.h("h1", null, index.h("person-icon", null), this.configSettings?.organizer?.name || 'Organizer'))), index.h("p", { key: '422505548dffc0ee5a70811415ff030641faeeff' }, index.h("clock-icon", { key: 'ef51faa1c20ef5caf3f3a8f7ff619c619ba72401' }), this.eventDuration ? utils.convertMinutesToHoursAndMinutes(this.eventDuration) : `- ${utils.instance.t('time.minutes')}`)), index.h("div", { key: 'f593d3bbcb954bd863381e445cff053ce0085714', class: 'header flex-row' }, index.h("h2", { key: 'bc844a479c3d7e7b4a2065e91aa79baace20b302', part: 'ndp__month-header' }, index.h("strong", { key: 'da5035f141b874d58f626426b71ee7e9dd0b6424' }, utils.translateMonth(this.month.toLocaleDateString(undefined, { month: 'long' }).toLocaleLowerCase())), "\u00A0", this.month.toLocaleDateString(undefined, { year: 'numeric' })), index.h("div", { key: 'a2721542d5155de0072aa8a191b111b7d8cd7eea', class: 'pagination' }, index.h("button", { key: 'ad051ec43c6eb386ddefcab4db66932b079d75e0', title: "Previous month", onClick: () => this.changeMonth(-1), class: { 'chevron-left': true, 'button': true }, disabled: this.month <= new Date(), part: "ndp__month-button" }, index.h("chevron-icon", { key: '29cc3852bddacb1d4dd014aceb061d6baa27bfb4' })), index.h("button", { key: '92de9256c6c89f2dde6c59717bc9866a122e455c', title: "Next month", onClick: () => this.changeMonth(1), class: { 'chevron-right': true, 'button': true }, disabled: this.disableNextMonthButton, part: "ndp__month-button" }, index.h("chevron-icon", { key: '98e5e9d80629c9e86767ba151e88b20fb1a188b7' })))), index.h("div", { key: 'a63a1331d33c6f1b79d0e2f99e06c8ad0e4a2e50', class: 'dates' }, [
            utils.instance.t('days.sunday'),
            utils.instance.t('days.monday'),
            utils.instance.t('days.tuesday'),
            utils.instance.t('days.wednesday'),
            utils.instance.t('days.thursday'),
            utils.instance.t('days.friday'),
            utils.instance.t('days.saturday'),
        ].map(day => {
    ...
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            dateSelected: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-date-picker', 'dateSelected', event.detail);
...
const NylasLocaleSwitch = class {
    ...
    getTimezoneLabelHTML(timezone) {
        const offset = utils.getTimezoneOffset(timezone);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '00af320c95ef648f69c9ebde6d741df848190059' }, index.h("div", { key: '56998ac07ecebb57f763852ea1c46b11328d4d15', class: "nylas-locale-switch", part: "nls" }, index.h("div", { key: 'ba294660f0716060787c9034010ad26b133338f5', class: {
                'select-wrapper': true,
                'timezone': true,
            }, part: "nls__timezone" }, index.h("select-dropdown", { key: 'e3d1a121cb6230c32ad2e4cf9aeffa4395bd635c', name: "timezone", options: timezoneOptions, defaultSelectedOption: timezoneOptions.find(op => op.value == this.selectedTimezone), exportparts: "sd_dropdown: nls__timezone-dropdown, sd_dropdown-button: nls__timezone-drop-button, sd_dropdown-button-selected-label: nls__timezone-drop-button-selected-label, sd_dropdown-content: nls__timezone-drop-content, sd_dropdown_label: nls__timezone-drop-label" }, index.h("span", { key: 'cc7bb4f138747aab7c5cf673c1b7b3ed09fb9de5', slot: "select-icon" }, index.h("globe-icon", { key: '717894778dc82c415eab8f764c2c18afc3636ee3', width: "20", height: "20" })))), index.h("div", { key: 'd0a64b3910138c1764e17e2be841dbd3fb746f3d', class: {
                'select-wrapper': true,
                'language': true,
            }, part: "nls__language" }, index.h("select-dropdown", { key: '86b417f7b62a0e6c74383e3315e1c6dfdfa09868', name: "language", options: languageOptions, defaultSelectedOption: languageOptions.find(lang => lang.value == this.selectedLanguage), exportparts: "sd_dropdown: nls__language-dropdown, sd_dropdown-button: nls__language-drop-button, sd_dropdown-content: nls__language-drop-content, sd_dropdown_label: nls__language-drop-label" }, index.h("span", { key: '0f1c14fae74a2543fcc57358c507d1288b02ba9c', slot: "select-icon" }, index.h("translate-icon", { key: 'f5a373fff866cf48f39e5bb3b2aa0f6567044433', width: "20", height: "20" })))))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
        "themeConfig": ["themeConfigChanged"],
    ...
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            timezoneChanged: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-locale-switch', 'timezoneChanged', event.detail);
                nylasSchedulerConnector.scheduler.selectTimezone(event.detail);
            },
            languageChanged: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-locale-switch', 'languageChanged', event.detail);
...
const NylasNotification = class {
    ...
    onError(event) {
        utils.debug(`[nylas-notification] Error: ${event.detail.notification.title}`);
        this.handleNotification(event);
    }
    onWarning(event) {
        utils.debug(`[nylas-notification] Warning: ${event.detail.notification.title}`);
        this.handleNotification(event);
    }
    onInfo(event) {
        utils.debug(`[nylas-notification] Info: ${event.detail.notification.title}`);
        this.handleNotification(event);
    }
    onSuccess(event) {
        utils.debug(`[nylas-notification] Success: ${event.detail.notification.title}`);
        this.handleNotification(event);
    }
    ...
    handleNotification(event) {
        ...
        if (parentHost && !this.isChildOf(parentHost)) {
            utils.debug(`[nylas-notification] Host not a parent`);
            return;
        }
        if (this.ttl === 0) {
    ...
    render() {
        return (index.h(index.Host, { key: '37c8f79eb1bb1e30512bda57012ac12edf925955' }, index.h(index.Fragment, { key: '6d991acafb35a569a091409cb73de7e0ce048024' }, this.notifications.map(notif => (index.h("div", { class: `notif ${notif.type}`, key: notif.id }, index.h("div", { class: "content" }, index.h("span", { class: `icon ${notif.type}` }, (notif.type === 'error' || notif.type === 'warning') && index.h("warning-icon", null)), index.h("span", { class: "message" }, index.h("span", { class: "title" }, notif.title), notif.description && index.h("span", { class: "description" }, notif.description))), index.h("button", { class: "dismiss-btn", onClick: () => this.dismissNotification(notif.id) }, index.h("close-icon", null))))), index.h("slot", { key: '37e8972883dac4e8fe1b9d58e53ee8792e4ae94b' }))));
    }
    get host() { return index.getElement(this); }
};
...
const NylasOrganizerConfirmationCard = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.rejectBookingButtonClicked = index.createEvent(this, "rejectBookingButtonClicked", 7);
        this.confirmBookingButtonClicked = index.createEvent(this, "confirmBookingButtonClicked", 7);
        this.confirmBookingError = index.createEvent(this, "confirmBookingError", 7);
    ...
    disconnectedCallback() { }
    async componentWillLoad() {
        utils.debug(`[nylas-organizer-confirmation-card] Component will load`);
    }
    async componentDidLoad() {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4c323bc2244bedc43ffea38922a0ba97424b5bf', part: "nmcc" }, index.h("div", { key: 'd7b9bea1042b6c23497c4a34a730884d1581f7a1', class: "event-card-wrapper", part: "nmccc__card" }, index.h("div", { key: 'c62045056e85744d1b94ae14b926aed48b821fdd', class: "calendar-icon" }, index.h("calendar-check-icon", { key: '38e95954bf2695949935b6998f5b5422ac2120ef' })), index.h("div", { key: '9bf921461d40ffe93856da6aa3dd6b29bcdf366e', class: "booked-event-header" }, index.h("h2", { key: '27beea17ad61d225cd1448b1a1e22c3089bfea6c', slot: "card-title", part: "nmcc__title" }, !!this.organizerConfirmationBookingId && `${utils.instance.t('bookingPendingTitle')}!`)), index.h("div", { key: '49a8c37598e7cc0b9148441db85a5f3b9c59cfcb', class: "manage-booking-description" }, index.h("p", { key: 'bba62e3fb07460d9ea1dd0bfa507a2aa29cd3ad8' }, utils.instance.t('bookingPendingnDescription'))), index.h("div", { key: '1d9b9e5965133b7863cc3aca80c73b88e2455dab', class: {
                'footer': true,
                'no-footer': this.configSettings?.scheduler?.hide_cancellation_options && this.configSettings?.scheduler?.hide_rescheduling_options,
                'no-template-cols': this.configSettings?.scheduler?.hide_cancellation_options || this.configSettings?.scheduler?.hide_rescheduling_options,
...
const NylasTimeslotPicker = class {
    ...
    render() {
        if (this.isLoading) {
            return (index.h(index.Host, null, index.h("div", { class: 'loading' }, new Array(6).fill(0).map((_, i) => (index.h("div", { class: 'timeslot-skeleton', style: { animationDelay: `${i * 20}ms` } }))))));
        }
        ...
        return (index.h(index.Host, { part: "ntp" }, index.h("div", { class: 'time-picker-wrapper', part: "ntp__time-picker-wrapper" }, index.h("div", { class: 'timeslots', part: "ntp__timeslots" }, this.times.map((timeslot, index$1) => (index.h("button", { part: `ntp__timeslot ${this.selectedTimeslot?.start_time?.getTime() === timeslot.start_time.getTime() ? 'ntp__timeslot--selected' : ''}`, class: {
                time: true,
    ...
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            timeslotSelected: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-timeslot-picker', 'timeslotSelected', event.detail);
                nylasSchedulerConnector.scheduler.selectTime(event.detail);
            },
            timeslotConfirmed: async (event, nylasSchedulerConnector) => {
                utils.debug('nylas-timeslot-picker', 'timeslotConfirmed', event.detail);
                if (event.detail) {
...
exports.nylas_confirmed_event_card = NylasConfirmedEventCard;
...
exports.nylas_organizer_confirmation_card = NylasOrganizerConfirmationCard;
exports.nylas_selected_event_card = NylasSelectedEventCard;
exports.nylas_timeslot_picker = NylasTimeslotPicker;

//# sourceMappingURL=nylas-booked-event-card_12.cjs.entry.js.map