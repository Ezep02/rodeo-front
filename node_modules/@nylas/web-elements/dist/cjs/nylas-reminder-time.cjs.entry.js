...
const NylasReminderTime = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1938d2ad21925d6252edb8b8468a6acf38f48b5d' }, index.h("div", { key: '690085428071362f16eccd4607d95352a63f8ddb', class: "nylas-reminder-time", part: "nrt" }, index.h("div", { key: 'baf5110057c4771a82a2b53aef615c0acc334233', class: "nylas-reminder-time__wrapper" }, showTimePeriodSelector && (index.h("time-period-selector", { id: "limit-future-bookings", part: "nrt__time-period-selector", timePeriods: [utils.instance.t('timeDuration', { context: 'minute' }), utils.instance.t('timeDuration', { context: 'hour' }), utils.instance.t('timePeriod', { context: 'day' })], exportparts: "tps__number-dropdown: nrt__number-dropdown, tps__number-dropdown-button: nrt__number-dropdown-button, tps__number-dropdown-content: nrt__number-dropdown-content, tps__period-dropdown: nrt__period-dropdown, tps__period-dropdown-button: nrt__period-dropdown-button, tps__period-dropdown-content: nrt__period-dropdown-content", defaultSelectedNumber: this.selectedNumber, defaultSelectedPeriod: this.selectedPeriod }))))));
    }
