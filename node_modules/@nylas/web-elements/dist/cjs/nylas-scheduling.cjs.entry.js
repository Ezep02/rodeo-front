    ...
    return (index.h(index.Fragment, null,
        ...
        isLoading && (index.h("div", { class: 'loading' },
            ...
            index.h("div", { class: 'right' },
                ...
                index.h("div", { class: 'skeleton' })))),
        !isLoading && children,
        index.h("div", { class: 'footer' }, nylasBranding && (index.h("a", { href: "https://scheduler.nylas.com?utm_source=powered-by-nylas-logoutm_medium=link&utm_campaign=get-scheduler&utm_id=get-scheduler", class: "powered-by-nylas", target: "_blank", rel: "noreferrer noopener" },
            "Powered by\u00A0",
            index.h("span", { class: "sr-only" }, "Nylas"),
            index.h("nylas-logo", { "aria-hidden": true }))))));
};
...
const NylasScheduling = class {
    ...
    feedbackSubmittedHandler(event) {
        const eventId = index$1.captureMessage('Scheduling Page User Feedback');
        const feedback = {
            eventId: eventId,
