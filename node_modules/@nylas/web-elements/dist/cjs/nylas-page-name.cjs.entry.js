...
const NylasPageName = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aff0da976c6bcf75be7f9f79552ff2b93f985207' }, index.h("div", { key: '47c6dc4a5de16c7097a8cc7b55a824da294e6a56', class: "nylas-page-name", part: "nces" }, index.h("div", { key: '6a245a0f7d1c33564ed61570660d7cc54ec47d70', class: "header", part: "nces__header" }, index.h("div", { key: 'ac421d52f0d5941dfdb1908dc04420359ff1c94c' }, index.h("h3", { key: '8706712f959dfc8c0af73309ff2b8ed1f3d6534e' }, utils.instance.t('nylasPageName.headerTitle')), index.h("p", { key: 'a9eb11c0248e5ce9acc634f05533810054312984' }, utils.instance.t('nylasPageName.headerSubTitle'), index.h("tooltip-component", { key: '022dd2e261b1c93e14b1d1a9800472d21b90dce9' }, index.h("info-icon", { key: 'b78838bc225be2ef8bfc6cc681b1d5005291c1ea', slot: "tooltip-icon" }), index.h("span", { key: '95bedf8954c9d7459edb08cc521c574ae4747f16', slot: "tooltip-content" }, utils.instance.t('nylasPageName.tooltip.desc'))))), this.showToggle && (index.h("div", { class: "drawer-toggle", part: "nces__drawer-toggle--container" }, index.h("span", { class: `chevron ${this.isOpen ? 'open' : 'closed'} `, onClick: () => this.toggleDrawer() }, index.h("chevron-icon", { width: "24", height: "24" }))))), this.isOpen && (index.h("div", { class: "nylas-page-name__body", part: "nces__body" }, index.h("div", { class: "nylas-page-name__section" }, index.h("div", { class: "nylas-page-name__row" }, index.h("div", { class: "input-container" }, index.h("div", { class: "nylas-page-name__input-wrapper" }, isComponentReady && (index.h("input-component", { name: "page-name", id: "page-name", type: "text", required: false, exportparts: "ic_input: npn__input-textfield", defaultValue: this.currentPageName ?? '' })))))))))));
    }
...
NylasPageName.style = nylasPageNameCss;

exports.nylas_page_name = NylasPageName;

//# sourceMappingURL=nylas-page-name.cjs.entry.js.map