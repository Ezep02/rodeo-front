...
Object.keys(PROVIDER_CONFERENCE_MAP).map(provider => provider);
[
    { value: 1, label: '1' },
...
Array.from({ length: 23 }, (_, i) => ({ value: i + 1, label: (i + 1).toString() }));
Array.from({ length: 7 }, (_, i) => ({ value: i + 1, label: (i + 1).toString() }));
...
//# sourceMappingURL=constants-1aa5d7c9.js.map