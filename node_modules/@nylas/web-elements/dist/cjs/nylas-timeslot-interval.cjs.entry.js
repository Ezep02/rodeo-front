...
const NylasTimeslotInterval = class {
    ...
    render() {
        ...
        const defaultSelectedInterval = typeof this.selectedInterval !== 'undefined'
            ...
            : undefined;
        return (index.h(index.Host, { key: '6a6ef80a26f96539f3bd76f490e80e3b5b5ec732' }, index.h("div", { key: '4a9b1ca06115bf4545b055ad346bb4a089817118', class: "nylas-timeslot-interval", part: "nti" }, index.h("div", { key: '18f1512a34b383264fd3a97c21c18809b7526be3', class: "header", part: "nti__header" }, index.h("h3", { key: '432759c6caf4396b5af467441b2877e707f4e6d5' }, utils.instance.t('nylasTimeslotInterval.headerTitle'))), index.h("div", { key: '033ce3e6b214b3e708755274737cc0c3577f9842', class: "nylas-timeslot-interval__dropdown" }, index.h("span", { key: '907d5c81914918ce0997640f9b38f3c26ab0f297', class: "label", part: "nti__input-label" }, utils.instance.t('nylasTimeslotInterval.timeslotInterval.label')), defaultSelectedInterval?.label && (index.h("select-dropdown", { name: "interval-minutes", options: intervalPreferenceOptions, withSearch: false, exportparts: "sd_dropdown: nti__dropdown, sd_dropdown-button: nti__dropdown-button, sd_dropdown-content: nti__dropdown-content", defaultSelectedOption: defaultSelectedInterval })), index.h("span", { key: '1237ae4014d733f962bd0471e2b3d4811526dae9', slot: "label", class: "label", part: "nti__input-label" }, utils.instance.t('nylasTimeslotInterval.timeslotRounding.label'), index.h("tooltip-component", { key: '04216f6b0eb529abeb7f0ed28dba4153a5b8a526' }, index.h("info-icon", { key: '4011e72276a72537bb6f95fcbfe533be4e769d27', slot: "tooltip-icon" }), index.h("span", { key: '51129510ca1781dc2a25f9fd81bbdecbe01c9cd4', slot: "tooltip-content" }, utils.instance.t('nylasTimeslotInterval.timeslotRounding.tooltip.desc')))), this.componentLoaded && (index.h("radio-button-group", { name: "interval-preference", defaultSelectedValue: this.selectedRoundTo ? 'rounding' : 'no-rounding', options: [
                {
                    value: 'no-rounding',
...
//# sourceMappingURL=nylas-timeslot-interval.cjs.entry.js.map