...
const NylasEventDuration = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4d4abb5d962a2997a9bfc9837d8afc564f7e3ef7' }, index.h("div", { key: '794e1476f644152cd5fb382e75ea277b6cf42c59', class: "nylas-event-duration", part: "ned" }, index.h("label", { key: '8623f4570bf92e4f606c5ac624f197a26216f66c', htmlFor: "duration" }, utils.instance.t('nylasEventDuration.headerTitle'), index.h("span", { key: 'aaaaf86dcffd338964736ae513512eacfcd166ec', class: "required" }, "*")), index.h("div", { key: '55bfb48285ea8872a129daecacb067c448122d7b', class: "nylas-event-duration__wrapper" }, index.h("input-dropdown", { key: '8dadaa1e245cd1623ecf45ec11a0b8fe4eac1e41', name: 'event-duration', options: this.durationMinutesOptions, inputValue: this.duration.toString(), exportparts: "id_dropdown: ned__input_dropdown, id_dropdown-input: ned__input_dropdown-input, id_dropdown-content: ned__input_dropdown-content", defaultInputOption: this.durationMinutesOptions.find(i => i.value == this.duration) }), this.durationIncrement && (index.h("select-dropdown", { name: 'event-duration', options: durationOptions, pluralizedLabel: this.duration > 1 ? 's' : '', exportparts: "sd_dropdown: ned__dropdown, sd_dropdown-button: ned__dropdown-button, sd_dropdown-content: ned__dropdown-content", defaultSelectedOption: durationOptions.find(i => i.value == this.durationIncrement), withSearch: false }))))));
    }
