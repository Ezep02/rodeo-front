...
const TooltipComponent = class {
    ...
    render() {
        return (index.h("div", { key: '2ca61ec97333e6f3c5504b5123747d82037f8650', class: "tooltip-container", part: "tc__container" }, index.h("span", { key: '4133e0e9a968139a8101789c5291f824a87b5c9d', class: "info-icon", tabindex: "0", onFocus: this.showTooltip.bind(this), onBlur: this.hideTooltip.bind(this) }, index.h("slot", { key: '6b07811a2de2bb05b8133c4d2992eb36ae280f8e', name: "tooltip-icon" }, "i")), index.h("span", { key: '99de5567aaa0998d1d29042f4b86fac5c0689dc6', class: `tooltip-content ${this.position}`, part: "tc__content" }, index.h("slot", { key: '608f52f2bd9bfef59c8dd32fd6f5f15bf044bb12', name: "tooltip-content" }, "This is a help text."))));
    }
    get el() { return index.getElement(this); }
};
TooltipComponent.style = TooltipComponentStyle0;

exports.info_icon = InfoIcon;
exports.tooltip_component = TooltipComponent;

//# sourceMappingURL=info-icon_2.cjs.entry.js.map