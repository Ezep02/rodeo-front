...
const NylasConnectedCalendars = class {
    ...
    render() {
        return (index.h(index.Host, { key: '126bfccad8bb7c1075afd5238b2380d073faf6e7' }, index.h("div", { key: '5e7a584dd488fbda242dd4024b2a8edd466e6b6f', class: "nylas-connected-calendars", part: "nccals" }, index.h("div", { key: '21c614517c601a87aa5d380440711ddbcd7e3947', class: "header", part: "nccals__header" }, index.h("h3", { key: '0fe17c8d660657ca6f178a342ae8b1c417d817aa' }, utils.instance.t('nylasConnectedCalendars.headerTitle')), index.h("p", { key: 'a947256ac12b2d7e492f65acf346ad1f4d983d0b' }, utils.instance.t('nylasConnectedCalendars.headerSubTitle'), index.h("tooltip-component", { key: 'd8218310c1c9ac4bd22880ec8ba7bb3cb9734726' }, index.h("info-icon", { key: '54e9092754e422d70ff2402083c13dfa15c361d6', slot: "tooltip-icon" }), index.h("span", { key: '10f22b96e506ed8589daec5d0e1a0f6e9286c845', slot: "tooltip-content" }, utils.instance.t('nylasConnectedCalendars.tooltip.desc'))))), index.h("div", { key: 'f69d6aa2679bda2d27eda4cdb1cf842d06f604f9', class: "content", part: "nccals__content" }, index.h("form", { key: '69aaabbc456acb1b04158b4392e8edf8bcd40313', ref: el => (this.connectedCalendarsFormRef = el) }, Object.keys(this.participantCalendars).map((key, index$1) => {
            const participant = this.selectedCalendars[key];
            const participantCalendars = this.participantCalendars[key];
            if (!participant || !participant.name)
                return;
            return (index.h("div", { class: "participant-container", part: "nccals__container", key: `participant-conatiner-${index$1}` }, index.h("div", { class: "participant-title", part: "nccals__title" }, index.h("p", null, utils.instance.t('nylasConnectedCalendars.participantCalendarTitle', { participantName: participant.name })), index.h("div", { class: "participant-toggle", part: "nccals__toggle-container" }, index.h("span", { class: `chevron ${participant.isOpen ? 'open' : 'closed'}`, onClick: () => {
                    this.selectedCalendars[key].isOpen = !participant.isOpen;
                    this.selectedCalendars = { ...this.selectedCalendars };
                } }, index.h("chevron-icon", { width: "24", height: "24" })))), participant.isOpen && (index.h("nylas-calendar-picker", { key: key, name: `participant-${key}`, calendars: participantCalendars, defaultSelectedCalendars: this.participantDefaultSelectedCalendars[key] }))));
        }))))));
    }
...
NylasConnectedCalendars.style = nylasConnectedCalendarsCss;

exports.nylas_connected_calendars = NylasConnectedCalendars;

//# sourceMappingURL=nylas-connected-calendars.cjs.entry.js.map