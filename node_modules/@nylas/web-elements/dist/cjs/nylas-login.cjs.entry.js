...
const NylasLogin = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '05d703ee512a876f10ba163da3b926e29335cd33' }, this.loginMethod === 'redirect' && (index.h("div", { class: "redirect-container" }, !this.isAuthenticated && (index.h("button", { part: "button", onClick: this._handleLoginRedirect }, this.buttonText)))), this.loginMethod === 'emebded' && (index.h("main", { class: "login-container" }, index.h("section", { class: "login-box" }, index.h("header", null, index.h("img", { src: this.logoUrl, alt: `${this.companyName} logo`, width: '100%', style: {
