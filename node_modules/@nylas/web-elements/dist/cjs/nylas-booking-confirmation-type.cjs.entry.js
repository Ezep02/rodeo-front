...
const NylasBookingConfirmationType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e50655127ac22aa67231a50d429fdbb9f85b2b46' }, this.showDropdown && (index.h("div", { class: "nylas-booking-confirmation-type", part: "nbct" }, bookingOptions.length > 0 && (index.h("div", { class: "nylas-booking-confirmation-type__dropdown" }, index.h("span", { class: "label" }, utils.instance.t('nylasBookingConfirmationType.dropdownLabel'), index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, utils.instance.t('nylasBookingConfirmationType.tooltip.desc')))), this.selectedBookingType && (index.h("select-dropdown", { name: "booking-type", options: bookingOptions, withSearch: false, exportparts: "sd_dropdown: nbct__dropdown, sd_dropdown-button: nbct__dropdown-button, sd_dropdown-content: nbct__dropdown-content", defaultSelectedOption: bookingOptions.find(cal => cal.value == this.selectedBookingType) }))))))));
    }
