...
export class NylasIfState {
    ...
    render() {
        return (h(Host, { key: '36d3cd4c91d34f8716528990469a2b015b4e3f72' }, h("div", { key: '2f598550f94fcb8e92e783f93c384703a6229776', class: this.classes }, this.show && h("slot", null))));
    }
