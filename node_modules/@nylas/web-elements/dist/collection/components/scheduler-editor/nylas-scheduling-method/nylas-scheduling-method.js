...
export class NylasSchedulingMethod {
    ...
    render() {
        ...
        return (h(Host, null, h("div", { class: "nylas-scheduling-method", part: "nsm" }, h("div", { class: "header", part: "nsm__header" }, h("h3", null, i18next.t('nylasSchedulingMethod.headerTitle'))), h("div", { class: "nylas-scheduling-method__dropdown" }, h("span", { class: "nylas-scheduling-method__dropdown-label" }, i18next.t('nylasSchedulingMethod.headerSubTitle'), h("tooltip-component", null, h("info-icon", { slot: "tooltip-icon" }), h("span", { slot: "tooltip-content" }, h("strong", null, i18next.t('nylasSchedulingMethod.tooltip.standard.label')), h("br", null), "- ", i18next.t('nylasSchedulingMethod.tooltip.standard.desc'), h("br", null), h("br", null), h("strong", null, i18next.t('nylasSchedulingMethod.tooltip.maxFairness.label')), h("br", null), "- ", i18next.t('nylasSchedulingMethod.tooltip.maxFairness.desc'), h("br", null), h("br", null), h("strong", null, i18next.t('nylasSchedulingMethod.tooltip.maxAvailability.label')), h("br", null), "- ", i18next.t('nylasSchedulingMethod.tooltip.maxAvailability.desc'), h("br", null)))), this.readOnly ? (h("input-component", { name: "availability-method-read-only", type: "text", exportparts: "ic__label: nsm__input-label, ic__input: nsm__input, ic__input_wrapper: nsm__input_wrapper", readOnly: true, defaultValue: bookingTypeOptions.find(cal => cal.value == defaultBookingType)?.label ?? bookingTypeOptions[0].label })) : (h("select-dropdown", { name: this.name, options: bookingTypeOptions, withSearch: false, exportparts: "sd_dropdown: nsm__dropdown, sd_dropdown-button: nsm__dropdown-button, sd_dropdown-content: nsm__dropdown-content", defaultSelectedOption: bookingTypeOptions.find(cal => cal.value == defaultBookingType) ?? bookingTypeOptions[0] }))))));
    }
