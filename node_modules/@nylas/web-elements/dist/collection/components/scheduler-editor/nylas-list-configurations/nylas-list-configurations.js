...
export class NylasListConfigurations {
    ...
    getActionLabelHTML(action) {
        ...
        switch (action) {
            case 'preview':
                return (h("span", { style: actionStyle }, h("eye-icon", { width: "16", height: "16" }), i18next.t('nylasListConfigurations.previewButtonText')));
            case 'copy':
                return (h("span", { style: actionStyle }, h("copy-icon", { width: "16", height: "16" }), i18next.t('nylasListConfigurations.copyLinkButtonText')));
            case 'delete':
                return (h("span", { style: { ...actionStyle, ...dangerStyle } }, h("delete-icon", { width: "15", height: "17" }), i18next.t('nylasListConfigurations.deleteButtonText')));
            default:
                return '';
        }
    }
    ...
    render() {
        return (h(Host, null, h("div", { class: "header" }, h("div", { class: "description" }, h("h2", null, i18next.t('allSchedulingPages')), h("p", null, i18next.t('createAndManageSchedulingPages'))), this.configurations && this.configurations.length > 0 && (h("div", { class: "actions" }, h("button-component", { part: "nlc__create-new-cta", clickHandler: () => {
                this.createButtonClick.emit(this.host);
            } }, i18next.t('createNewSchedulingPageButtonText'))))), h("div", { class: "configurations" }, h("div", { class: "table-container" }, h("table", { class: {
            ...
            } }, h("th", null, i18next.t('pageTitle')), h("th", null, i18next.t('durationTitle')), h("th", null)), this.state === 'loading' && (h("tr", { class: "no-configurations" }, h("td", { colSpan: 3 }, h("div", null, h("h3", null, i18next.t('loading'), "..."), h("p", null, i18next.t('loadingPagesDescription')))))), this.state !== 'loading' && (!this.configurations || this.configurations.length === 0) && (h("tr", { class: "no-configurations" }, h("td", { colSpan: 3 }, h("div", null, h("calendar-icon", { width: "48", height: "48" }), h("h3", null, i18next.t('noSchedulingPages')), h("p", null, i18next.t('createFirstSchedulingPage')), h("button-component", { part: "nlc__create-new-cta", clickHandler: () => {
                this.createButtonClick.emit(this.host);
            } }, i18next.t('createNewSchedulingPageButtonText')))))), this.state !== 'loading' &&
            this.configurations?.map((config, i) => {
                ...
                return (h("tr", { key: config?.id }, h("td", null, h("div", { class: "title" }, h("div", { class: "config-event-title", title: config?.event_booking?.title }, config?.event_booking?.title), h("div", { class: 'config-event-description' }, config?.event_booking?.description))), h("td", null, h("div", { class: "duration" }, this.getDurationString(config?.availability?.duration_minutes))), h("td", null, h("div", { class: "actions" }, h("button-component", { variant: 'basic', key: `edit-${i}`, clickHandler: event => {
                    ...
                    } }, h("edit-icon", { width: "16", height: "16" }), i18next.t('editSchedulingPageButtonText')), h("select-dropdown", { class: {
                        last: lastTwo,
