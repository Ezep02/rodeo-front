...
.nylas-buffer-time .header {
  padding: 1rem;
  border-bottom: 1px solid var(--nylas-base-200);
}
.nylas-buffer-time .header h3 {
  margin: 0;
  font-size: 16px;
  font-weight: 600;
  line-height: 20px;
...
.nylas-buffer-time .nylas-buffer-time__body .nylas-buffer-time__dropdown .nylas-buffer-time__row label {
  width: 200px;
}
.nylas-buffer-time .nylas-buffer-time__body .nylas-buffer-time__dropdown .nylas-buffer-time__row .dropdown-container {
  display: flex;
  gap: 1rem;
  align-items: center;
  justify-content: flex-end;
}
.nylas-buffer-time .nylas-buffer-time__body .nylas-buffer-time__dropdown .nylas-buffer-time__row .dropdown-container span {
...
.nylas-buffer-time .nylas-buffer-time__body .nylas-buffer-time__preview .preview-container .slot.active {
  background-color: var(--nylas-base-100);
}
.nylas-buffer-time .nylas-buffer-time__body .nylas-buffer-time__preview .preview-container .slot:last-of-type {
...
.nylas-buffer-time .nylas-buffer-time__dropdown select-dropdown::part(sd_dropdown-content) {
  width: 100%;
}
.nylas-buffer-time .nylas-buffer-time__dropdown select-dropdown::part(sd_dropdown-button-selected-label) {
