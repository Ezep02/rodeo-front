...
.color-picker-container.error::placeholder {
  font-weight: 400;
}
.color-picker-container::placeholder {
...
.color-picker-container input::-webkit-color-swatch {
  min-width: 30px;
  border-radius: 0.25rem;
  border: 1px solid var(--nylas-base-200);
  margin: 0.25rem;
}
.color-picker-container input::-moz-color-swatch {
  min-width: 30px;
  border-radius: 0.25rem;
  border: 1px solid var(--nylas-base-200);
  margin: 0.25rem;
...
.color-picker-container:hover, .color-picker-container:active {
...
.labelBtn:hover, .labelBtn:active {
  outline: 1px solid var(--nylas-primary);
}
.labelBtn span.chevron {
  display: flex;
  align-self: center;
}
.labelBtn span.open {
...
.labelBtn span.closed {
  transform: rotate(270deg);
}
.labelBtn span.selected-option {
