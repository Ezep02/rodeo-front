...
.dropdown .dropdown-label span.required {
...
.dropdown-content ul li:hover, .dropdown-content ul li:focus {
...
.dropdown-content ul li label input {
  margin: 0;
}
...
.selected-options .selected-option button {
  background: transparent;
  border: none;
  cursor: pointer;
  padding: 0;
}
.selected-options .selected-option button:hover {
