...
const PromotionSection = React.lazy(
  () => import("../components/section/Promotion")
);
const LocationInfoCard = React.lazy(
  () => import("@/components/cards/LocationInfoCard")
);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex-1">
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-5 text-gray-200">
            {Array.isArray(promotionList) && promotionList.length > 0
              ? "Descubrí nuestras promociones exclusivas"
              : "Descubrí nuestros servicios exclusivos"}
          </h1>
          <p className="text-lg text-gray-300 mb-3">
            {Array.isArray(promotionList) && promotionList.length > 0
              ? "Aprovecha ofertas únicas pensadas especialmente para ti. ¡No te las pierdas!"
              : "Pensados para quienes confían en nosotros día a día. Porque aquí, cada cliente forma parte de lo que somos."}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 p-4 flex flex-col">
            ...
            <div className="flex gap-3">
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Descubre cómo llevar tu estilo al siguiente nivel
                </p>
              </div>
            </div>
          </header>
          ...
          >
            <ProductSection onClickAction={openBooking} />
          </Suspense>
        </div>
