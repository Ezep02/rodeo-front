...
const ShowDetailDialog: React.FC<OrderDetailsModalProps> = ({ order }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button size={"sm"} variant={"ghost"} onClick={toggleDialog}>
          Ver detalles
        </Button>
      </DialogTrigger>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-start text-zinc-600">
                  Revisa todos los detalles de esta cita, incluyendo cliente,
                  servicios y pagos.
                </DialogDescription>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 w-full md:w-1/2">
              ...
              <div className="bg-zinc-800 px-4 py-3 rounded-2xl text-white flex flex-col gap-2">
                <div>
                  ...
                  <p className="text-sm">
                    ${paidAmount.toFixed(2)} / ${totalPrice.toFixed(2)}
                  </p>
                </div>

                <div>
                  <label className="mt-2 text-sm text-zinc-300">Debes</label>
                  <p
                    className={`${
                      order.payment_percentage < 100
