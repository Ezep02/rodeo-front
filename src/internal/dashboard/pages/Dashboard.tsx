    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <Tabs defaultValue="Servicios">
          ...
          <TabsList className="grid grid-cols-3 w-[300px] mb-4 mt-2">
          ...
          <TabsContent value="Servicios">
            ...
            <div className="bg-gray-50 p-3 text-center text-sm flex justify-center items-center gap-2 shadow-sm rounded-md">
              <MapPin className="h-4 w-4 text-red-500" />
              <span>Av. 29, Calle 48 •</span>
              <a href="https://maps.app.goo.gl/mpWfZ32yUaZ6Xbbr6" target="_blank" className="text-red-500 hover:underline">
                Como llegar?
              </a>
            </div>
