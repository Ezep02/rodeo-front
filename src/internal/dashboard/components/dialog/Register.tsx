...
const RegisterDialog: React.FC<Props> = ({ setIsUserAuthenticated, setUser }) => {
                    ...
                    <div className="w-full max-w-md">
                        <div className="text-center mb-6">
                            <div className="flex mb-2 gap-1">
                                ...
                                <span className="text-sm font-semibold text-zinc-700">El Rodeo</span>
                            </div>
                                ...
                                >
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <div className="relative">
                                            <FormRegisterField
                                                ...
                                                error={errors.email}
                                            />
                                            <a href="#" className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-blue-600 hover:underline">
                                    ...
                                    <div className="flex flex-col gap-4 mt-2">
                                        <div className="flex items-center space-x-2">
                                            <input type="checkbox" id="terms" className="w-4 h-4 text-black border-zinc-300 rounded focus:ring-black" />
                                            <label htmlFor="terms" className="text-sm font-normal text-zinc-600">
                                                He leído y acepto la <span className="underline">Política de Privacidad</span> y los <span className="underline">Términos y Condiciones</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between mt-4">
                                        <div className="flex items-center space-x-2">
                                            <input type="checkbox" id="remember" className="w-4 h-4 text-black border-zinc-300 rounded focus:ring-black" />
                                            <label htmlFor="remember" className="text-sm font-normal text-zinc-600">
                                                Recordarme
                                            </label>
                                        </div>
                                        <Button variant="outline" className="flex items-center gap-2 border-zinc-300 text-zinc-700 font-semibold" type="button">
                                            <FaGoogle />
