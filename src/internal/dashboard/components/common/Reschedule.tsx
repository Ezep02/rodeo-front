...
const Reschedule: React.FC<RescheduleProps> = ({ appointment }) => {
    ...
    // Manejar transicion luego de hacer click en reprogramar
    const handleAppointmentTransition = (appointment: CustomerPendingOrder, shift_to_replace: Shift) => {
        startTransition(() => {
                        ...
                        isReschedulingPending ? (
                            ...
                            <>
                                ...
                                <Button
                                    ...
                                    onClick={() => handleAppointmentTransition(appointment, selectedShift!)}
                                >
                                    Reprogramar{" "}
                                    {
                                        selectedShift && (
